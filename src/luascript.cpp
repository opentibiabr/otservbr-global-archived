...
{
	if ((thing == nullptr) || thing->isRemoved()) {
		return 0;
	}
...
void LuaScriptInterface::reportError(const char* function, const std::string& error_desc, bool stack_trace/* = false*/)
{
	...
	if (stack_trace && (scriptInterface != nullptr)) {
...
void LuaScriptInterface::setItemMetatable(lua_State* L, int32_t index, const Item* item)
{
	...
	} else if (item->getTeleport() != nullptr) {
...
{
	if (creature->getPlayer() != nullptr) {
		luaL_getmetatable(L, "Player");
	} else if (creature->getMonster() != nullptr) {
...
int LuaScriptInterface::luaIsDepot(lua_State* L)
{
	...
	pushBoolean(L, (container != nullptr) && (container->getDepotLocker() != nullptr));
	return 1;
}
...
int LuaScriptInterface::luaIsMoveable(lua_State* L)
{
	...
	pushBoolean(L, (thing != nullptr) && thing->isPushable());
	return 1;
}
...
int LuaScriptInterface::luaTileGetGround(lua_State* L)
{
	// tile:getGround()
	Tile* tile = getUserdata<Tile>(L, 1);
	if ((tile != nullptr) && (tile->getGround() != nullptr)) {
...
int LuaScriptInterface::luaNetworkMessageDelete(lua_State* L)
{
	...
	if ((messagePtr != nullptr) && (*messagePtr != nullptr)) {
		delete *messagePtr;
		*messagePtr = nullptr;
	}
	return 0;
...
int LuaScriptInterface::luaModalWindowDelete(lua_State* L)
{
	...
	if ((windowPtr != nullptr) && (*windowPtr != nullptr)) {
		delete *windowPtr;
		*windowPtr = nullptr;
	}
	return 0;
...
int LuaScriptInterface::luaItemSplit(lua_State* L)
{
	...
	Item* item = *itemPtr;
	if ((item == nullptr) || !item->isStackable() || item->isRemoved()) {
		lua_pushnil(L);
		return 1;
	}
	...
	if ((newItem != nullptr) && newItem != item) {
...
int LuaScriptInterface::luaTeleportCreate(lua_State* L)
{
	...
	Item* item = getScriptEnv()->getItemByUID(id);
	if ((item != nullptr) && (item->getTeleport() != nullptr)) {
		pushUserdata(L, item);
...
int LuaScriptInterface::luaCreatureAddCondition(lua_State* L)
{
	...
	if ((creature != nullptr) && (condition != nullptr)) {
...
int LuaScriptInterface::luaPlayerGetSkillLevel(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if ((player != nullptr) && skillType <= SKILL_LAST) {
...
int LuaScriptInterface::luaPlayerGetGuildLevel(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if ((player != nullptr) && (player->getGuild() != nullptr)) {
...
int LuaScriptInterface::luaPlayerGetMaxSoul(lua_State* L)
{
	// player:getMaxSoul()
	Player* player = getUserdata<Player>(L, 1);
	if ((player != nullptr) && (player->vocation != nullptr)) {
...
int LuaScriptInterface::luaPlayerSendTextMessage(lua_State* L)
{
	...
	if (parameters == 4) {
		...
		if ((channel == nullptr) || !channel->hasUser(*player)) {
			pushBoolean(L, false);
			return 1;
		}
...
int LuaScriptInterface::luaVocationGetDemotion(lua_State* L)
{
	...
	if ((demotedVocation != nullptr) && demotedVocation != vocation) {
...
int LuaScriptInterface::luaVocationGetPromotion(lua_State* L)
{
	...
	if ((promotedVocation != nullptr) && promotedVocation != vocation) {
...
int LuaScriptInterface::luaHouseStartTrade(lua_State* L)
{
	...
	if ((player == nullptr) || (tradePartner == nullptr) || (house == nullptr)) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaCombatSetCondition(lua_State* L)
{
	...
	Condition* condition = getUserdata<Condition>(L, 2);
	Combat* combat = getUserdata<Combat>(L, 1);
	if ((combat != nullptr) && (condition != nullptr)) {
...
int LuaScriptInterface::luaConditionDelete(lua_State* L)
{
	...
	if ((conditionPtr != nullptr) && (*conditionPtr != nullptr)) {
		delete *conditionPtr;
...
int LuaScriptInterface::luaDeleteLoot(lua_State* L)
{
	...
	if ((lootPtr != nullptr) && (*lootPtr != nullptr)) {
		delete *lootPtr;
		*lootPtr = nullptr;
	}
	return 0;
...
int LuaScriptInterface::luaDeleteMonsterSpell(lua_State* L)
{
	...
	if ((monsterSpellPtr != nullptr) && (*monsterSpellPtr != nullptr)) {
...
int LuaScriptInterface::luaPartyDisband(lua_State* L)
{
	...
	if ((partyPtr != nullptr) && (*partyPtr != nullptr)) {
...
int LuaScriptInterface::luaPartySetLeader(lua_State* L)
{
	...
	Player* player = getPlayer(L, 2);
	Party* party = getUserdata<Party>(L, 1);
	if ((party != nullptr) && (player != nullptr)) {
...
int LuaScriptInterface::luaSpellGroup(lua_State* L)
{
	...
	if (spell != nullptr) {
		...
		if (lua_gettop(L) == 2) {
			...
			if ((primaryGroup != 0u) && (secondaryGroup != 0u)) {

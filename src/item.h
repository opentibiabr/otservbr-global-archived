...
class ItemAttributes {
 ...
 private:
  ...
  const static uint32_t intAttributeTypes =
      ...
      ITEM_ATTRIBUTE_EXTRADEFENSE | ITEM_ATTRIBUTE_ARMOR |
      ITEM_ATTRIBUTE_HITCHANCE | ITEM_ATTRIBUTE_SHOOTRANGE |
      ITEM_ATTRIBUTE_OWNER | ITEM_ATTRIBUTE_DURATION |
      ITEM_ATTRIBUTE_DECAYSTATE | ITEM_ATTRIBUTE_CORPSEOWNER |
      ITEM_ATTRIBUTE_CHARGES | ITEM_ATTRIBUTE_FLUIDTYPE |
      ITEM_ATTRIBUTE_DOORID | ITEM_ATTRIBUTE_IMBUINGSLOTS |
      ITEM_ATTRIBUTE_OPENCONTAINER | ITEM_ATTRIBUTE_QUICKLOOTCONTAINER;

  const static uint32_t stringAttributeTypes =
      ITEM_ATTRIBUTE_DESCRIPTION | ITEM_ATTRIBUTE_TEXT | ITEM_ATTRIBUTE_WRITER |
 ...
 public:
  ...
  const std::forward_list<Attribute>& getList() const { return attributes; }
...
class Item : virtual public Thing {
 public:
  ...
  const ItemAttributes::CustomAttribute* getCustomAttribute(
  ...
  bool isCorpse() const { return items[id].corpseType != RACE_NONE; }

...
class Events {
 ...
 public:
  ...
  bool eventPlayerOnTradeAccept(Player* player, Player* target, Item* item,
                                Item* targetItem);
  void eventPlayerOnGainExperience(Player* player, Creature* source,
  ...
  bool eventPlayerCanBeAppliedImbuement(Player* player, Imbuement* imbuement,
                                        Item* item);
  void eventPlayerOnApplyImbuement(Player* player, Imbuement* imbuement,

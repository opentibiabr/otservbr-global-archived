...
void ProtocolLogin::getCharacterList(const std::string& accountName,
...
void ProtocolLogin::onRecvFirstMessage(NetworkMessage& msg) {
  ...
  if (!Protocol::RSA_decrypt(msg)) {
    std::cout << "[ProtocolLogin::onRecvFirstMessage] RSA Decrypt Failed"
              << std::endl;
    disconnect();
    return;
  }
  ...
  g_dispatcher.addTask(
      createTask(std::bind(&ProtocolLogin::getCharacterList, thisPtr,
                           accountName, password, version)));
}

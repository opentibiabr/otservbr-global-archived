...
bool CreatureEvents::registerEvent(Event_ptr event, const pugi::xml_node&) {
  ...
  if (creatureEvent->getEventType() == CREATURE_EVENT_NONE) {
    std::cout << "Error: [CreatureEvents::registerEvent] Trying to register "
                 "event without type!"
              << std::endl;
    return false;
  }
...
bool CreatureEvents::registerLuaEvent(CreatureEvent* event) {
  ...
  if (creatureEvent->getEventType() == CREATURE_EVENT_NONE) {
    std::cout << "Error: [CreatureEvents::registerLuaEvent] Trying to register "
                 "event without type!"
              << std::endl;
    return false;
  }
...
bool CreatureEvent::configureEvent(const pugi::xml_node& node) {
  ...
  if (!nameAttribute) {
    std::cout << "[Error - CreatureEvent::configureEvent] Missing name for "
                 "creature event"
              << std::endl;
    return false;
  }
  ...
  if (!typeAttribute) {
    std::cout << "[Error - CreatureEvent::configureEvent] Missing type for "
                 "creature event: "
              << eventName << std::endl;
    return false;
  }
  ...
  if (tmpStr == "login") {
    ...
    std::cout << "[Error - CreatureEvent::configureEvent] Invalid type for "
                 "creature event: "
              << eventName << std::endl;
    return false;
  }
...
bool CreatureEvent::executeOnLogin(Player* player) const {
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeOnLogin] Call stack overflow"
              << std::endl;
    return false;
  }
...
bool CreatureEvent::executeOnLogout(Player* player) const {
  // onLogout(player)
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeOnLogout] Call stack overflow"
              << std::endl;
    return false;
  }
...
bool CreatureEvent::executeOnThink(Creature* creature, uint32_t interval) {
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeOnThink] Call stack overflow"
              << std::endl;
    return false;
  }
...
bool CreatureEvent::executeOnDeath(Creature* creature, Item* corpse,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeOnDeath] Call stack overflow"
              << std::endl;
    return false;
  }
...
bool CreatureEvent::executeAdvance(Player* player, skills_t skill,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeAdvance] Call stack overflow"
              << std::endl;
    return false;
  }
...
void CreatureEvent::executeOnKill(Creature* creature, Creature* target,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeOnKill] Call stack overflow"
              << std::endl;
    return;
  }
...
void CreatureEvent::executeModalWindow(Player* player, uint32_t modalWindowId,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout
        << "[Error - CreatureEvent::executeModalWindow] Call stack overflow"
        << std::endl;
    return;
  }
...
bool CreatureEvent::executeTextEdit(Player* player, Item* item,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - CreatureEvent::executeTextEdit] Call stack overflow"
              << std::endl;
    return false;
  }
...
void CreatureEvent::executeHealthChange(Creature* creature, Creature* attacker,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout
        << "[Error - CreatureEvent::executeHealthChange] Call stack overflow"
        << std::endl;
    return;
  }
...
void CreatureEvent::executeManaChange(Creature* creature, Creature* attacker,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout
        << "[Error - CreatureEvent::executeManaChange] Call stack overflow"
        << std::endl;
    return;
  }
...
void CreatureEvent::executeExtendedOpcode(Player* player, uint8_t opcode,
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout
        << "[Error - CreatureEvent::executeExtendedOpcode] Call stack overflow"
        << std::endl;
    return;
  }

...
class MoveEvents final : public BaseEvents {
 public:
  ...
  uint32_t onCreatureMove(Creature* creature, const Tile* tile,
...
using StepFunction = std::function<uint32_t(Creature* creature, Item* item,
                                            const Position& pos)>;
using MoveFunction =
...
class MoveEvent final : public Event {
 public:
  ...
  void setSlotName(std::string name) { slotName = name; }

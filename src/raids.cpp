...
bool Raids::loadFromXml() {
  ...
  for (auto raidNode : doc.child("raids").children()) {
    ...
    if ((attr = raidNode.attribute("name"))) {
      ...
      std::cout << "[Error - Raids::loadFromXml] Name tag missing for raid"
                << std::endl;
      continue;
    }
    ...
    if ((attr = raidNode.attribute("file"))) {
      ...
      ss << "raids/" << name << ".xml";
      file = ss.str();
      std::cout << "[Warning - Raids::loadFromXml] File tag missing for raid "
                << name << ". Using default: " << file << std::endl;
    }

    interval =
        pugi::cast<uint32_t>(raidNode.attribute("interval2").value()) * 60;
    if (interval == 0) {
      std::cout << "[Error - Raids::loadFromXml] interval2 tag missing or zero "
    ...
    if ((attr = raidNode.attribute("margin"))) {
      ...
      std::cout
          << "[Warning - Raids::loadFromXml] margin tag missing for raid: "
          << name << std::endl;
      margin = 0;
    }
    ...
    if (newRaid->loadFromXml("data/raids/" + file)) {
      ...
      std::cout << "[Error - Raids::loadFromXml] Failed to load raid: " << name
                << std::endl;
      delete newRaid;
    }
  }
...
bool AnnounceEvent::configureRaidEvent(const pugi::xml_node& eventNode) {
  ...
  if (!messageAttribute) {
    std::cout << "[Error] Raid: message tag missing for announce event."
              << std::endl;
    return false;
  }
  ...
  if (typeAttribute) {
    ...
    if (tmpStrValue == "warning") {
      ...
      std::cout << "[Notice] Raid: Unknown type tag missing for announce "
                   "event. Using default: "
    ...
    messageType = MESSAGE_EVENT_ADVANCE;
    std::cout
        << "[Notice] Raid: type tag missing for announce event. Using default: "
        << static_cast<uint32_t>(messageType) << std::endl;
  }
  return true;
}
...
bool SingleSpawnEvent::configureRaidEvent(const pugi::xml_node& eventNode) {
  ...
  if ((attr = eventNode.attribute("name"))) {
    ...
    std::cout << "[Error] Raid: name tag missing for singlespawn event."
              << std::endl;
    return false;
  }
  ...
  if ((attr = eventNode.attribute("x"))) {
    ...
    std::cout << "[Error] Raid: x tag missing for singlespawn event."
              << std::endl;
    return false;
  }
  ...
  if ((attr = eventNode.attribute("y"))) {
    ...
    std::cout << "[Error] Raid: y tag missing for singlespawn event."
              << std::endl;
    return false;
  }
  ...
  if ((attr = eventNode.attribute("z"))) {
    ...
    std::cout << "[Error] Raid: z tag missing for singlespawn event."
              << std::endl;
    return false;
  }
  return true;
...
bool SingleSpawnEvent::executeEvent() {
  ...
  if (!monster) {
    std::cout << "[Error] Raids: Cant create monster " << monsterName
              << std::endl;
    return false;
  }
  ...
  if (!g_game.placeCreature(monster, position, false, true)) {
    delete monster;
    std::cout << "[Error] Raids: Cant place monster " << monsterName
              << std::endl;
    return false;
  }
  return true;
...
bool AreaSpawnEvent::configureRaidEvent(const pugi::xml_node& eventNode) {
  ...
  if ((attr = eventNode.attribute("radius"))) {
    ...
    if ((attr = eventNode.attribute("centerx"))) {
      ...
      std::cout << "[Error] Raid: centerx tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("centery"))) {
      ...
      std::cout << "[Error] Raid: centery tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("centerz"))) {
      ...
      std::cout << "[Error] Raid: centerz tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("fromx"))) {
      ...
      std::cout << "[Error] Raid: fromx tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("fromy"))) {
      ...
      std::cout << "[Error] Raid: fromy tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("fromz"))) {
      ...
      std::cout << "[Error] Raid: fromz tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("tox"))) {
      ...
      std::cout << "[Error] Raid: tox tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("toy"))) {
      ...
      std::cout << "[Error] Raid: toy tag missing for areaspawn event."
                << std::endl;
      return false;
    }
    ...
    if ((attr = eventNode.attribute("toz"))) {
      ...
      std::cout << "[Error] Raid: toz tag missing for areaspawn event."
                << std::endl;
      return false;
    }
  }
  ...
  for (auto monsterNode : eventNode.children()) {
    ...
    if ((attr = monsterNode.attribute("name"))) {
      ...
      std::cout << "[Error] Raid: name tag missing for monster node."
                << std::endl;
      return false;
    }
    ...
    if (maxAmount == 0 && minAmount == 0) {
      if ((attr = monsterNode.attribute("amount"))) {
        ...
        std::cout << "[Error] Raid: amount tag missing for monster node."
                  << std::endl;
        return false;
      }
    }
...
bool AreaSpawnEvent::executeEvent() {
  for (const MonsterSpawn& spawn : spawnList) {
    ...
    for (uint32_t i = 0; i < amount; ++i) {
      ...
      if (!monster) {
        std::cout
            << "[Error - AreaSpawnEvent::executeEvent] Can't create monster "
            << spawn.name << std::endl;
        return false;
      }
...
bool ScriptEvent::configureRaidEvent(const pugi::xml_node& eventNode) {
  ...
  if (!scriptAttribute) {
    std::cout << "Error: [ScriptEvent::configureRaidEvent] No script file "
                 "found for raid"
              << std::endl;
    return false;
  }

  if (!loadScript("data/raids/scripts/" +
                  std::string(scriptAttribute.as_string()))) {
    std::cout
        << "Error: [ScriptEvent::configureRaidEvent] Can not load raid script."
        << std::endl;
    return false;
  }
  return true;
...
bool ScriptEvent::executeEvent() {
  ...
  if (!scriptInterface->reserveScriptEnv()) {
    std::cout << "[Error - ScriptEvent::onRaid] Call stack overflow"
              << std::endl;
    return false;
  }

        ...
        if (strcasecmp(value, "shooteffect") == 0) {
          if ((attr = attributeNode.attribute("value"))) {
            ...
            if (shoot != CONST_ANI_NONE) {
              ...
              std::cout << "[Warning - Monsters::deserializeSpell] "
                        << description
                        << " - Unknown shootEffect: " << attr.as_string()
                        << std::endl;
            }
          }
          ...
          if ((attr = attributeNode.attribute("value"))) {
            ...
            if (effect != CONST_ME_NONE) {
              ...
              std::cout << "[Warning - Monsters::deserializeSpell] "
                        << description
                        << " - Unknown areaEffect: " << attr.as_string()
                        << std::endl;
            }
          }
        } else {
          std::cout << "[Warning - Monsters::deserializeSpells] Effect type \""
  ...
  if (spell->isScripted) {
    ...
    if (tmpName == "melee") {
      ...
      if (spell->conditionType != CONDITION_NONE) {
        ...
        Condition* condition =
            getDamageCondition(conditionType, maxDamage, minDamage,
      ...
      if (spell->conditionType == CONDITION_NONE) {
        std::cout << "[Error - Monsters::deserializeSpell] - " << description
                  << " - Condition is not set for: " << spell->name
                  << std::endl;
      }
...
MonsterType* Monsters::loadMonster(const std::string& file,
  ...
  if (!monsterNode) {
    std::cout << "[Error - Monsters::loadMonster] Missing monster node in: "
              << file << std::endl;
    return nullptr;
  }
  ...
  if (!(attr = monsterNode.attribute("name"))) {
    std::cout << "[Error - Monsters::loadMonster] Missing name in: " << file
              << std::endl;
    return nullptr;
  }
  ...
  if ((attr = monsterNode.attribute("script"))) {
    ...
    if (scriptInterface->loadFile("data/monster/scripts/" + script) == 0) {
      ...
      std::cout << "[Warning - Monsters::loadMonster] Can not load script: "
                << script << std::endl;
  ...
  if ((node = monsterNode.child("health"))) {
    if ((attr = node.attribute("now"))) {
      ...
      std::cout << "[Error - Monsters::loadMonster] Missing health now. "
                << file << std::endl;
    }
    ...
    if ((attr = node.attribute("max"))) {
      ...
      std::cout << "[Error - Monsters::loadMonster] Missing health max. "
                << file << std::endl;
    }
  }
  ...
  if ((node = monsterNode.child("flags"))) {
    for (auto flagNode : node.children()) {
      ...
      if (strcasecmp(attrName, "summonable") == 0) {
        ...
        if (staticAttack > 100) {
          std::cout << "[Warning - Monsters::loadMonster] staticattack greater "
                       "than 100. "
                    << file << std::endl;
          staticAttack = 100;
        }
  ...
  if ((node = monsterNode.child("targetchange"))) {
    if ((attr = node.attribute("speed")) ||
      ...
      std::cout
          << "[Warning - Monsters::loadMonster] Missing targetchange speed. "
          << file << std::endl;
    }
    ...
    if ((attr = node.attribute("chance"))) {
      ...
      std::cout
          << "[Warning - Monsters::loadMonster] Missing targetchange chance. "
          << file << std::endl;
    }
  }
  ...
  if ((node = monsterNode.child("targetstrategies"))) {
    if ((attr = node.attribute("nearest"))) {
      mType->info.targetStrategiesNearestPercent =
          pugi::cast<int32_t>(attr.value());
    } else {
      std::cout << "[Warning - Monsters::loadMonster] Missing "
                   "targetStrategiesNearestPercent. "
                << file << std::endl;
    }

    if ((attr = node.attribute("health"))) {
      mType->info.targetStrategiesLowerHPPercent =
          pugi::cast<int32_t>(attr.value());
    } else {
      std::cout << "[Warning - Monsters::loadMonster] Missing "
                   "targetStrategiesLowerHPPercent. "
                << file << std::endl;
    }

    if ((attr = node.attribute("damage"))) {
      mType->info.targetStrategiesMostDamagePercent =
          pugi::cast<int32_t>(attr.value());
    } else {
      std::cout << "[Warning - Monsters::loadMonster] Missing "
                   "targetStrategiesMostDamagePercent. "
                << file << std::endl;
    }
  ...
  if ((node = monsterNode.child("look"))) {
    if ((attr = node.attribute("type"))) {
      ...
      std::cout
          << "[Warning - Monsters::loadMonster] Missing look type/typeex. "
          << file << std::endl;
    }
    ...
    for (auto immunityNode : node.children()) {
      if ((attr = immunityNode.attribute("name"))) {
        ...
        if (tmpStrValue == "physical") {
          ...
          std::cout
              << "[Warning - Monsters::loadMonster] Unknown immunity name "
              << attr.as_string() << ". " << file << std::endl;
        }
        ...
        std::cout << "[Warning - Monsters::loadMonster] Unknown immunity. "
                  << file << std::endl;
      }
    }
  }
  ...
  if ((node = monsterNode.child("voices"))) {
    if ((attr = node.attribute("speed")) ||
      ...
      std::cout << "[Warning - Monsters::loadMonster] Missing voices speed. "
                << file << std::endl;
    }
    ...
    if ((attr = node.attribute("chance"))) {
      ...
      std::cout << "[Warning - Monsters::loadMonster] Missing voices chance. "
                << file << std::endl;
    }
    ...
    for (auto voiceNode : node.children()) {
      ...
      if ((attr = voiceNode.attribute("sentence"))) {
        ...
        std::cout
            << "[Warning - Monsters::loadMonster] Missing voice sentence. "
            << file << std::endl;
      }
  ...
  if ((node = monsterNode.child("loot"))) {
    for (auto lootNode : node.children()) {
      ...
      if (loadLootItem(lootNode, lootBlock)) {
        ...
        std::cout << "[Warning - Monsters::loadMonster] Cant load loot. "
                  << file << std::endl;
      }
    }
  }
  ...
  if ((node = monsterNode.child("summons"))) {
    if ((attr = node.attribute("maxSummons"))) {
      ...
      std::cout
          << "[Warning - Monsters::loadMonster] Missing summons maxSummons. "
          << file << std::endl;
    }
    ...
    for (auto summonNode : node.children()) {
      ...
      if ((attr = summonNode.attribute("name"))) {
        ...
        std::cout << "[Warning - Monsters::loadMonster] Missing summon name. "
                  << file << std::endl;
      }
    }
  }
  ...
  if ((node = monsterNode.child("script"))) {
    for (auto eventNode : node.children()) {
      if ((attr = eventNode.attribute("name"))) {
        ...
        std::cout << "[Warning - Monsters::loadMonster] Missing name for "
                     "script event. "
                  << file << std::endl;
      }
    }
...
bool MonsterType::loadCallback(LuaScriptInterface* scriptInterface) {
  ...
  if (id == -1) {
    std::cout << "[Warning - MonsterType::loadCallback] Event not found. "
              << std::endl;
    return false;
  }
...
bool Monsters::loadLootItem(const pugi::xml_node& node, LootBlock& lootBlock) {
  ...
  if ((attr = node.attribute("id"))) {
    ...
    if (ids.first == Item::items.nameToItems.cend()) {
      std::cout << "[Warning - Monsters::loadMonster] Unknown loot item \""
                << name << "\". " << std::endl;
      return false;
    }
    ...
    if (std::next(ids.first) != ids.second) {
      std::cout << "[Warning - Monsters::loadMonster] Non-unique loot item \""
                << name << "\". " << std::endl;
      return false;
    }

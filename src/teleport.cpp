...
ReturnValue Teleport::queryAdd(int32_t /*index*/, const Thing& /*thing*/, uint32_t /*count*/, uint32_t /*flags*/, Creature* /*actor*/) const
{
	return RETURNVALUE_NOTPOSSIBLE;
}

ReturnValue Teleport::queryMaxCount(int32_t /*index*/, const Thing& /*thing*/, uint32_t /*count*/, uint32_t& /*maxQueryCount*/, uint32_t /*flags*/) const
{
	return RETURNVALUE_NOTPOSSIBLE;
}
...
Cylinder* Teleport::queryDestination(int32_t& /*index*/, const Thing& /*thing*/, Item** /*destItem*/, uint32_t& /*flags*/)
{
	return this;
}
...
void Teleport::postAddNotification(Thing* thing, const Cylinder* oldParent, int32_t index, cylinderlink_t /*link*/)
{
	getParent()->postAddNotification(thing, oldParent, index, LINK_PARENT);
}

void Teleport::postRemoveNotification(Thing* thing, const Cylinder* newParent, int32_t index, cylinderlink_t /*link*/)
{

...
[![Discord Channel](https://img.shields.io/discord/298969150133370880.svg?style=flat-square&logo=discord)](https://discord.gg/3NxYnyV)
![GitHub issues](https://img.shields.io/github/issues/opentibiabr/otservbr-global)
![GitHub pull requests](https://img.shields.io/github/issues-pr/opentibiabr/otservbr-global)
[![Contributors](https://img.shields.io/github/contributors/opentibiabr/otservbr-global.svg?style=flat-square)](https://github.com/opentibiabr/otservbr-global/issues)
![GitHub](https://img.shields.io/github/license/opentibiabr/otservbr-global)
...
* Wiki: Compiling on Linux ([Debian](https://github.com/opentibiabr/otservbr-global/wiki/Compiling-on-Debian-GNU-Linux), [Ubuntu]([Link](https://github.com/opentibiabr/otservbr-global/wiki/Compiling-on-Ubuntu)), [Windows]([link](https://github.com/opentibiabr/otservbr-global/wiki/Compiling-on-Windows-(vcpkg))))
...
* Focus on fixing only one thing, mixing too much things on the same Pull Request make it harder to review, harder to test and if we need to revert the change it will remover other things together.

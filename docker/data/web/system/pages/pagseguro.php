...
$paymentRequest->setRedirectUrl('http:' . BASE_URL . $config['pagSeguro']['urlRedirect']);
$paymentRequest->addParameter('notificationURL', 'http:' . BASE_URL . 'payments/pagseguro.php');

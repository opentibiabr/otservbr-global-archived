local servants = {
	['golden servant replica'] = {storage = GlobalStorage.ForgottenKnowledge.GoldenServant, playerStorage = Storage.ForgottenKnowledge.GoldenServantCounter},
	['diamond servant replica'] = {storage = GlobalStorage.ForgottenKnowledge.DiamondServant, playerStorage = Storage.ForgottenKnowledge.DiamondServantCounter}
}

function onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	...
	broadcastMessage("The remains of the Raging Mage are scattered on the floor of his Tower.\
	The dimensional portal quakes.", MESSAGE_EVENT_ADVANCE)
	targetMonster:say("I WILL RETURN!! My death will just be a door to await my homecoming,\
	...
	addEvent(function()
		...
		tilePos:remove()
		broadcastMessage("With a great bang the dimensional portal in Zao collapsed and\

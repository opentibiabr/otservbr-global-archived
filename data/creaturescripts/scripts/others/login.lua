...
function onLogin(player)
  ...
  --  bestiary:updateBestiary(player)
    ...
    if player:getStorageValue(63352) < 1 then
        player:setStorageValue(63353, 0)
        player:setStorageValue(63352, 1)
    end

    if player:getStorageValue(63452) < 1 then
        player:setStorageValue(63453, 0)
        player:setStorageValue(63452, 1)
    end

...
local function creatureSayCallback(npc, creature, type, message)
	...
	if msgcontains(message, "mission") then
		if player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 10 then
			if player:getPosition().z == 12 and player:getStorageValue(Storage.WrathoftheEmperor.GhostOfAPriest01) < 1 and npcHandler.topic[playerId] ~= 1 then
				npcHandler:say({
	...
	elseif msgcontains(message, "no") and npcHandler.topic[playerId] then

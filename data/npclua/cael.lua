...
local function creatureSayCallback(npc, creature, type, message)
	...
	if msgcontains(message, "tome") or msgcontains(message, "knowledge") then
		...
		if player:getStorageValue(Storage.TheNewFrontier.Mission08) == 2 then
			...
			elseif player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge) >= 1 and player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge) <= 5 then --tome2 - tome6
				...
				npcHandler.topic[playerId] = player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge)+1
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[playerId] >= 1 and npcHandler.topic[playerId] <= 13 then
		if player:removeItem(11134, 1) then --remove tome
			if npcHandler.topic[playerId] == 1 then	--tome1
			...
			elseif npcHandler.topic[playerId] >= 2 and npcHandler.topic[playerId] <= 12 then --tome2 - tome12
				npcHandler:say("Thank you! I look forward to reading this interesting discovery of yours and learn a few things about {Zao}.", npc, creature)
				...
				npcHandler.topic[playerId] = player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge)+20
			elseif npcHandler.topic[playerId] == 13 then -- more then 12 tomes
	...
	elseif(msgcontains(message, "zao")) then
		if npcHandler.topic[playerId] == 21 then	--tome1
		...
		elseif npcHandler.topic[playerId] == 22 then	--tome2
		...
		elseif npcHandler.topic[playerId] == 30 then	--tome10
			...
			npcHandler.topic[playerId] = 49
		elseif npcHandler.topic[playerId] == 31 then	--tome11
		...
		elseif npcHandler.topic[playerId] == 32 then	--tome12
		...
		elseif npcHandler.topic[playerId] == 33 then	--more than tome12
	...
	elseif(msgcontains(message, "lizard")) then --tome1
		if npcHandler.topic[playerId] == 40 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "minotaur")) then --tome2
		if npcHandler.topic[playerId] == 41 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "draken")) then --tome3
		if npcHandler.topic[playerId] == 42 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "food")) then --tome4
		if npcHandler.topic[playerId] == 43 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "zzaion")) then --tome5
		if npcHandler.topic[playerId] == 44 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "human")) then --tome6
		if npcHandler.topic[playerId] == 45 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "steppe")) then --tome7
		if npcHandler.topic[playerId] == 46 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "corruption")) then --tome8
		if npcHandler.topic[playerId] == 47 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "origin")) then --tome9
		if npcHandler.topic[playerId] == 48 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "founder")) then --tome10
		if npcHandler.topic[playerId] == 49 then
			npcHandler:say({
	...
	elseif(msgcontains(message, "thrones")) then --tome12
		if npcHandler.topic[playerId] == 51 then
			npcHandler:say({
	...
	elseif msgcontains(message, "lantern") then
		if player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge) >= 11 then
			...
			npcHandler.topic[playerId] = 65
		end
	elseif msgcontains(message, "yes") and npcHandler.topic[playerId] == 65 then
	...
	elseif msgcontains(message, "cloth") then
		if player:getStorageValue(Storage.TheNewFrontier.TomeofKnowledge) >= 12 then
			...
			npcHandler.topic[playerId] = 66
		end
	elseif msgcontains(message, "yes") and npcHandler.topic[playerId] == 66 then
	...
	elseif msgcontains(message, "crest") then
		...
		elseif player:hasOutfit(player:getSex() == PLAYERSEX_FEMALE and 336 or 335) and player:getItemCount(11115) > 0 then
			...
			npcHandler.topic[playerId] = 61
		else
			npcHandler:say("You don't have a Warmaster Outfit or the crest to get the Addons.", npc, creature)
			npcHandler.topic[playerId] = 0
		end
	elseif msgcontains(message, "yes") and npcHandler.topic[playerId] >= 60 and npcHandler.topic[playerId] <= 61 then
		if npcHandler.topic[playerId] == 60 then
		...
		elseif npcHandler.topic[playerId] == 61 then

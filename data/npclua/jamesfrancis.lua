...
local function creatureSayCallback(npc, creature, type, message)
	local player = Player(creature)
	-- Start quest
	if msgcontains(message, "mystery") and npcHandler.topic[creature] == 1 then
	...
	elseif msgcontains(message, "favour") and npcHandler.topic[creature] == 2 then
	...
	elseif msgcontains(message, "mission") and npcHandler.topic[creature] == 5 then

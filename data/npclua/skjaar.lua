...
local function creatureSayCallback(npc, creature, type, message)	local player = Player(creature)
	...
	elseif msgcontains(message, 'redips') and npcHandler.topic[creature] == 3 then
	...
	elseif msgcontains(message, '7') and npcHandler.topic[creature] == 4 then
	...
	elseif msgcontains(message, 'black') and npcHandler.topic[creature] == 5 then

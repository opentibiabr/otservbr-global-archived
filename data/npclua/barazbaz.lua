...
function creatureSayCallback(npc, creature, type, message)
	...
	elseif(msgcontains(message, "notebook")) and (player:getStorageValue(Storage.DarkTrails.Mission11) == 1 and getPlayerItemCount(creature, 12406) == 1) then
		npcHandler:say({
		...
		doPlayerRemoveItem(creature,12406, 1)
	else

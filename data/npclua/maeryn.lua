...
function creatureSayCallback(npc, creature, type, message)
	 if not npcHandler:isFocused(creature) then
		  if message == "hi" or message == "hello" then
			   npcHandler:say("Greetings, visitor. I wonder what may lead you to this {dangerous} place.", npc, creature)
	 ...
	 elseif isInArray({'knight', 'sorcerer', 'druid', 'paladin'}, message:lower()) and npcHandler.topic[creature] == 2  then
	 ...
	 elseif isInArray({'axe', 'club', 'sword'}, message:lower()) and npcHandler.topic[creature] == 3 then
	 ...
	 elseif msgcontains(message, 'bye') then
		  npcHandler:say("Farewell, then.", npc, creature)

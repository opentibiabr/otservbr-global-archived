...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message,'yes') and npcHandler.topic[playerId] <= 4 and npcHandler.topic[playerId] >= 1 then
		local trade = {
	...
	elseif msgcontains(message,'no') and (npcHandler.topic[playerId] >= 1 and npcHandler.topic[playerId] <= 5) then

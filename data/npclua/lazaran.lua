...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "peace") and npcHandler.topic[creature] == 10 and player:getStorageValue(Storage.TheNewFrontier.Questline) == 9 then
	...
	elseif msgcontains(message, "mission") and npcHandler.topic[creature] == 12 and player:getStorageValue(Storage.UnnaturalSelection.Questline) < 1 

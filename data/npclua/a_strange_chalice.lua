...
local function creatureSayCallback(npc, creature, type, message)
	...
	if msgcontains(message, "daughter") and npcHandler.topic[creature] == 1 then
		npcHandler:say({
	...
	if msgcontains(message, "story") and npcHandler.topic[creature] == 2 then
		npcHandler:say({
	...
	if msgcontains(message, "disguised") and npcHandler.topic[creature] == 3 then
		npcHandler:say({
	...
	if msgcontains(message, "thirsty") and npcHandler.topic[creature] == 4 then
		npcHandler:say({
	...
	if msgcontains(message, "learned") and npcHandler.topic[creature] == 5 then
		npcHandler:say({

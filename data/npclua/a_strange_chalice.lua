...
local function creatureSayCallback(npc, creature, type, message)
	...
	if msgcontains(message, "daughter") and npcHandler.topic[playerId] == 1 then
		npcHandler:say({
	...
	if msgcontains(message, "story") and npcHandler.topic[playerId] == 2 then
		npcHandler:say({
	...
	if msgcontains(message, "disguised") and npcHandler.topic[playerId] == 3 then
		npcHandler:say({
	...
	if msgcontains(message, "thirsty") and npcHandler.topic[playerId] == 4 then
		npcHandler:say({
	...
	if msgcontains(message, "learned") and npcHandler.topic[playerId] == 5 then
		npcHandler:say({

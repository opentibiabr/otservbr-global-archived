...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif(msgcontains(message, "armor")) and npcHandler.topic[playerId] == 2 then
	...
	elseif(msgcontains(message, "helmet")) and npcHandler.topic[playerId] == 2 then
	...
	elseif(msgcontains(message, "boots")) and npcHandler.topic[playerId] == 2 then

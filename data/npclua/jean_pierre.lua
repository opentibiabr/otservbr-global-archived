...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "rotworm stew") then
		if npcHandler.topic[playerId] == 4 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "hydra tongue salad") then
		if npcHandler.topic[playerId] == 6 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "roasted dragon wings") then
		if npcHandler.topic[playerId] == 8 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "tropical fried terrorbird") then
		if npcHandler.topic[playerId] == 10 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "banana chocolate shake") then
		if npcHandler.topic[playerId] == 12 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "veggie casserole") then
		if npcHandler.topic[playerId] == 14 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "filled jalapeño peppers") then
		if npcHandler.topic[playerId] == 16 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "blessed steak") then
		if npcHandler.topic[playerId] == 18 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "northern fishburger") then
		if npcHandler.topic[playerId] == 20 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "carrot cake") then
		if npcHandler.topic[playerId] == 22 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "coconut shrimp bake") then
		if npcHandler.topic[playerId] == 24 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "blackjack") then
		if npcHandler.topic[playerId] == 26 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "demonic candy ball") then
		if npcHandler.topic[playerId] == 28 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	--	if npcHandler.topic[playerId] == 30 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then

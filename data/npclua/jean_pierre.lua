...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "rotworm stew") then
		if npcHandler.topic[creature] == 4 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "hydra tongue salad") then
		if npcHandler.topic[creature] == 6 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "roasted dragon wings") then
		if npcHandler.topic[creature] == 8 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "tropical fried terrorbird") then
		if npcHandler.topic[creature] == 10 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "banana chocolate shake") then
		if npcHandler.topic[creature] == 12 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "veggie casserole") then
		if npcHandler.topic[creature] == 14 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "filled jalapeño peppers") then
		if npcHandler.topic[creature] == 16 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "blessed steak") then
		if npcHandler.topic[creature] == 18 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "northern fishburger") then
		if npcHandler.topic[creature] == 20 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "carrot cake") then
		if npcHandler.topic[creature] == 22 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "coconut shrimp bake") then
		if npcHandler.topic[creature] == 24 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "blackjack") then
		if npcHandler.topic[creature] == 26 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	elseif msgcontains(message, "demonic candy ball") then
		if npcHandler.topic[creature] == 28 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then
	...
	--	if npcHandler.topic[creature] == 30 or player:getStorageValue(Storage.HotCuisineQuest.QuestStart) == 2 then

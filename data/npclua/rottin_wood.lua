...
function creatureSayCallback(npc, creature, type, message)	if(msgcontains(message, "mission") or msgcontains(message, "task")) then
	...
	elseif(msgcontains(message, "yes")) then
		...
		elseif(npcHandler.topic[creature] == 2) then
			...
			npcHandler.topic[creature] = 0
		elseif(npcHandler.topic[creature] == 3) and getPlayerItemCount(creature, 13160) >= 7 then
			...
			elseif(npcHandler.topic[creature] == 3) and getPlayerItemCount(creature, 13160) <= 6 then

...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif npcHandler.topic[playerId] == 2 then
		if player:removeMoneyNpc(Price[playerId]) then
		...
		npcHandler.topic[playerId] = nil
		Price[playerId] = nil
	elseif npcHandler.topic[playerId] == 3 and player:removeItem(2036, 1) then
		npcHandler:say("Take some time to talk to me!", npc, creature)
		npcHandler.topic[playerId] = nil
	elseif npcHandler.topic[playerId] == 4 and (msgcontains(message, "spouse") or msgcontains(message, "girlfriend")) then
		npcHandler:say("Well ... I have met him for a little while .. but this was nothing serious.", npc, creature)
		npcHandler.topic[playerId] = 5
	elseif npcHandler.topic[playerId] == 5 and msgcontains(message, "fruit") then

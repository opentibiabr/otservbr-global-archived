...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "yes") then
		...
		elseif npcHandler.topic[playerId] == 4 then
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 5 then -- Wings
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 6 then -- Paws
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 7 then -- Eyes
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 8 then -- Fins
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 9 then -- Scale
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[playerId] == 13 then
		if npcHandler.topic[playerId] == 13 and player:removeMoneyBank(400) then

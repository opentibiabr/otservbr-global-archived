...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "yes") then
		...
		elseif npcHandler.topic[creature] == 4 then
			...
			npcHandler.topic[creature] = 0
		elseif npcHandler.topic[creature] == 5 then -- Wings
			...
			npcHandler.topic[creature] = 0
		elseif npcHandler.topic[creature] == 6 then -- Paws
			...
			npcHandler.topic[creature] = 0
		elseif npcHandler.topic[creature] == 7 then -- Eyes
			...
			npcHandler.topic[creature] = 0
		elseif npcHandler.topic[creature] == 8 then -- Fins
			...
			npcHandler.topic[creature] = 0
		elseif npcHandler.topic[creature] == 9 then -- Scale
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 13 then
		if npcHandler.topic[creature] == 13 and player:removeMoneyNpc(400) then

...
local function creatureSayCallback(npc, creature, type, message)
	...
	if msgcontains(message, "healing") and npcHandler.topic[creature] == 0 then
	...
	elseif msgcontains(message, "help") and npcHandler.topic[creature] == 0 then
	...
	-- Vocation dialog
	elseif npcHandler.topic[creature] == 0 and msgcontains(message, "vocation") then
		npcHandler:say(vocationDefaultMessages,	npc, creature, 10)
		npcHandler.topic[creature] = 0
	-- Choosing dialog start
	elseif msgcontains(message, "choosing") or msgcontains(message, "choose") and npcHandler.topic[creature] == 0 then
		if player:getLevel() >= 8 then
	...
	elseif msgcontains(message, "distance") and npcHandler.topic[creature] == 2 then
		npcHandler:say("Tell me: Do you prefer to fight with {bow} and {spear}, or do you want to cast {magic}?", npc, creature)
		npcHandler.topic[creature] = 3
	-- knight
	elseif msgcontains(message, "close") and npcHandler.topic[creature] == 2 then
		npcHandler:say(
			{
	...
	-- Paladin
	elseif msgcontains(message, "bow") or msgcontains(message, "spear") and npcHandler.topic[creature] == 3 then
		npcHandler:say(
			{
	...
	-- Mage
	elseif msgcontains(message, "magic") and npcHandler.topic[creature] == 3 then
	...
	-- Druid
	elseif msgcontains(message, "heal") and npcHandler.topic[creature] == 4 then
		npcHandler:say(
			{
	...
	-- Sorcerer
	elseif msgcontains(message, "death") and npcHandler.topic[creature] == 4 then
		npcHandler:say(
			{
	...
	-- Choosing dialog start
	elseif msgcontains(message, "decided") and npcHandler.topic[creature] == 0 then
		npcHandler:say("So tell me, which {vocation} do you want to choose: {knight}, {sorcerer}, {paladin} or {druid}?", npc, creature)
	-- Say vocations name
	elseif msgcontains(message, "sorcerer") and npcHandler.topic[creature] == 0 then
		local message = {
	...
	elseif msgcontains(message, "druid") and npcHandler.topic[creature] == 0 then
		local message = {
		...
		npcHandler:say(message, npc, creature, 10)
	elseif msgcontains(message, "paladin") and npcHandler.topic[creature] == 0 then
		local message = {
		...
		npcHandler:say(message, npc, creature, 10)
	elseif msgcontains(message, "knight") and npcHandler.topic[creature] == 0 then
		local message = {
		...
		npcHandler:say(message, npc, creature, 10)
	elseif ((npcHandler.topic[creature] >= 5) and (npcHandler.topic[creature] <= 8)) then
		if msgcontains(message, "yes") then
			for index, value in pairs(topicTable) do
				if npcHandler.topic[creature] == index then
			...
			npcHandler:say(
				{
					...
					vocationMessage[npcHandler.topic[creature]]..
					" vocation, tell me.",
				},
			npc, creature, 10)
			npcHandler.topic[creature] = 0

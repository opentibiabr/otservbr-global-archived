...
function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "rumours") and npcHandler.topic[creature] == 1 then
	...
	elseif msgcontains(message, "descendants") and npcHandler.topic[creature] == 2 then
	...
	elseif msgcontains(message, "draconic incitements") and npcHandler.topic[creature] == 3 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 5 then

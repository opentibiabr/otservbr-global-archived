...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 1 and player:getStorageValue(Storage.Kilmaresh.Twelve.Boss) == 1 then
		if player:getStorageValue(Storage.Kilmaresh.Twelve.Boss) == 1 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 3 and player:getStorageValue(Storage.Kilmaresh.Twelve.Boss) == 2 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 5 and player:getStorageValue(Storage.Kilmaresh.Twelve.Boss) == 3 then
		if player:getStorageValue(Storage.Kilmaresh.Twelve.Boss) == 3 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 7 and player:getStorageValue(Storage.Kilmaresh.Thirteen.Fafnar) == 300 then
		if player:getStorageValue(Storage.Kilmaresh.Thirteen.Fafnar) == 300 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 9 and player:getStorageValue(Storage.Kilmaresh.Thirteen.Lyre) == 3 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 11 and player:getStorageValue(Storage.Kilmaresh.Thirteen.Presente) == 2 then
	...
	elseif msgcontains(message, "yes") and npcHandler.topic[creature] == 13 and player:getStorageValue(Storage.Kilmaresh.Thirteen.Fafnar) == 301 then
		if player:getStorageValue(Storage.Kilmaresh.Thirteen.Fafnar) == 301 then

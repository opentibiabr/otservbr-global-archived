...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "warrior's sword") then
		...
		elseif player:getStorageValue(Storage.OutfitQuest.WarriorSwordAddon) == 1 and npcHandler.topic[creature] == 1 then
	...
	elseif msgcontains(message, "knight's sword") then
		...
		elseif player:getStorageValue(Storage.OutfitQuest.Knight.AddonSword) == 1 and npcHandler.topic[creature] == 1 then

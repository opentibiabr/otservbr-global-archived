...
function creatureSayCallback(npc, creature, type, message)	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or creature
	...
	if msgcontains(message, 'reward') and npcHandler.topic[creature] == 0 and player:getStorageValue(34013) < 1 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'fight') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'retirement') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'memoirs') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'hassle') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'worthy') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'weaknesses') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'mists') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'world') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'books') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'invention') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'adapt') and npcHandler.topic[creature] == 0 then
		npcHandler:say({
	...
	elseif msgcontains(message, 'finer') and npcHandler.topic[creature] == 0 then
		npcHandler:say({

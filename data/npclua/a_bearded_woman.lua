...
npcType.onSay = function(npc, creature, type, message)
    return npc:processOnSay(
        ...
        creature:getPlayer(),
        {
            ["hi"] = NpcInteraction:new("GET ME OUT OF HERE! NOW!", messageTypes.MESSAGE_GREET),
            ["job"] = NpcInteraction:new("I am a great and famous actor! Not a princess, at all. I was only PRETENDING to be a princess. But try explaining that to those stupid pirates."),
            ["actor"] = NpcInteraction:new("Stage acting was a waste of my immense talent. Not only am I a born leader, my talent is more profitable when it is used for conning people."),
            ["stage"] = NpcInteraction:new("Stage acting was a waste of my immense talent. Not only am I a born leader, my talent is more profitable when it is used for conning people."),
            ["kid"] = NpcInteraction:new("He was always a fool with a heart too soft to become a feared pirate"),
            ["princess"] = NpcInteraction:new("Me playing a princess was just part of a cunning plan we had"),
            ["cell"] = NpcInteraction:new("If you find some way to release me I might even let you live as reward! So you'd better do your best or I'll kill you!"),
            ["name"] = NpcInteraction:new("How dare you? I left to rot in this dirty cell and you have nothing better to do than chit chat?"),
            ["rot"] = NpcInteraction:new("YOU .. YOU .. You are as good as dead! I will get you! Do you hear me? I will have your head! On a platter!"),
            ["pirate"] = NpcInteraction:new({

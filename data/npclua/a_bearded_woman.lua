...
local configs = {
    ...
    ["actor"] = {
        message = "Stage acting was a waste of my immense talent. Not only am I a born leader, my talent is more profitable when it is used for conning people.",
    }
    ["stage"] = {
        message = "Stage acting was a waste of my immense talent. Not only am I a born leader, my talent is more profitable when it is used for conning people.",
    }
    ["kid"] = {
        message = "He was always a fool with a heart too soft to become a feared pirate",
    }
    ["princess"] = {
        message = "Me playing a princess was just part of a cunning plan we had",
    }
    ["cell"] = {
        message = "If you find some way to release me I might even let you live as reward! So you'd better do your best or I'll kill you!",
    }
    ["name"] = {
        message = "How dare you? I left to rot in this dirty cell and you have nothing better to do than chit chat?",
    }
    ["rot"] = {
        message = "YOU .. YOU .. You are as good as dead! I will get you! Do you hear me? I will have your head! On a platter!",
    }
    ["pirate"] = {
         message = {

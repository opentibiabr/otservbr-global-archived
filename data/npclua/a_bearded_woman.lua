...
npcType.onSay = function(npc, creature, type, message)
    return npc:processOnSay(
        ...
        creature:getPlayer(),
        {
            ...
            ["kid"] = NpcConfig:new("He was always a fool with a heart too soft to become a feared pirate"),
            ["princess"] = NpcConfig:new("Me playing a princess was just part of a cunning plan we had"),
            ["cell"] = NpcConfig:new("If you find some way to release me I might even let you live as reward! So you'd better do your best or I'll kill you!"),
            ["name"] = NpcConfig:new("How dare you? I left to rot in this dirty cell and you have nothing better to do than chit chat?"),
            ["rot"] = NpcConfig:new("YOU .. YOU .. You are as good as dead! I will get you! Do you hear me? I will have your head! On a platter!"),
            ["pirate"] = NpcConfig:new({

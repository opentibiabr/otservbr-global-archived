...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif msgcontains(message, "278") and npcHandler.topic[creature] == 9 then
	...
	elseif (msgcontains(message, "164") or msgcontains(message, "89")) and npcHandler.topic[creature] == 9 then

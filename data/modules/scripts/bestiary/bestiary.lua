...
Bestiary.sendMonsterData = function(player, msg)
    ...
    if currentLevel > 3 then
		...
		-- if charm is actived for this monster
		-- msg:addByte(1) -- unlock charm selection
		-- msg:addByte(1) -- charm id selected
		-- msg:addU32(0) -- unknow value
    end

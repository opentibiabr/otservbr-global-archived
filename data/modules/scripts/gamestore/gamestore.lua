--[[
    Review: 06/11/2019 by CoehManeh | Content: Organization and adde new items. | Pendency: Check all items in game,
    mainly the commented ones. Search for "-- repair" and add the correct ID's.

    Items have been updated so that if the offer type is not one of the types:
    OFFER_TYPE_OUTFIT, OFFER_TYPE_OUTFIT_ADDON, OFFER_TYPE_MOUNT, OFFER_TYPE_NAMECHANGE,
    OFFER_TYPE_SEXCHANGE, OFFER_TYPE_PROMOTION, OFFER_TYPE_EXPBOOST, OFFER_TYPE_PREYSLOT,
    OFFER_TYPE_PREYBONUS, OFFER_TYPE_TEMPLE, OFFER_TYPE_BLESSINGS, OFFER_TYPE_PREMIUM,
...
GameStore.Categories = {
    ...
    }, 
    {
        ...
        offers = { 
                    ...
                    {
                        icons = { "Ultimate_Ultimate_Spirit_Keg.png" }, -- repair
    ...
    },
    {
        ...
        offers = {
                    ...
                    }, 
                    {
                        ...
                        price = 870,
                        id = 105,
                        description = "- only usable by purchasing character\n- provides character with a speed boost\n\nDo you like fluffy bunnies but think they are too small? Do you admire the majesty of stags and their antlers but are afraid of their untameable wilderness? Do not worry, the mystic creature Wolpertinger consolidates the best qualities of both animals. Hop on its backs and enjoy the ride.",
                        type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
                    }, 
                    {
    ...
    {
        -- ... outfit has addon = 0 or no defined addon. By default addon is set to 0.
    ...
    },
    {
        ...
        offers = {
                    ...
                    --     price = 90,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to turn the lights on or off\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    --     icons = { "Bath_Tub.png" },
                    ...
                    --     price = 250,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use some liquid on it to draw a bath\n- use it when filled to throw out the bath water\n- when filled all characters that have access to the house can walk on it to take a swim\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 100,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- drag the unwrapped painting to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 250,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- drag the unwrapped paintings to a wall to hand them up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 100,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- drag the unwrappedpainting to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 50,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- drag the unwrapped cupboard to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 180,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to light or quench the fire\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 180,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to light or extinguish the candles\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 100,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- put it on the floor or drag the unwrapped skull to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    --     icons = { "Idol_Lamp.png" },
                    ...
                    --     price = 120,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to lit or blow out the candle\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 50,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- put it on the floor or drag the unwrapped treasure map to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 25,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use an unwrapped tile to lay it out or to pile it back up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 80,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- put it on the floor or drag the unwrapped trophy to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 100,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to take some delicious food\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 180,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- give it a banana to trigger an animation\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 50,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- put it on the floor or drag the unwrapped flag to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 50,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- put it on the floor or drag the unwrapped ship's wheel to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 120,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to change the colour of the lamp's light or to turn it off\n- drag the unwrapped torch to a wall to hang it up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 120,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- \n- tells time, day, cycle and year when used\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    --     price = 90,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use it to display a pair of the finest spears or to hide it\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    },
                    {
                        ...
                        price = 30,
                        count = 1,
                        description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use the unwrapped marble to attach it to the floor or to unstick it from it\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                        type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    },
                    {
                        ...
                        price = 30,
                        count = 1,
                        description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use the unwrapped parquet to install it or to pile it back up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                        type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        price = 25,
                        count = 1,
                        description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use an unwrapped plank to roll it out or up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                        type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    },
                    {
                        icons = { "Red_Roses.png" },
                    ...
                    },
                    {
                        ...
                        price = 25,
                        count = 1,
                        description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in a box which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use an unwrapped mat to roll it out or up\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                        type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    },
                    {
                    ...
                    -- },
                    -- {
                    --     icons = { "Magnificent_Furniture.png" },
                    --     name = "Magnificent Furniture",
                    --     id = 26074, -- repair
                    --     price = 290,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or trunk to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    --     icons = { "Vengothic_Furniture.png" },
                    --     name = "Vengothic Furniture",
                    --     id = 26074, -- repair
                    --     price = 280,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or chest to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    ...
                    -- },
                    -- {
                    --     icons = { "Comfy_Furniture.png" },
                    --     name = "Comfy Furniture",
                    --     id = 26074, -- repair
                    --     price = 290,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or chest to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    ...
                    -- },
                    -- {
                    --     icons = { "Dwarven_Stone_Furniture.png" },
                    --     name = "Dwarven Stone Furniture",
                    --     id = 26074, -- repair
                    --     price = 280,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or chest to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    ...
                    -- },
                    -- {
                    --     icons = { "Ferocious_Furniture.png" },
                    --     name = "Ferocious Furniture",
                    --     id = 26074, -- repair
                    --     price = 290,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or trunk to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    ...
                    -- },
                    -- {
                    --     icons = { "Hrodmir_Furniture.png" },
                    --     name = "Hrodmir Furniture",
                    --     id = 26074, -- repair
                    --     price = 280,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cupboard or chest to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    --     type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
                    -- },
                    -- {
                    --     icons = { "Ornate_Furniture.png" },
                    ...
                    -- },
                    -- {
                    --     icons = { "Skeletal_Furniture.png" },
                    --     name = "Skeletal Furniture",
                    --     id = 26074, -- repair
                    --     price = 280,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or chest to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    ...
                    -- },
                    -- {
                    --     icons = { "Verdant_Furniture.png" },
                    --     name = "Verdant Furniture",
                    --     id = 26074, -- repair
                    --     price = 280,
                    --     count = 1,
                    --     description = "- can only be unwrapped in a house owned by the purchasing character\n- comes in boxes which can only be unwrapped by purchasing character\n- will be sent to your Store inbox and can only be stored there and in depot box\n- use cabinet or trunk to open up some storage space\n- will be wrapped back and sent to inbox if the purchasing character is no longer the house owner",
                    ...
                    --     type = GameStore.OfferTypes.KKKKKKKKKK,
                    -- },

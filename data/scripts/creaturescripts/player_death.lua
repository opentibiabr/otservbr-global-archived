local creaturescript = CreatureEvent("Player Death")

local deathListEnabled = true
local maxDeathRecords = 5

function creaturescript.onDeath(player, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)

local familiar = {
	[VOCATION.BASE_ID.SORCERER] = {id = 1239, name = "Sorcerer familiar"},
	[VOCATION.BASE_ID.DRUID] = {id = 1238, name = "Druid familiar"},
	[VOCATION.BASE_ID.PALADIN] = {id = 1237, name = "Paladin familiar"},
	[VOCATION.BASE_ID.KNIGHT] = {id = 1236, name = "Knight familiar"}
}

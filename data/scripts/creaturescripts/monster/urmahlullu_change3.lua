local config = {
	...
	{chance = 100, monster = 'Wisdom of Urmahlullu', message = ''}
}

local UrmahlulluThirdDeath = CreatureEvent("UrmahlulluThirdDeath")
function UrmahlulluThirdDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)

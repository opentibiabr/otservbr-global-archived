local config = {
	...
	{chance = 100, monster = 'Urmahlullu the Weakened', message = ''}
}

local UrmahlulluLastDeath = CreatureEvent("UrmahlulluLastDeath")
function UrmahlulluLastDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)

local config = {
	...
	{chance = 100, monster = 'Wildness of Urmahlullu', message = ''}
}

local UrmahlulluFirstDeath = CreatureEvent("UrmahlulluFirstDeath")
function UrmahlulluFirstDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)

...
-- strange mallet
local strangeMallet = Weapon(WEAPON_CLUB)
strangeMallet:id(27523)
strangeMallet:attack(18)
strangeMallet:defense(9)
strangeMallet:register()

-- mallet handle
local malletHandle = Weapon(WEAPON_CLUB)
malletHandle:id(27525)
malletHandle:attack(24)
malletHandle:defense(14)
malletHandle:register()

-- zathroth' redeemer
local zathrothRedeemer = Weapon(WEAPON_CLUB)
zathrothRedeemer:id(28746,28747,28748,28749)
zathrothRedeemer:slotType("two-handed")
zathrothRedeemer:register()
...
-- rotten demonbone
local rottenDemonbone = Weapon(WEAPON_CLUB)
rottenDemonbone:id(28829)
rottenDemonbone:level(80)
rottenDemonbone:attack(46)
rottenDemonbone:defense(40,-1)
rottenDemonbone:wieldUnproperly(true)
rottenDemonbone:register()

-- energized demonbone
local energizedDemonbone = Weapon(WEAPON_CLUB)
energizedDemonbone:id(28830)
energizedDemonbone:level(80)
energizedDemonbone:attack(46)
energizedDemonbone:defense(40,-1)
energizedDemonbone:wieldUnproperly(true)
energizedDemonbone:register()

-- unliving demonbone
local unlivingDemonbone = Weapon(WEAPON_CLUB)
unlivingDemonbone:id(28831)
unlivingDemonbone:level(80)
unlivingDemonbone:attack(46)
unlivingDemonbone:defense(40,-1)
unlivingDemonbone:wieldUnproperly(true)
unlivingDemonbone:register()

-- sulphurous demonbone
local sulphurousDemonbone = Weapon(WEAPON_CLUB)
sulphurousDemonbone:id(28832)
sulphurousDemonbone:level(80)
sulphurousDemonbone:attack(46)
sulphurousDemonbone:defense(40,-1)
sulphurousDemonbone:wieldUnproperly(true)
sulphurousDemonbone:register()
...
-- resizer
local resizer = Weapon(WEAPON_CLUB)
resizer:id(29419)
resizer:level(180)
resizer:attack(13)
resizer:defense(40)
resizer:wieldUnproperly(true)
--iceRapier:extraElement(39, "ice")
resizer:slotType("two-handed")
resizer:vocation("knight", true, true)
resizer:vocation("elite knight")
resizer:register()

-- mace of destruction
local maceOfDestruction = Weapon(WEAPON_CLUB)
maceOfDestruction:id(27453)
maceOfDestruction:level(200)
maceOfDestruction:attack(50)
maceOfDestruction:defense(30)
maceOfDestruction:wieldUnproperly(true)
maceOfDestruction:vocation("knight", true, true)
maceOfDestruction:vocation("elite knight")
maceOfDestruction:register()
	
-- hammer of destruction
local hammerOfDestruction = Weapon(WEAPON_CLUB)
hammerOfDestruction:id(27454)
hammerOfDestruction:level(200)
hammerOfDestruction:attack(53)
hammerOfDestruction:defense(30)
hammerOfDestruction:wieldUnproperly(true)
hammerOfDestruction:slotType("two-handed")
hammerOfDestruction:vocation("knight", true, true)
hammerOfDestruction:vocation("elite knight")
hammerOfDestruction:register()
...
cobraClub:wieldUnproperly(true)
--cobraClub:extraElement(44, "fire")
cobraClub:vocation("knight", true, true)
cobraClub:vocation("elite knight")
cobraClub:register()
	
-- mortal mace
local mortalMace = Weapon(WEAPON_CLUB)
mortalMace:id(31580)
mortalMace:level(220)
mortalMace:attack(8)
mortalMace:defense(27,2)
mortalMace:wieldUnproperly(true)
--mortalMace:extraElement(44, "death")
mortalMace:vocation("knight", true, true)
mortalMace:vocation("elite knight")
mortalMace:register()
...
-- falcon battleaxe
local falconBattleaxe = Weapon(WEAPON_CLUB)
falconBattleaxe:id(28724)
falconBattleaxe:level(300)
falconBattleaxe:attack(10)
falconBattleaxe:defense(33)
falconBattleaxe:wieldUnproperly(true)
--falconBattleaxe:extraElement(45, "energy")
falconBattleaxe:slotType("two-handed")
falconBattleaxe:vocation("knight", true, true)
falconBattleaxe:vocation("elite knight")
falconBattleaxe:register()

-- falcon mace
local falconMace = Weapon(WEAPON_CLUB)
falconMace:id(28725)
falconMace:level(300)
falconMace:attack(11)
falconMace:defense(33,3)
falconMace:wieldUnproperly(true)
--falconMace:extraElement(41, "energy")
falconMace:vocation("knight", true, true)
falconMace:vocation("elite knight")
falconMace:register()
...
-- golden axe
local goldenAxe = Weapon(WEAPON_AXE)
goldenAxe:id(29286)
goldenAxe:attack(10)
goldenAxe:defense(5)
goldenAxe:slotType("two-handed")
goldenAxe:register()
...
axeDestruction:wieldUnproperly(true)
axeDestruction:vocation("knight", true, true)
axeDestruction:vocation("elite knight")
axeDestruction:register()

-- plague bite
local plagueBite = Weapon(WEAPON_AXE)
plagueBite:id(22759)
plagueBite:level(200)
plagueBite:attack(26)
plagueBite:defense(31,3)
plagueBite:wieldUnproperly(true)
-- plagueBite:extraElement(26, "earth")
plagueBite:register()

-- axe of destruction
local axeOfDestruction = Weapon(WEAPON_AXE)
axeOfDestruction:id(27451)
axeOfDestruction:level(200)
axeOfDestruction:attack(51)
axeOfDestruction:defense(31)
axeOfDestruction:wieldUnproperly(true)
axeOfDestruction:vocation("knight", true, true)
axeOfDestruction:vocation("elite knight")
axeOfDestruction:register()

-- chopper of destruction
local chopperOfDestruction = Weapon(WEAPON_AXE)
chopperOfDestruction:id(27452)
chopperOfDestruction:level(200)
chopperOfDestruction:attack(52)
chopperOfDestruction:defense(32)
chopperOfDestruction:wieldUnproperly(true)
chopperOfDestruction:slotType("two-handed")
chopperOfDestruction:vocation("knight", true, true)
chopperOfDestruction:vocation("elite knight")
chopperOfDestruction:register()
...
cobraAxe:wieldUnproperly(true)
--cobraAxe:extraElement(44, "ice")
...
-- falcon battleaxe
local falconBattleaxe = Weapon(WEAPON_AXE)

...
summerblade:wieldUnproperly(true)
--summerblade:extraElement(42, "fire")
summerblade:vocation("knight", true, true)
summerblade:vocation("elite knight")
...
winterblade:wieldUnproperly(true)
--winterblade:extraElement(41, "ice")
winterblade:vocation("knight", true, true)
winterblade:vocation("elite knight")
...
bladeDestruction:wieldUnproperly(true)
bladeDestruction:vocation("knight", true, true)
bladeDestruction:vocation("elite knight")
...
gnomeSword:wieldUnproperly(true)
--gnomeSword:extraElement(42, "energy")
gnomeSword:vocation("knight", true, true)
gnomeSword:vocation("elite knight")
gnomeSword:register()
...
cobraSword:wieldUnproperly(true)

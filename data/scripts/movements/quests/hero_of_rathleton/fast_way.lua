local destination = {
	[22213] = {position = Position(33740, 31940, 15)},
	[22214] = {position = Position(33534, 31955, 15)},
	[22215] = {position = Position(33611, 32055, 15)}
}
...
function fastWay.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(22211) >= 1 then

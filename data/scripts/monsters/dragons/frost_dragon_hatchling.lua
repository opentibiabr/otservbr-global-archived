...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -60, maxDamage = -110, type = COMBAT_ICE, length = 5, spread = 2, effect = CONST_ME_ICEATTACK, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -60, maxDamage = -110, type = COMBAT_ICE, effect = CONST_ME_ICEAREA, target = true},

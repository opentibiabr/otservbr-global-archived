...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -60, maxDamage = -90, type = COMBAT_FIRE, length = 5, spread = 2, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -30, maxDamage = -55, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

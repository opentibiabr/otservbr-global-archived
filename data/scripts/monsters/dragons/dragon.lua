...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -60, maxDamage = -140, type = COMBAT_FIREDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -100, maxDamage = -170, type = COMBAT_FIREDAMAGE, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -90, maxDamage = -150, type = COMBAT_ENERGYDAMAGE, radius = 4, effect = CONST_ME_TELEPORT, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -140, maxDamage = -250, type = COMBAT_ENERGYDAMAGE, radius = 5, effect = CONST_ME_PURPLEENERGY, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -45, maxDamage = -80, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -50, maxDamage = -105, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -50, maxDamage = -105, type = COMBAT_DEATHDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -700, type = COMBAT_PHYSICAL, length = 5, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -400, type = COMBAT_PHYSICAL, ShootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_STONES, target = true},

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -450, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 20, minDamage = -250, maxDamage = -400, type = COMBAT_HOLYDAMAGE, radius = 3, effect = CONST_ME_HOLYAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -250, maxDamage = -400, type = COMBAT_PHYSICALDAMAGE, radius = 6, effect = CONST_ME_BLOCKHIT, target = true}
}

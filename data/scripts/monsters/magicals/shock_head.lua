...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -798, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -300, type = COMBAT_DEATH, length = 5, spread = 2, effect = CONST_ME_BLACKSMOKE, target = true},
	{name ="speed", interval = 2000, chance = 15, SpeedChange = -800, Duration = 7500},
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -350, type = COMBAT_PHYSICAL, ShootEffect = CONST_ANI_EARTH, effect = CONST_ME_STONES, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 12, minDamage = -500, maxDamage = -900, type = COMBAT_PHYSICALDAMAGE, radius = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 12, minDamage = -400, maxDamage = -775, type = COMBAT_FIREDAMAGE, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}

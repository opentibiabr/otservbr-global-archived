...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 40, minDamage = 0, maxDamage = -100, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_HUNTINGSPEAR, effect = CONST_ME_MAGIC_GREEN, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 40, minDamage = 0, maxDamage = -100, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_HUNTINGSPEAR, effect = CONST_ME_MAGIC_GREEN, target = true},

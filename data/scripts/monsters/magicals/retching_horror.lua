...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -110, type = COMBAT_PHYSICALDAMAGE, radius = 4, effect = CONST_ME_HITAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -200, type = COMBAT_PHYSICALDAMAGE, radius = 1, shootEffect = CONST_ANI_SNIPERARROW, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -200, maxDamage = -350, type = COMBAT_FIREDAMAGE, radius = 1, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = true}
}

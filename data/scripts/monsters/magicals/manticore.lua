...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 13, minDamage = -350, maxDamage = -450, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_HITBYFIRE, target = false},
	...
	{name ="combat", interval = 2000, chance = 22, minDamage = -300, maxDamage = -500, type = COMBAT_FIRE, range = 4, shootEffect = CONST_ANI_BURSTARROW, target = true}
}

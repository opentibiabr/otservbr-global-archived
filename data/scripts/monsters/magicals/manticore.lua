...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 15, minDamage = -300, maxDamage = -400, type = COMBAT_EARTHDAMAGE, shootEffect = CONST_ANI_ENVENOMEDARROW, effect = CONST_ME_GREEN_RINGS, target = true},

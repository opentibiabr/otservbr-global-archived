...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -250, maxDamage = -610, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = false},

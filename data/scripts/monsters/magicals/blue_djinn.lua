...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -60, maxDamage = -105, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = true},

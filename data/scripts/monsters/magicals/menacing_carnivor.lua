...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -300, maxDamage = -450, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -150, maxDamage = -330, type = COMBAT_PHYSICALDAMAGE, radius = 4, effect = CONST_ME_GROUNDSHAKER, target = false}
}

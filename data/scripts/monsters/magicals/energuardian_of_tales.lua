...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -10, maxDamage = -550, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1000, chance = 13, minDamage = -100, maxDamage = -555, type = COMBAT_ENERGYDAMAGE, radius = 3, effect = CONST_ME_ENERGYAREA, target = false}
}

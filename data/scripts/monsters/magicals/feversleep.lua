...
monster.attacks = {
	...
	-- poison
	{name ="combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 20, minDamage = -800, maxDamage = -1000, radius = 7, effect = CONST_ME_YELLOW_RINGS, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -70, maxDamage = -100, type = COMBAT_MANADRAIN, radius = 5, effect = CONST_ME_MAGIC_RED, target = false},

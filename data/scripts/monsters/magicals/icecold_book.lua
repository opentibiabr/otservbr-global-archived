...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 12, minDamage = -230, maxDamage = -880, type = COMBAT_ICEDAMAGE, range = 7, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_ICETORNADO, target = false}
}

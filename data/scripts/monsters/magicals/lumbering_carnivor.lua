...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -200, maxDamage = -500, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -100, maxDamage = -150, type = COMBAT_PHYSICAL, effect = CONST_ME_GROUNDSHAKER, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -180, maxDamage = -300, type = COMBAT_ENERGY, range = 5, ShootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_PURPLEENERGY, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -350, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -80, maxDamage = -200, type = COMBAT_PHYSICAL, effect = CONST_ME_STUN, target = false}
}

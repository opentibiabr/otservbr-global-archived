...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -150, maxDamage = -250, type = COMBAT_EARTHDAMAGE, radius = 3, effect = CONST_ME_HITBYPOISON, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -70, maxDamage = -120, type = COMBAT_EARTHDAMAGE, radius = 3, effect = CONST_ME_HITBYPOISON, target = true},

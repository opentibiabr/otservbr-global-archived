...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -160, maxDamage = -250, type = COMBAT_ENERGY, range = 6, ShootEffect = CONST_ANI_FLASHARROW, effect = CONST_ME_STUN, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -80, maxDamage = -200, type = COMBAT_LIFEDRAIN, effect = CONST_ME_MAGIC_RED, target = false},

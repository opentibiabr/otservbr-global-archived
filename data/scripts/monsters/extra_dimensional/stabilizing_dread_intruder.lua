...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -200, maxDamage = -300, type = COMBAT_DEATHDAMAGE, range = 4, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 25, minDamage = -350, maxDamage = -450, target = false}
}

monster.defenses = {
	defense = 50,
	armor = 50,
	{name ="combat", interval = 2000, chance = 5, minDamage = 80, maxDamage = 120, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

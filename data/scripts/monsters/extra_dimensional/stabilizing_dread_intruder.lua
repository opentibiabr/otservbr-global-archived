...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -200, maxDamage = -300, type = COMBAT_DEATHDAMAGE, range = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 9, minDamage = -100, maxDamage = -200, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_GLOOTHSPEAR, effect = CONST_ME_HITBYPOISON, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_EARTH, effect = CONST_ME_MAGIC_RED, target = false}
}

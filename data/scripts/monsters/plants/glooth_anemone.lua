...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 9, minDamage = -100, maxDamage = -200, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_GLOOTHSPEAR, effect = CONST_ME_HITBYPOISON, target = true},
	{name ="combat", interval = 2000, chance = 7, minDamage = -50, maxDamage = -100, type = COMBAT_LIFEDRAIN, range = 7, radius = 1, shootEffect = CONST_ANI_POISON, effect = CONST_ME_MAGIC_RED, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 5, minDamage = -30, maxDamage = -100, type = COMBAT_MANADRAIN, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="speed", interval = 2000, chance = 15, speedChange = -700, duration = 15000},
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -100, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_CARNIPHILA, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -55, maxDamage = -100, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_HITBYPOISON, target = true},

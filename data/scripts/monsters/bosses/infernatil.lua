...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 7, minDamage = -250, maxDamage = -750, type = COMBAT_PHYSICALDAMAGE, radius = 6, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1000, chance = 50, minDamage = -200, maxDamage = -500, type = COMBAT_FIREDAMAGE, radius = 5, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="firefield", interval = 1000, chance = 4, radius = 8, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1000, chance = 34, minDamage = -350, maxDamage = -850, type = COMBAT_FIREDAMAGE, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

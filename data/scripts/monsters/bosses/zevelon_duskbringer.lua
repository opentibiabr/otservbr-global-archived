...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 65, attack = 75, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1000, chance = 12, minDamage = 0, maxDamage = -200, type = COMBAT_DEATH, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},

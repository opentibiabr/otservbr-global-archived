...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 200, attack = 200, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 40, minDamage = -500, maxDamage = -1500, type = COMBAT_PHYSICAL, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 30, minDamage = -300, maxDamage = -1300, effect = CONST_ME_POISONAREA, target = false},

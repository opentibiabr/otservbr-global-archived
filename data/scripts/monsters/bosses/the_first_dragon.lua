...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -410, maxDamage = -695, type = COMBAT_FIREDAMAGE, range = 5, radius = 5, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -410, maxDamage = -595, type = COMBAT_FIREDAMAGE, radius = 7, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -150, maxDamage = -280, type = COMBAT_LIFEDRAIN, radius = 6, effect = CONST_ME_MAGIC_RED, target = false}
}

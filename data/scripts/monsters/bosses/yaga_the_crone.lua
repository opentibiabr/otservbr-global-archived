...
monster.attacks = {
	...
	{name ="combat", interval = 2500, chance = 50, minDamage = -30, maxDamage = -50, type = COMBAT_FIRE, range = 5, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_HITBYFIRE, target = false},
	-- poison

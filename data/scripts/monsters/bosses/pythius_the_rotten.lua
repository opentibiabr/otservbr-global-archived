...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 16, minDamage = -165, maxDamage = -200, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_DRAWBLOOD, target = true},
	{name ="combat", interval = 2000, chance = 17, minDamage = -55, maxDamage = -155, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},

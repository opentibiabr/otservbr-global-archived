...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -30, maxDamage = -60, type = COMBAT_FIRE, range = 5, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_HITBYFIRE, target = false},

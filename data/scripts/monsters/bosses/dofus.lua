...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 150, attack = 150, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 24, minDamage = -480, maxDamage = -800, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_LARGEROCK, target = false},

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 230, attack = 210, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1000, chance = 8, minDamage = -800, maxDamage = -1900, type = COMBAT_DEATH, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 3000, chance = 13, minDamage = -300, maxDamage = -800, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 9, minDamage = -400, maxDamage = -800, type = COMBAT_ENERGY, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false},
	-- poison

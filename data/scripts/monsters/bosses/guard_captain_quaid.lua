...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 18, minDamage = -500, maxDamage = -620, type = COMBAT_EARTHDAMAGE, radius = 4, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_GREEN_RINGS, target = true},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -400, maxDamage = -550, type = COMBAT_FIREDAMAGE, radius = 1, shootEffect = CONST_ANI_BURSTARROW, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -300, maxDamage = -450, type = COMBAT_EARTHDAMAGE, radius = 3, effect = CONST_ME_GREEN_RINGS, target = false}
}

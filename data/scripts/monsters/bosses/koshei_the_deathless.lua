...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -170, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 300, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 9, minDamage = -50, maxDamage = -140, type = COMBAT_DEATH, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 9, minDamage = -200, maxDamage = -650, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 1000, chance = 11, minDamage = -400, maxDamage = -900, type = COMBAT_LIFEDRAIN, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_SOUND_GREEN, target = true},

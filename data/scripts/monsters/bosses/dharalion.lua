...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 30, attack = 28, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1000, chance = 15, minDamage = -30, maxDamage = -60, type = COMBAT_MANADRAIN, range = 7, target = false},
	{name ="combat", interval = 1000, chance = 13, minDamage = -70, maxDamage = -90, type = COMBAT_ENERGY, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1000, chance = 10, minDamage = -80, maxDamage = -151, type = COMBAT_PHYSICAL, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, target = false},

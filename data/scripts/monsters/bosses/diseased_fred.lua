...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -207, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 4, interval = 4000}},
	...
	{name ="combat", interval = 1000, chance = 40, minDamage = -100, maxDamage = -175, type = COMBAT_PHYSICAL, ShootEffect = CONST_ANI_SMALLEARTH, target = false},

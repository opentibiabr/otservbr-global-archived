...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 100, minDamage = 0, maxDamage = -530, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -350, type = COMBAT_FIREDAMAGE, effect = CONST_ME_EXPLOSIONAREA, target = true}
}

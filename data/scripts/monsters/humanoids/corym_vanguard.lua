...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -50, maxDamage = -100, type = COMBAT_EARTHDAMAGE, length = 5, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -40, maxDamage = -70, type = COMBAT_DEATHDAMAGE, radius = 4, effect = CONST_ME_MORTAREA, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, minDamage = 0, maxDamage = -150, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_SPEAR, effect = CONST_ME_EXPLOSIONAREA, target = false},
	-- bleed
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -160, maxDamage = -260, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_BURSTARROW, effect = CONST_ME_EXPLOSIONHIT, target = true},
...
monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="combat", interval = 2000, chance = 7, minDamage = 95, maxDamage = 180, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false},

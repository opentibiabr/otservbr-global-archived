...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -22, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 15, minDamage = -16, maxDamage = -32, type = COMBAT_ICE, range = 7, ShootEffect = CONST_ANI_ICE, target = false},
	--
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -9, maxDamage = -30, type = COMBAT_ICE, length = 5, spread = 2, effect = CONST_ME_ICEAREA, target = false}
}

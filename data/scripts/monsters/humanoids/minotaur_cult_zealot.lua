...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -180, maxDamage = -230, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_WHIRLWINDAXE, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -180, maxDamage = -250, type = COMBAT_PHYSICAL, range = 7, effect = CONST_ME_EXPLOSIONHIT, target = true}
}

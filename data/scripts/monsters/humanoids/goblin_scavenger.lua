...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -30, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_SPEAR, target = false},
	...
	{name ="combat", interval = 2000, chance = 5, minDamage = -1, maxDamage = -30, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = false}
}

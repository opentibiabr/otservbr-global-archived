...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -50, maxDamage = -105, type = COMBAT_FIREDAMAGE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

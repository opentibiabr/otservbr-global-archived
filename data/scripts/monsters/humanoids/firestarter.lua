...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -21, type = COMBAT_FIRE, ShootEffect = CONST_ANI_BURSTARROW, effect = CONST_ME_EXPLOSIONHIT, target = true},

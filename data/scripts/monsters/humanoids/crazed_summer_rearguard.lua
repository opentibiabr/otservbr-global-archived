...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -210, maxDamage = -530, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -270, maxDamage = -710, type = COMBAT_FIRE, length = 3, spread = 0, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -250, maxDamage = -300, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -200, maxDamage = -350, type = COMBAT_FIRE, effect = CONST_ME_EXPLOSIONAREA, target = true}
}

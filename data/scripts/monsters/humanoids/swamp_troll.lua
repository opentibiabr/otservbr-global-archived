...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 100, minDamage = 0, maxDamage = -13, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 1, interval = 4000}}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -25, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -30, type = COMBAT_PHYSICAL, range = 7, shootEffect = CONST_ANI_SPEAR, target = false}
}

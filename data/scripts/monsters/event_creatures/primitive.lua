...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 34, minDamage = -20, maxDamage = -20, type = COMBAT_FIREDAMAGE, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

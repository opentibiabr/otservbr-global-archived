...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 105, attack = 85, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -100, maxDamage = -300, type = COMBAT_EARTH, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 3000, chance = 14, minDamage = -40, maxDamage = -300, type = COMBAT_ENERGY, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1000, chance = 10, minDamage = -30, maxDamage = -300, type = COMBAT_DEATH, effect = CONST_ME_POFF, target = false},
	{name ="combat", interval = 3000, chance = 12, minDamage = -100, maxDamage = -300, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_PLANTATTACK, target = false},

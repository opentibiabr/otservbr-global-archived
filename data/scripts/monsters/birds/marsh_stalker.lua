...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -8, type = COMBAT_PHYSICAL, range = 7, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_EXPLOSIONAREA, target = true}
}

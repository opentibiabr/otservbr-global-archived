...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -50, maxDamage = -90, type = COMBAT_LIFEDRAIN, radius = 3, effect = CONST_ME_HITAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -40, maxDamage = -70, type = COMBAT_ICEDAMAGE, range = 7, radius = 4, effect = CONST_ME_ICEATTACK, target = false},

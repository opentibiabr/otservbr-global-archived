...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -180, maxDamage = -215, type = COMBAT_DROWNDAMAGE, range = 7, shootEffect = CONST_ANI_SPEAR, effect = CONST_ME_LOSEENERGY, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -375, type = COMBAT_PHYSICAL, range = 7, shootEffect = CONST_ANI_WHIRLWINDSWORD, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -180, maxDamage = -215, type = COMBAT_DROWN, range = 7, shootEffect = CONST_ANI_SPEAR, effect = CONST_ME_LOSEENERGY, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -40, maxDamage = -100, type = COMBAT_DROWN, range = 7, ShootEffect = CONST_ANI_SPEAR, effect = CONST_ME_LOSEENERGY, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -270, maxDamage = -615, type = COMBAT_ENERGYDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -175, maxDamage = -205, type = COMBAT_ENERGYDAMAGE, range = 7, shootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_ENERGYHIT, target = true},

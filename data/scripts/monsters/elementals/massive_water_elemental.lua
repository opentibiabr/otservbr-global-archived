...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -220, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 300, interval = 4000}},
	{name ="combat", interval = 2000, chance = 15, minDamage = -330, maxDamage = -450, type = COMBAT_DROWN, range = 7, effect = CONST_ME_LOSEENERGY, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -170, maxDamage = -210, type = COMBAT_ICE, range = 7, ShootEffect = CONST_ANI_SMALLICE, target = false},
	-- poison

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 66, attack = 70, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -205, maxDamage = -497, type = COMBAT_ENERGYDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -200, maxDamage = -680, type = COMBAT_HOLYDAMAGE, radius = 3, effect = CONST_ME_HOLYDAMAGE, target = true},
...
monster.defenses = {
	defense = 33,
	armor = 76,
	{name ="combat", interval = 2000, chance = 40, minDamage = 100, maxDamage = 300, type = COMBAT_PHYSICALDAMAGE, radius = 3, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 200, chance = 55, minDamage = 100, maxDamage = 300, type = COMBAT_PHYSICALDAMAGE, radius = 3, effect = CONST_ME_ENERGYHIT, target = false}
}

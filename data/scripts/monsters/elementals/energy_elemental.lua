...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -125, maxDamage = -252, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -100, maxDamage = -130, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_ENERGYHIT, target = true},

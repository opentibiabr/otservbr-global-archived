...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -125, maxDamage = -252, type = COMBAT_ENERGYDAMAGE, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},

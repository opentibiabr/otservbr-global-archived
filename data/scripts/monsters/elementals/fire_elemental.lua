...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -45, maxDamage = -160, type = COMBAT_FIREDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

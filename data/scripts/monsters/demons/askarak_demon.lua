...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -20, maxDamage = -60, type = COMBAT_EARTHDAMAGE, range = 7, radius = 6, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = false},

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -520, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 800, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -395, maxDamage = -498, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -350, maxDamage = -660, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -200, maxDamage = -403, type = COMBAT_FIRE, effect = CONST_ME_HITBYFIRE, target = true},

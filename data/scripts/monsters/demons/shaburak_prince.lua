...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -40, maxDamage = -90, type = COMBAT_FIREDAMAGE, range = 7, radius = 6, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = false},

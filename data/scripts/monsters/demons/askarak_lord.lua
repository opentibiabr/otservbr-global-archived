...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -186, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 20, minDamage = -40, maxDamage = -80, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -95, maxDamage = -180, type = COMBAT_EARTH, length = 4, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -130, maxDamage = -180, type = COMBAT_EARTH, length = 4, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},

...
monster.attacks = {
	{name ="combat", interval = 1500, chance = 100, minDamage = 0, maxDamage = -539, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 200, interval = 4000}},

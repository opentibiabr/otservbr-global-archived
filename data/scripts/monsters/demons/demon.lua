...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -520, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -210, maxDamage = -300, type = COMBAT_ENERGY, range = 1, ShootEffect = CONST_ANI_ENERGY, target = false},

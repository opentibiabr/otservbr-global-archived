...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -60, maxDamage = -90, type = COMBAT_FIREDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -20, maxDamage = -50, type = COMBAT_FIREDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

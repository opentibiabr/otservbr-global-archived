...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -80, maxDamage = -150, type = COMBAT_ICEDAMAGE, range = 6, radius = 3, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_GIANTICE, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -30, maxDamage = -70, type = COMBAT_FIREDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_EXPLOSIONHIT, target = true},

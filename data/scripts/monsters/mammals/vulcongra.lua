...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -195, maxDamage = -340, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -100, maxDamage = -200, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -200, type = COMBAT_PHYSICAL, length = 5, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}
...
monster.defenses = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 150, maxDamage = 300, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

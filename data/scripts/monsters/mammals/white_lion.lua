...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 0, minDamage = 0, maxDamage = -300, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 0, minDamage = -300, maxDamage = -400, type = COMBAT_HOLY, range = 1, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 2000, chance = 0, minDamage = -250, maxDamage = -350, type = COMBAT_HOLY, range = 1, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 2000, chance = 100, minDamage = -250, maxDamage = -350, type = COMBAT_PHYSICAL, range = 1, effect = CONST_ME_EXPLOSIONAREA, target = false}
}

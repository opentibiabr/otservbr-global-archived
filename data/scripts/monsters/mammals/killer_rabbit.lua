...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 30, minDamage = 0, maxDamage = -50, type = COMBAT_PHYSICALDAMAGE, range = 1, target = false}
}

monster.defenses = {
	defense = 35,
	armor = 30,
	{name ="speed", interval = 1000, chance = 40, SpeedChange = 380, Duration = 8000},

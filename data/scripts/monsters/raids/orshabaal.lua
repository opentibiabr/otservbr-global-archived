...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1990, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 1000, chance = 34, minDamage = -310, maxDamage = -600, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 1000, chance = 10, range = 7, ShootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 1000, chance = 15, minDamage = -500, maxDamage = -850, type = COMBAT_ENERGY, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false}
}

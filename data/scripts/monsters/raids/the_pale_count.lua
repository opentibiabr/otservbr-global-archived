...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 21, minDamage = -130, maxDamage = -350, type = COMBAT_ICEDAMAGE, range = 6, radius = 2, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_GIANTICE, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 35, minDamage = -500, maxDamage = -1210, type = COMBAT_FIREDAMAGE, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 1800, chance = 40, minDamage = 0, maxDamage = -580, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 5, effect = CONST_ME_HITAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -250, maxDamage = -500, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 13, effect = CONST_ME_SOUND_RED, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -450, type = COMBAT_PHYSICALDAMAGE, radius = 14, effect = CONST_ME_LOSEENERGY, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 60, minDamage = 0, maxDamage = -350, type = COMBAT_PHYSICALDAMAGE, shootEffect = CONST_ANI_THROWINGKNIFE, target = false}
}

monster.defenses = {
	defense = 50,
	armor = 35,
	{name ="combat", interval = 4000, chance = 25, minDamage = 50, maxDamage = 150, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

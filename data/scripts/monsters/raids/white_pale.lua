...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 45, attack = 40, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 14, minDamage = -100, maxDamage = -110, type = COMBAT_EARTH, effect = CONST_ME_SMALLPLANTS, target = false},
	-- poison

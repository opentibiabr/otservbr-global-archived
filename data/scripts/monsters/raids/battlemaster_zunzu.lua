...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -115, maxDamage = -350, type = COMBAT_EARTHDAMAGE, range = 1, radius = 1, effect = CONST_ME_POISONAREA, target = true}
}

monster.defenses = {
	defense = 35,
	armor = 45,
	{name ="combat", interval = 1000, chance = 18, minDamage = 200, maxDamage = 400, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

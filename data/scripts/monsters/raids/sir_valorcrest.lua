...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 12, minDamage = 0, maxDamage = -190, type = COMBAT_DEATHDAMAGE, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true}
}

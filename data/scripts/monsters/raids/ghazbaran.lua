...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, minDamage = -250, maxDamage = -500, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 6, effect = CONST_ME_HITAREA, target = false},
	{name ="combat", interval = 3000, chance = 34, minDamage = -120, maxDamage = -500, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_WHIRLWINDSWORD, effect = CONST_ME_DRAWBLOOD, target = true},
	...
	{name ="combat", interval = 3000, chance = 20, minDamage = -200, maxDamage = -480, type = COMBAT_PHYSICALDAMAGE, range = 14, radius = 5, effect = CONST_ME_POFF, target = false},
	{name ="combat", interval = 4000, chance = 15, minDamage = -100, maxDamage = -650, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 13, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 4000, chance = 18, minDamage = -200, maxDamage = -600, type = COMBAT_PHYSICALDAMAGE, radius = 14, effect = CONST_ME_LOSEENERGY, target = false},
	{name ="combat", interval = 3000, chance = 15, minDamage = -200, maxDamage = -750, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false}
}

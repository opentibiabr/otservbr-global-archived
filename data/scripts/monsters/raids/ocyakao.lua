...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 70, maxDamage = -185, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 3, shootEffect = CONST_ANI_SMALLSTONE, target = true}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 25, attack = 50, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = 70, maxDamage = -185, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_SMALLSTONE, target = true}
}

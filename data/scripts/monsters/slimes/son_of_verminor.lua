...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -473, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, totalDamage = 450, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -350, maxDamage = -390, type = COMBAT_EARTHDAMAGE, radius = 3, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -220, maxDamage = -270, type = COMBAT_DEATHDAMAGE, radius = 3, effect = CONST_ME_SMALLCLOUDS, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -10, maxDamage = -30, type = COMBAT_ENERGY, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 30, minDamage = -10, maxDamage = -20, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_HITBYPOISON, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -40, maxDamage = -60, type = COMBAT_EARTHDAMAGE, length = 5, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},

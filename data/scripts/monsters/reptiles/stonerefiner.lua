...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -70, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -40, maxDamage = -80, range = 7, target = false}
}

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 120, attack = 82, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 11, minDamage = -200, maxDamage = -285, type = COMBAT_LIFEDRAIN, radius = 3, effect = CONST_ME_MAGIC_RED, target = false},

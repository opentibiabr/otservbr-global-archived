...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -120, maxDamage = -250, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},

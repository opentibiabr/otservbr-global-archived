...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -150, maxDamage = -280, type = COMBAT_PHYSICALDAMAGE, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -75, maxDamage = -100, type = COMBAT_LIFEDRAIN, shootEffect = CONST_ANI_SMALLSTONE, target = true},

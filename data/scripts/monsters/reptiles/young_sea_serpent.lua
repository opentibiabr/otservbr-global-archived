...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -10, maxDamage = -250, type = COMBAT_EARTH, length = 7, spread = 2, effect = CONST_ME_SMALLPLANTS, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -80, maxDamage = -250, type = COMBAT_ICE, length = 7, spread = 2, effect = CONST_ME_ICEATTACK, target = false},

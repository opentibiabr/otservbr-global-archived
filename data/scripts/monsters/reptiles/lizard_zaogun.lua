...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -220, maxDamage = -375, type = COMBAT_EARTHDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true}
}

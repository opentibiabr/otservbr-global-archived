...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -50, maxDamage = -110, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true}
}

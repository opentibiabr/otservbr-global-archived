...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -190, maxDamage = -340, type = COMBAT_EARTH, effect = CONST_ME_HITBYPOISON, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -90, maxDamage = -180, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false}
}

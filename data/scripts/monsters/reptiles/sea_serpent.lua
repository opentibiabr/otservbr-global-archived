...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -60, maxDamage = -300, type = COMBAT_EARTH, length = 7, spread = 2, effect = CONST_ME_SMALLPLANTS, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -101, maxDamage = -300, type = COMBAT_ICE, length = 7, spread = 2, effect = CONST_ME_ICEATTACK, target = false},

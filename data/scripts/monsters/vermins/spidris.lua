...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -150, maxDamage = -310, type = COMBAT_EARTHDAMAGE, range = 7, radius = 3, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -4, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 10, interval = 4000}},
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -12, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, target = false}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -248, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 400, interval = 4000}},
	{name ="combat", interval = 2000, chance = 15, minDamage = -110, maxDamage = -180, type = COMBAT_EARTH, effect = CONST_ME_POISONAREA, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -80, maxDamage = -100, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, target = false}
}

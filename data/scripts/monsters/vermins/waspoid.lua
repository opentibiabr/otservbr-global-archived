...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -248, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, totalDamage = 400, interval = 4000}},
	{name ="combat", interval = 2000, chance = 15, minDamage = -110, maxDamage = -180, type = COMBAT_EARTHDAMAGE, radius = 3, effect = CONST_ME_POISONAREA, target = true},

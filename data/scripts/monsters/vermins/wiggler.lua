...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -200, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 500, interval = 4000}},
	{name ="combat", interval = 2000, chance = 10, minDamage = -180, maxDamage = -270, type = COMBAT_EARTH, length = 4, spread = 3, target = false},
	-- poison

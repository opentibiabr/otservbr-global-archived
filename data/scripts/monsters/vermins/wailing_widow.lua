...
monster.attacks = {
	...
	{name ="drunk", interval = 2000, chance = 20, range = 7, radius = 4, effect = CONST_ME_SOUND_RED, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -40, maxDamage = -70, type = COMBAT_LIFEDRAIN, radius = 3, effect = CONST_ME_MAGIC_RED, target = false},

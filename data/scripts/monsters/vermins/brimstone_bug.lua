...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -213, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 400, interval = 4000}},
	{name ="speed", interval = 2000, chance = 20, SpeedChange = -600, Duration = 10000},
	{name ="combat", interval = 2000, chance = 5, minDamage = -140, maxDamage = -310, type = COMBAT_EARTH, effect = CONST_ME_SMALLPLANTS, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -80, maxDamage = -120, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_YELLOW_RINGS, target = false}
}

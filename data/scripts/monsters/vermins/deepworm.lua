...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -190, maxDamage = -300, type = COMBAT_EARTHDAMAGE, range = 7, length = 6, spread = 2, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -400, type = COMBAT_EARTHDAMAGE, length = 3, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}

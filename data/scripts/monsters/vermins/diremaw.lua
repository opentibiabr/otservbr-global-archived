...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 25, minDamage = -150, maxDamage = -200, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},

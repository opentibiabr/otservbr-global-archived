...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -250, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 160, interval = 4000}},
	{name ="speed", interval = 2000, chance = 15, SpeedChange = -800, Duration = 15000},
	{name ="combat", interval = 2000, chance = 15, minDamage = -50, maxDamage = -100, type = COMBAT_ICE, range = 7, ShootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true},

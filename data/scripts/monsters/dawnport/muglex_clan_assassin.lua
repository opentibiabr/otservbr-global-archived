...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 10, attack = 15, effect = CONST_ME_DRAWBLOOD},
	{name ="drunk", interval = 2000, chance = 11, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 9, minDamage = 0, maxDamage = -30, type = COMBAT_PHYSICAL, range = 6, ShootEffect = CONST_ANI_THROWINGKNIFE, target = false}
}

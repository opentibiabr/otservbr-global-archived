...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -220, maxDamage = -405, type = COMBAT_EARTHDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_POISON, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -65, maxDamage = -135, type = COMBAT_LIFEDRAIN, radius = 4, effect = CONST_ME_MAGIC_GREEN, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -350, maxDamage = -450, type = COMBAT_ENERGYDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_POWERBOLT, effect = CONST_ME_ENERGYHIT, target = true},

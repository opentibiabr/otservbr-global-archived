...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -320, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 180, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -175, maxDamage = -300, type = COMBAT_DEATH, range = 1, ShootEffect = CONST_ANI_DEATH, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 1700, chance = 15, minDamage = -250, maxDamage = -550, type = COMBAT_EARTHDAMAGE, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true},
	...
	{name ="combat", interval = 1700, chance = 35, minDamage = -250, maxDamage = -550, type = COMBAT_DEATHDAMAGE, radius = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1700, chance = 35, minDamage = -250, maxDamage = -400, type = COMBAT_HOLYDAMAGE, radius = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 1700, chance = 13, minDamage = -400, maxDamage = -450, type = COMBAT_ENERGYDAMAGE, range = 4, radius = 4, effect = CONST_ME_ENERGYAREA, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 1700, chance = 25, minDamage = -250, maxDamage = -550, type = COMBAT_ENERGY, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1700, chance = 35, minDamage = -250, maxDamage = -550, type = COMBAT_DEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1700, chance = 35, minDamage = -250, maxDamage = -400, type = COMBAT_HOLY, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 1700, chance = 13, minDamage = -400, maxDamage = -450, type = COMBAT_ENERGY, range = 4, effect = CONST_ME_ENERGYAREA, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -120, maxDamage = -250, type = COMBAT_DEATH, range = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -50, maxDamage = -100, type = COMBAT_DEATH, range = 6, ShootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
	-- bleed

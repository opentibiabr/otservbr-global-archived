...
monster.attacks = {
	...
	{name ="combat", interval = 1700, chance = 35, minDamage = -150, maxDamage = -550, type = COMBAT_DEATHDAMAGE, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1700, chance = 20, minDamage = -150, maxDamage = -550, type = COMBAT_ENERGYDAMAGE, radius = 4, effect = CONST_ME_ENERGYAREA, target = false}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -250, maxDamage = -480, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 25, minDamage = -200, maxDamage = -350, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -350, type = COMBAT_FIRE, effect = CONST_ME_FIREATTACK, target = true},

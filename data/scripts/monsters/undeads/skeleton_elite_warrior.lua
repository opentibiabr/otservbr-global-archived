...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 20, minDamage = -300, maxDamage = -450, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false}
}

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 100, maxDamage = 550, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 1000, chance = 15, minDamage = 300, maxDamage = 500, type = COMBAT_LIFEDRAIN, range = 5, radius = 3, effect = CONST_ME_HITAREA, target = false}
}

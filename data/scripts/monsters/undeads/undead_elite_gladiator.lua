...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 100, maxDamage = 550, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1500, chance = 20, minDamage = 300, maxDamage = 550, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_WHIRLWINDSWORD, target = false},

...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 100, minDamage = 0, maxDamage = -520, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 380, interval = 4000}},
...
monster.defenses = {
	defense = 25,
	armor = 25,
	{name ="speed", interval = 2000, chance = 15, SpeedChange = 1000, Duration = 5000},

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -400, maxDamage = -580, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 25, minDamage = -270, maxDamage = -390, type = COMBAT_LIFEDRAIN, radius = 4, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="combat", interval = 2000, chance = 25, minDamage = -280, maxDamage = -410, type = COMBAT_ICEDAMAGE, radius = 4, effect = CONST_ME_ICEAREA, target = true},

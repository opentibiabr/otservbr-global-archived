...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -370, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -340, type = COMBAT_PHYSICAL, length = 3, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false}
}

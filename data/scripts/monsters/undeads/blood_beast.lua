...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 82, attack = 50, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, totalDamage = 260, interval = 4000}},
	{name ="combat", interval = 2000, chance = 10, minDamage = -65, maxDamage = -105, type = COMBAT_EARTHDAMAGE, range = 5, shootEffect = CONST_ANI_GREENSTAR, effect = CONST_ME_POISONAREA, target = true},
	-- poison

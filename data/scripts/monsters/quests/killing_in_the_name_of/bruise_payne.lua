...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 100, minDamage = 0, maxDamage = -240, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 6, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -130, maxDamage = -237, type = COMBAT_DROWNDAMAGE, effect = CONST_ME_SOUND_WHITE, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 12, minDamage = 0, maxDamage = -300, type = COMBAT_EARTHDAMAGE, range = 1, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 12, minDamage = -280, maxDamage = -450, type = COMBAT_EARTHDAMAGE, range = 4, radius = 4, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_POFF, target = true},
...
monster.defenses = {
	defense = 35,
	armor = 35,
	{name ="combat", interval = 2000, chance = 25, minDamage = 230, maxDamage = 330, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

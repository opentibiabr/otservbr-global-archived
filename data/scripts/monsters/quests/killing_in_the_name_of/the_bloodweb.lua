...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 40, attack = 100, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 8, interval = 4000}},
	{name ="speed", interval = 2000, chance = 20, SpeedChange = -850, Duration = 8000},
	{name ="combat", interval = 1000, chance = 25, minDamage = -60, maxDamage = -150, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true}
}

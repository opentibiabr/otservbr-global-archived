...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 5, minDamage = 0, maxDamage = -394, type = COMBAT_EARTHDAMAGE, effect = CONST_ME_SMALLPLANTS, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -120, type = COMBAT_EARTHDAMAGE, length = 8, spread = 3, effect = CONST_ME_YELLOW_RINGS, target = false}
}

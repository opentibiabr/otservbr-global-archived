...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -250, maxDamage = -420, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_SPEAR, effect = CONST_ME_GREEN_RINGS, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -150, type = COMBAT_EARTHDAMAGE, radius = 6, effect = CONST_ME_GREEN_RINGS, target = false}
}

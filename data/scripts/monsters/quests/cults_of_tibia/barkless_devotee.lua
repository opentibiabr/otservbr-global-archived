...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -250, maxDamage = -420, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_SPEAR, effect = CONST_ME_GREEN_RINGS, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -180, maxDamage = -220, type = COMBAT_ENERGY, range = 6, length = 6, spread = 7, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false}
}

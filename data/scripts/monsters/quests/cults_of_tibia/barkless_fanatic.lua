...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -220, maxDamage = -450, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_SPEAR, effect = CONST_ME_GREEN_RINGS, target = true},

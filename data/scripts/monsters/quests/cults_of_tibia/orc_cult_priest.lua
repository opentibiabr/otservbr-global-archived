...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -310, type = COMBAT_ENERGY, range = 7, shootEffect = CONST_ANI_ENERGYBALL, target = false},
	{name ="combat", interval = 2000, chance = 5, minDamage = -200, maxDamage = -250, type = COMBAT_FIRE, range = 7, shootEffect = CONST_ANI_FIRE, target = true},

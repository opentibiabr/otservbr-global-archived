...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 60, minDamage = -30, maxDamage = -181, type = COMBAT_DEATHDAMAGE, range = 7, radius = 3, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = true},

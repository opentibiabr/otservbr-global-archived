...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, minDamage = 0, maxDamage = -500, type = COMBAT_DEATHDAMAGE, range = 8, radius = 8, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true}
}

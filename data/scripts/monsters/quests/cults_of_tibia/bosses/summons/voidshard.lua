...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -168, maxDamage = -400, type = COMBAT_ENERGY, range = 6, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true},

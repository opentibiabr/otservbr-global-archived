...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -524, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -300, maxDamage = -1050, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false}
}

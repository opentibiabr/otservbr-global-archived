...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 100, attack = 60, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 15, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -75, maxDamage = -150, type = COMBAT_ICE, range = 7, ShootEffect = CONST_ANI_ICE, effect = CONST_ME_BLOCKHIT, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -600, maxDamage = -780, type = COMBAT_DEATHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	...
	-- energy damage
	{name ="combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 20, minDamage = -2000, maxDamage = -2000, radius = 7, effect = CONST_ME_BLOCKHIT, target = false},
	-- bleed

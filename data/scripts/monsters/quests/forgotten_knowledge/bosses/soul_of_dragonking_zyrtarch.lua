...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -710, maxDamage = -895, type = COMBAT_ENERGY, length = 9, spread = 4, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -710, maxDamage = -895, type = COMBAT_FIRE, length = 9, spread = 4, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -710, maxDamage = -895, type = COMBAT_FIRE, length = 9, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -200, maxDamage = -1400, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 12, minDamage = -130, maxDamage = -460, type = COMBAT_ENERGY, length = 6, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},

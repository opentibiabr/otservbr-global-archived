...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -200, maxDamage = -300, type = COMBAT_ENERGY, length = 6, spread = 3, effect = CONST_ME_PURPLEENERGY, target = true},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICAL, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},

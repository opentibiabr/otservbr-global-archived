...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -60, maxDamage = -150, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 500, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -280, type = COMBAT_PHYSICALDAMAGE, radius = 4, effect = CONST_ME_GROUNDSHAKER, target = false},

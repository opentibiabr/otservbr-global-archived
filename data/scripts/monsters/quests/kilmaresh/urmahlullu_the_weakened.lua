...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -50, maxDamage = -1100, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 3000, chance = 20, minDamage = -500, maxDamage = -800, type = COMBAT_FIRE, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -550, maxDamage = -800, type = COMBAT_FIRE, effect = CONST_ME_FIREAREA, target = false},

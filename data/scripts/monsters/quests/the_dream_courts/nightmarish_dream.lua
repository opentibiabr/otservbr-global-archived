...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -100, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 3, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 5, minDamage = -55, maxDamage = -350, type = COMBAT_DEATH, range = 1, effect = CONST_ME_SMALLCLOUDS, target = true},

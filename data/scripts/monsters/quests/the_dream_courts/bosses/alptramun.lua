...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1000, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 15, minDamage = -190, maxDamage = -300, type = COMBAT_DEATH, range = 7, length = 6, spread = 3, ShootEffect = CONST_ANI_POISON, target = false},

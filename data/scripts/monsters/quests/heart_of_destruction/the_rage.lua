...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -740, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -300, maxDamage = -600, type = COMBAT_DEATH, effect = CONST_ME_SMALLCLOUDS, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -600, maxDamage = -900, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -600, type = COMBAT_PHYSICAL, length = 10, spread = 3, effect = CONST_ME_YELLOW_RINGS, target = false},

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -740, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -300, maxDamage = -600, type = COMBAT_DEATHDAMAGE, radius = 4, effect = CONST_ME_SMALLCLOUDS, target = true},

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -300, maxDamage = -1400, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 25, minDamage = -300, maxDamage = -600, type = COMBAT_DEATH, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 25, minDamage = -500, maxDamage = -900, target = false},
	{name ="combat", interval = 2000, chance = 25, minDamage = -600, maxDamage = -1000, type = COMBAT_PHYSICAL, length = 9, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = 0, maxDamage = -200, type = COMBAT_PHYSICAL, range = 4, ShootEffect = CONST_ANI_INFERNALBOLT, target = true},
	{name ="combat", interval = 2000, chance = 25, minDamage = 0, maxDamage = -200, type = COMBAT_PHYSICAL, effect = CONST_ME_ENERGYAREA, target = true}
}

...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 100, minDamage = 0, maxDamage = -525, effect = CONST_ME_DRAWBLOOD},
	{name ="speed", interval = 3500, chance = 35, SpeedChange = -250, Duration = 40}
}

...
monster.attacks = {
	...
	{name ="speed", interval = 3500, chance = 65, SpeedChange = -500, Duration = 40},
	{name ="combat", interval = 3000, chance = 75, minDamage = -13, maxDamage = -80, type = COMBAT_ENERGYDAMAGE, range = 7, shootEffect = CONST_ANI_ENERGY, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 6000, chance = 60, minDamage = -100, maxDamage = -180, type = COMBAT_FIREDAMAGE, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 3000, chance = 50, minDamage = -70, maxDamage = -115, type = COMBAT_FIREDAMAGE, range = 10, radius = 5, effect = CONST_ME_FIREAREA, target = true}
}

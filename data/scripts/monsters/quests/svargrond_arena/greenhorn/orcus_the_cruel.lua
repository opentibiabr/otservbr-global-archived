...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, minDamage = 0, maxDamage = -70, type = COMBAT_PHYSICALDAMAGE, range = 5, radius = 1, shootEffect = CONST_ANI_THROWINGKNIFE, target = true}
}

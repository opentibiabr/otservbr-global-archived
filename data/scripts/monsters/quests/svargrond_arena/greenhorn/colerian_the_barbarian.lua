...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 80, minDamage = 0, maxDamage = -40, type = COMBAT_PHYSICALDAMAGE, range = 5, radius = 1, shootEffect = CONST_ANI_PIERCINGBOLT, target = true}
}

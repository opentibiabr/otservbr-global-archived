...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 13, minDamage = -450, maxDamage = -640, type = COMBAT_HOLY, length = 7, spread = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, minDamage = -480, maxDamage = -630, type = COMBAT_EARTH, effect = CONST_ME_EXPLOSIONHIT, target = false}
}

...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 200, attack = 150, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 12, minDamage = 0, maxDamage = -660, type = COMBAT_DEATHDAMAGE, range = 7, radius = 6, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false},

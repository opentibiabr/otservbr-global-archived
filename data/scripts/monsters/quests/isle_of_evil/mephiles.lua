...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 70, minDamage = -15, maxDamage = -45, type = COMBAT_FIREDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

...
monster.attacks = {
	{name ="combat", interval = 1200, chance = 100, minDamage = 0, maxDamage = -35, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1500, chance = 70, minDamage = -15, maxDamage = -45, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 30, minDamage = -66, maxDamage = -72, type = COMBAT_FIREDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

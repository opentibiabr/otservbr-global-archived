...
monster.attacks = {
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 1200, chance = 100, minDamage = 0, maxDamage = -167, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 30, minDamage = -66, maxDamage = -85, type = COMBAT_LIFEDRAIN, length = 6, spread = 3, effect = CONST_ME_MAGIC_GREEN, target = false}
}

monster.defenses = {
	defense = 15,
	armor = 15,
	{name ="combat", interval = 2000, chance = 30, minDamage = 90, maxDamage = 200, type = COMBAT_HEALING, effect = CONST_ME_HITBYFIRE, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 30, minDamage = -12, maxDamage = -20, type = COMBAT_DEATHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_DRAWBLOOD, target = true},

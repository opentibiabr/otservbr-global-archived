...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1000, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 55, interval = 4000}},
	{name ="combat", interval = 3000, chance = 7, minDamage = -100, maxDamage = -700, type = COMBAT_LIFEDRAIN, range = 1, target = false},
	{name ="combat", interval = 2000, chance = 12, minDamage = -100, maxDamage = -500, type = COMBAT_EARTH, range = 7, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 3000, chance = 12, minDamage = -120, maxDamage = -750, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_MORTAREA, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -150, maxDamage = -650, type = COMBAT_EARTH, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
	...
	{name ="combat", interval = 3000, chance = 17, minDamage = -55, maxDamage = -550, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}

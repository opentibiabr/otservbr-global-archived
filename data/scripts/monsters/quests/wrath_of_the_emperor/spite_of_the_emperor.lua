...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 55, attack = 115, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 3000, chance = 17, minDamage = -150, maxDamage = -250, type = COMBAT_PHYSICAL, length = 8, spread = 3, effect = CONST_ME_LOSEENERGY, target = false},
	{name ="combat", interval = 3000, chance = 10, minDamage = 0, maxDamage = -500, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},

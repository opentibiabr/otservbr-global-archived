...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 85, attack = 145, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 21, minDamage = -400, maxDamage = -650, type = COMBAT_LIFEDRAIN, radius = 6, effect = CONST_ME_POFF, target = false}
}

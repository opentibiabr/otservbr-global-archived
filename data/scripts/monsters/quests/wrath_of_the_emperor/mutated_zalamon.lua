...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -815, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -100, maxDamage = -300, type = COMBAT_EARTHDAMAGE, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},

...
monster.attacks = {
	...
	-- energy damage
	{name ="combat", type = COMBAT_ENERGYDAMAGE, interval = 1000, chance = 10, minDamage = -800, maxDamage = -800, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_SMALLPLANTS, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -500, maxDamage = -1600, type = COMBAT_ENERGYDAMAGE, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1000, chance = 20, minDamage = -1000, maxDamage = -1800, type = COMBAT_EARTHDAMAGE, length = 5, spread = 2, effect = CONST_ME_PLANTATTACK, target = false}
}

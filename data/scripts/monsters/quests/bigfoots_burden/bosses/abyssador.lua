...
monster.attacks = {
	{name ="combat", interval = 3000, chance = 100, skill = 300, attack = 150, effect = CONST_ME_DRAWBLOOD},
	-- energy damage
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -500, maxDamage = -1600, type = COMBAT_ENERGY, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = false},

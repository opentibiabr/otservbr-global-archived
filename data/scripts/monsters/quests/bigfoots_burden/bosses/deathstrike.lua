...
monster.attacks = {
	{name ="combat", interval = 1300, chance = 100, skill = 80, attack = 120, effect = CONST_ME_DRAWBLOOD},
	{name ="speed", interval = 2000, chance = 20, SpeedChange = -400, Duration = 2500},
	{name ="combat", interval = 2000, chance = 100, minDamage = -820, maxDamage = -950, type = COMBAT_FIRE, range = 7, effect = CONST_ME_FIREAREA, target = false},

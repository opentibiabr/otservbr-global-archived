...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -390, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -220, maxDamage = -350, type = COMBAT_FIREDAMAGE, radius = 4, effect = CONST_ME_FIREAREA, target = true},
	{name ="speed", interval = 2000, chance = 10, speedChange = -300, duration = 10000},
	{name ="combat", interval = 2000, chance = 30, minDamage = -280, maxDamage = -350, type = COMBAT_FIREDAMAGE, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}

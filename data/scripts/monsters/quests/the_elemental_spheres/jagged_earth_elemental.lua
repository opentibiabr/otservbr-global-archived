...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 11, minDamage = 0, maxDamage = -200, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_POISONAREA, target = true}
}

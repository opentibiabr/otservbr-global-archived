...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = 0, maxDamage = -800, type = COMBAT_ENERGY, length = 7, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
	{name ="combat", interval = 1000, chance = 11, minDamage = 0, maxDamage = -200, type = COMBAT_ENERGY, range = 3, effect = CONST_ME_PURPLEENERGY, target = true},
	{name ="combat", interval = 1000, chance = 9, minDamage = -50, maxDamage = -200, type = COMBAT_EARTH, effect = CONST_ME_BIGPLANTS, target = false}
}

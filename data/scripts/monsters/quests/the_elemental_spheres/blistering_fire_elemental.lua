...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 11, minDamage = -65, maxDamage = -510, type = COMBAT_FIREDAMAGE, length = 7, spread = 3, target = false},
	-- fire
	{name ="combat", type = COMBAT_FIREDAMAGE, interval = 1000, chance = 12, minDamage = -50, maxDamage = -200, radius = 6, effect = CONST_ME_FIREAREA, target = false},

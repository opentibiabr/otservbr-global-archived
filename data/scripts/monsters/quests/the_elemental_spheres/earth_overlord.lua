...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 10, minDamage = 0, maxDamage = -800, type = COMBAT_EARTH, length = 7, spread = 3, effect = CONST_ME_STONES, target = false},
	{name ="combat", interval = 1000, chance = 9, minDamage = 0, maxDamage = -490, type = COMBAT_EARTH, effect = CONST_ME_BIGPLANTS, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -168, maxDamage = -100, type = COMBAT_ENERGYDAMAGE, range = 6, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true},
	-- energy damage

...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 13, minDamage = -65, maxDamage = -205, type = COMBAT_FIRE, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 1000, chance = 12, minDamage = -110, maxDamage = -150, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

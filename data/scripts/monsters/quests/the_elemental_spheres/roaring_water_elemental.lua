...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, minDamage = -240, maxDamage = -320, type = COMBAT_ICEDAMAGE, radius = 2, shootEffect = CONST_ANI_ICE, effect = CONST_ME_LOSEENERGY, target = true}
}

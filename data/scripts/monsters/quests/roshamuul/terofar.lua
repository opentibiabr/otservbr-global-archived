...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 18, minDamage = 0, maxDamage = -750, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_WHIRLWINDAXE, target = true}
}

monster.defenses = {
	defense = 65,
	armor = 55,
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_HEALING, minDamage = 300, maxDamage = 500, radius = 8, effect = CONST_ME_DRAWBLOOD, target = false},

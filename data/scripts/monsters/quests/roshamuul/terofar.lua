...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 180, attack = 100, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 30, minDamage = -700, maxDamage = -1500, type = COMBAT_DEATH, length = 8, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false},
	{name ="combat", interval = 2000, chance = 18, minDamage = 0, maxDamage = -750, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_WHIRLWINDAXE, target = true}
}

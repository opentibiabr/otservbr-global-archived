...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 190, attack = 100, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 18, minDamage = -1000, maxDamage = -3000, type = COMBAT_DEATH, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false}
}

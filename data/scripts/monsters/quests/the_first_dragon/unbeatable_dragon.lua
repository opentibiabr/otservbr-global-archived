...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, minDamage = -100, maxDamage = -200, type = COMBAT_FIREDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

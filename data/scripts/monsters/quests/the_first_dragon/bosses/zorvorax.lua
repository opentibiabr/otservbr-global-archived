...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -120, maxDamage = -650, type = COMBAT_DEATHDAMAGE, range = 7, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_BLACKSMOKE, target = true},

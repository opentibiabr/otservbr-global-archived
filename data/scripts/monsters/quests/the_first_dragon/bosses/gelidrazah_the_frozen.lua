...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -310, maxDamage = -495, type = COMBAT_ICEDAMAGE, range = 5, radius = 5, effect = CONST_ME_ICETORNADO, target = true},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -210, maxDamage = -395, type = COMBAT_ICEDAMAGE, radius = 3, effect = CONST_ME_ICEAREA, target = false},

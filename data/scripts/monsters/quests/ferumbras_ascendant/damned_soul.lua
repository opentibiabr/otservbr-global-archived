...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 76, attack = 100, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 13, minDamage = -90, maxDamage = -240, type = COMBAT_DEATH, length = 3, spread = 0, effect = CONST_ME_MAGIC_RED, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 33, minDamage = -150, maxDamage = -250, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 25, minDamage = -350, maxDamage = -450, type = COMBAT_DROWN, target = false},

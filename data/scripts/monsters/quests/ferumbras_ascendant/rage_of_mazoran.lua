...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 120, attack = 80, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 12, minDamage = -65, maxDamage = -330, type = COMBAT_FIREDAMAGE, range = 7, radius = 3, effect = CONST_ME_HITBYFIRE, target = false},

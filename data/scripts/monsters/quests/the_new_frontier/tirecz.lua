...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 72, attack = 100, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -290, type = COMBAT_PHYSICALDAMAGE, radius = 3, effect = CONST_ME_BLOCKHIT, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -370, type = COMBAT_PHYSICALDAMAGE, radius = 7, effect = CONST_ME_DRAWBLOOD, target = false}
}

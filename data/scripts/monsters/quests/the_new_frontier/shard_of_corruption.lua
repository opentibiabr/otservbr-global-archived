...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -115, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_GREEN_RINGS, target = true}
}

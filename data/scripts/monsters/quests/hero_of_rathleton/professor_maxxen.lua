...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 11, minDamage = -250, maxDamage = -500, type = COMBAT_ENERGY, effect = CONST_ME_ENERGYHIT, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -450, maxDamage = -500, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},

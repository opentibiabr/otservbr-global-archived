...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 130, attack = 100, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 32, minDamage = -200, maxDamage = -400, type = COMBAT_PHYSICAL, effect = CONST_ME_CARNIPHILA, target = false},
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -500, maxDamage = -1000, type = COMBAT_PHYSICAL, length = 7, spread = 3, effect = CONST_ME_GROUNDSHAKER, target = false}
}

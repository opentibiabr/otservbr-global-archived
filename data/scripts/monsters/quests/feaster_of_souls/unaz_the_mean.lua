...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 25, minDamage = -300, maxDamage = -650, type = COMBAT_ENERGY, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1500, chance = 35, minDamage = -300, maxDamage = -650, type = COMBAT_DEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1500, chance = 20, minDamage = -300, maxDamage = -650, type = COMBAT_ENERGY, effect = CONST_ME_ENERGYAREA, target = false}
}

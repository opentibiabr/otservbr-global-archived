...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 35, minDamage = -300, maxDamage = -650, type = COMBAT_DEATHDAMAGE, radius = 4, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 1500, chance = 20, minDamage = -300, maxDamage = -650, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_GREEN_RINGS, target = true}
}

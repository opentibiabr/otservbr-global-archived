...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -350, type = COMBAT_EARTHDAMAGE, radius = 4, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 3000, chance = 15, minDamage = -200, maxDamage = -530, type = COMBAT_EARTHDAMAGE, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_HITBYPOISON, target = true}
}

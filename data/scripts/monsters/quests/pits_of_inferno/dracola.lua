...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -120, maxDamage = -750, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},
	-- drown
	{name ="combat", type = COMBAT_DROWNDAMAGE, interval = 1000, chance = 20, length = 8, spread = 3, effect = CONST_ME_POFF, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -300, maxDamage = -870, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_DRAWBLOOD, target = true},
	...
	{name ="combat", interval = 1000, chance = 23, minDamage = -50, maxDamage = -175, type = COMBAT_EARTHDAMAGE, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},

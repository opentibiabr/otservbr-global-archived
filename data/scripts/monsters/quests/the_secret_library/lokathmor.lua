...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 8, minDamage = -90, maxDamage = -200, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_WHIRLWINDAXE, effect = CONST_ME_EXPLOSIONAREA, target = true}
}

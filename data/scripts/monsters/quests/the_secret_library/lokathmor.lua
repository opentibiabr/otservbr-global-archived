...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 8, minDamage = -1100, maxDamage = -2800, type = COMBAT_LIFEDRAIN, range = 7, radius = 5, shootEffect = CONST_ANI_WHIRLWINDAXE, effect = CONST_ME_DRAWBLOOD, target = true},

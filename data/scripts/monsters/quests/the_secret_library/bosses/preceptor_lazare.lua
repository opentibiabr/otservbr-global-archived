...
monster.loot = {
	...
	{name = "Small Diamond", chance = 100000, maxCount = 3},
	...
	{name = "Soul Orb", chance = 100000, maxCount = 5},
	{name = "Demonic Essence", chance = 100000, maxCount = 5},
	{name = "Ham", chance = 100000, maxCount = 2},
	{name = "Small Ruby", chance = 700, maxCount = 3},
	{name = "red Gem", chance = 700, maxCount = 3},
	{name = "Onyx Arrow", chance = 700, maxCount = 3},
	{name = "Small Topaz", chance = 700, maxCount = 3},
	{name = "Small Diamond", chance = 7, maxCount = 3},
	{id = 7633, chance = 800},
	{name = "Violet Gem", chance = 600},
	{name = "Green Gem", chance = 600},
	{name = "Knight Armor", chance = 600},
	{name = "Titan Axe", chance = 600},
	{name = "Spiked Squelcher", chance = 600},
	{name = "Patch of Fine Cloth", chance = 500, maxCount = 3},
	{name = "Golden Armor", chance = 250},

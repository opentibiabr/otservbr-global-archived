...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = -150, maxDamage = -700, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 20, minDamage = -100, maxDamage = -720, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_ETHEREALSPEAR, target = false},
	{name ="combat", interval = 2000, chance = 14, minDamage = -100, maxDamage = -1000, type = COMBAT_HOLY, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false},

...
monster.loot = {
	...
	{name = "Green Gem", chance = 250},
	{name = "Damaged Armor Plates", chance = 320, maxCount = 3},
	{name = "Falcon Crest", chance = 310, maxCount = 3},
	{name = "Patch of Fine Cloth", chance = 320},
	{name = "Golden Armor", chance = 120},
	{name = "Mastermind Shield", chance = 120},
	{name = "Falcon Bow", chance = 60},
	{name = "Falcon Wand", chance = 60},
	{name = "Falcon Plate", chance = 60}
}

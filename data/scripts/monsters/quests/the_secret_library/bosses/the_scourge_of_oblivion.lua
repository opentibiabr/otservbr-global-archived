...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 250, attack = 350, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 8, minDamage = -1550, maxDamage = -2550, type = COMBAT_FIRE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -1075, maxDamage = -2405, type = COMBAT_ENERGY, range = 7, shootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_ENERGYHIT, target = true},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -450, maxDamage = -1400, type = COMBAT_DEATH, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	...
	{name ="combat", interval = 1000, chance = 34, minDamage = -100, maxDamage = -700, type = COMBAT_FIRE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},

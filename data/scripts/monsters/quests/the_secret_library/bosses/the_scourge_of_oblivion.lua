...
monster.attacks = {
	...
	{name ="drunk", interval = 2000, chance = 20, radius = 5, effect = CONST_ME_SMALLCLOUDS, target = false},
	...
	{name ="combat", interval = 2000, chance = 8, minDamage = -1550, maxDamage = -2550, type = COMBAT_FIREDAMAGE, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 1000, chance = 20, minDamage = -600, maxDamage = -1500, type = COMBAT_LIFEDRAIN, radius = 8, effect = CONST_ME_LOSEENERGY, target = false},

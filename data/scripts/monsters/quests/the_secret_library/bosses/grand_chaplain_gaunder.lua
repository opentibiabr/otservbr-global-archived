...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 15, minDamage = -200, maxDamage = -890, type = COMBAT_LIFEDRAIN, range = 4, radius = 4, effect = CONST_ME_HITBYPOISON, target = false},
	...
	{name ="combat", interval = 1000, chance = 15, minDamage = -200, maxDamage = -700, type = COMBAT_LIFEDRAIN, range = 5, radius = 3, effect = CONST_ME_SMALLCLOUDS, target = false}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2000, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 15, minDamage = -180, maxDamage = -660, type = COMBAT_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -600, maxDamage = -850, type = COMBAT_DEATH, length = 5, spread = 2, effect = CONST_ME_BLACKSMOKE, target = false},

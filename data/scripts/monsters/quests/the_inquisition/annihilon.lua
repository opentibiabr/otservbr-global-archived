...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -200, maxDamage = -700, type = COMBAT_DEATHDAMAGE, radius = 4, effect = CONST_ME_ICEAREA, target = false},
	{name ="combat", interval = 3000, chance = 18, minDamage = -50, maxDamage = -255, type = COMBAT_PHYSICALDAMAGE, radius = 5, effect = CONST_ME_GROUNDSHAKER, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -50, maxDamage = -600, type = COMBAT_FIREDAMAGE, radius = 6, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

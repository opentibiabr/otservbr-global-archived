...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 8, minDamage = -30, maxDamage = -760, type = COMBAT_DEATHDAMAGE, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false},

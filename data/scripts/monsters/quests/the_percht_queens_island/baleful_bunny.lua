...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 1, minDamage = -100, maxDamage = -150, type = COMBAT_PHYSICALDAMAGE, radius = 4, effect = CONST_ME_POFF, target = true},
	{name ="combat", interval = 2000, chance = 1, minDamage = -100, maxDamage = -150, type = COMBAT_FIREDAMAGE, radius = 1, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 111, minDamage = -100, maxDamage = -150, type = COMBAT_LIFEDRAIN, radius = 4, effect = CONST_ME_DRAWBLOOD, target = true}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 14, minDamage = -350, maxDamage = -500, type = COMBAT_FIRE, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_EXPLOSIONHIT, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -250, maxDamage = -400, type = COMBAT_ENERGY, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 12, minDamage = -250, maxDamage = -350, type = COMBAT_ENERGY, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false}
}

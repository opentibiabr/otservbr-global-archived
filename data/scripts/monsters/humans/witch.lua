...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -30, maxDamage = -75, type = COMBAT_FIRE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_HITBYFIRE, target = false},

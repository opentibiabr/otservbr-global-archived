...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 50, minDamage = -60, maxDamage = -200, type = COMBAT_PHYSICALDAMAGE, range = 8, shootEffect = CONST_ANI_ARROW, target = false}
}

monster.defenses = {
	defense = 32,
	armor = 32,
	{name ="combat", interval = 3000, chance = 35, minDamage = 200, maxDamage = 250, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}

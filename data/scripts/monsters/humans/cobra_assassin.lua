...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -280, maxDamage = -400, type = COMBAT_PHYSICAL, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 2000, chance = 12, minDamage = -250, maxDamage = -400, type = COMBAT_PHYSICAL, length = 5, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}

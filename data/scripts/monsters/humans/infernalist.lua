...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, minDamage = -65, maxDamage = -180, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_HITBYFIRE, target = true},
	{name ="combat", interval = 2000, chance = 20, minDamage = -90, maxDamage = -180, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -150, maxDamage = -250, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},
	{name ="combat", interval = 2000, chance = 5, minDamage = -100, maxDamage = -150, type = COMBAT_PHYSICAL, effect = CONST_ME_EXPLOSIONAREA, target = false}
}

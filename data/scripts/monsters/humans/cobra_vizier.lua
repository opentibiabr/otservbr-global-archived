...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 12, minDamage = -350, maxDamage = -520, type = COMBAT_EARTHDAMAGE, radius = 4, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_GREEN_RINGS, target = true}
}

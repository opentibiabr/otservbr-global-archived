...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, minDamage = -90, maxDamage = -180, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGY, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -50, maxDamage = -180, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_BURSTARROW, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 2000, chance = 10, range = 7, ShootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -150, maxDamage = -230, type = COMBAT_ENERGY, length = 8, spread = 3, effect = CONST_ME_BIGCLOUDS, target = false},

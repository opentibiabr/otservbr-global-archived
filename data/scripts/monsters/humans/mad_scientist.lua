...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -20, maxDamage = -56, type = COMBAT_DROWN, range = 7, ShootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_POFF, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -20, maxDamage = -36, type = COMBAT_EARTH, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_ENERGYHIT, target = false},

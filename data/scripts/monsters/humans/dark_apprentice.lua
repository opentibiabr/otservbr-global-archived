...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -60, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -2, maxDamage = -26, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = -10, maxDamage = -20, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGY, target = false},
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -24, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_SMALLSTONE, target = false},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -40, type = COMBAT_PHYSICALDAMAGE, range = 7, radius = 1, shootEffect = CONST_ANI_THROWINGSTAR, target = true}
}

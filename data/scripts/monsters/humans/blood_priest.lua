...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -60, maxDamage = -100, type = COMBAT_DEATHDAMAGE, range = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_SMALLCLOUDS, target = true},

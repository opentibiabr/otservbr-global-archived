...
monster.attacks = {
	...
	-- physical damage
	{name ="combat", type = COMBAT_PHYSICALDAMAGE, interval = 3000, chance = 11, minDamage = -100, maxDamage = -300, radius = 6, shootEffect = CONST_ANI_WHIRLWINDCLUB, effect = CONST_ME_DRAWBLOOD, target = true},

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = 0, maxDamage = -50, type = COMBAT_EARTH, range = 4, ShootEffect = CONST_ANI_SMALLSTONE, effect = CONST_ME_STONES, target = true},
	-- earth damage

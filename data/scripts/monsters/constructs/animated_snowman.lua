...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -10, maxDamage = -40, type = COMBAT_ENERGYDAMAGE, range = 7, radius = 2, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true}
}

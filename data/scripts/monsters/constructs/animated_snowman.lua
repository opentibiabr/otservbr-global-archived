...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -10, maxDamage = -40, type = COMBAT_ENERGY, range = 7, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true}
}

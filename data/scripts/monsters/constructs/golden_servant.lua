...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -60, maxDamage = -100, type = COMBAT_ENERGY, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_YELLOWENERGY, target = true},
	{name ="combat", interval = 2000, chance = 15, minDamage = -80, maxDamage = -110, type = COMBAT_ENERGY, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 10, minDamage = -90, maxDamage = -150, type = COMBAT_ENERGY, length = 5, spread = 2, effect = CONST_ME_YELLOWENERGY, target = false}
}

...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 84, attack = 50, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -125, maxDamage = -230, type = COMBAT_DEATH, length = 8, spread = 3, effect = CONST_ME_YELLOWENERGY, target = false},

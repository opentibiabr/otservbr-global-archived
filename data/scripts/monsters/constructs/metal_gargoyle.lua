...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 9, minDamage = -85, maxDamage = -150, type = COMBAT_LIFEDRAIN, range = 7, radius = 3, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},

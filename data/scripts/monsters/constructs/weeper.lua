...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -400, maxDamage = -1000, type = COMBAT_FIRE, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},
	{name ="combat", interval = 3000, chance = 100, minDamage = -80, maxDamage = -250, type = COMBAT_FIRE, effect = CONST_ME_HITBYFIRE, target = false},

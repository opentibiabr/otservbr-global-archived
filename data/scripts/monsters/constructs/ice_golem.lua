...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -220, effect = CONST_ME_DRAWBLOOD},
	{name ="speed", interval = 1000, chance = 13, SpeedChange = -800, Duration = 20000},
	{name ="combat", interval = 1000, chance = 15, minDamage = -50, maxDamage = -85, type = COMBAT_ICE, range = 7, ShootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_ICEATTACK, target = false},

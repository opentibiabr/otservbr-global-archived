...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_PHYSICAL, effect = CONST_ME_SOUND_WHITE, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICAL, effect = CONST_ME_SOUND_GREEN, target = false},

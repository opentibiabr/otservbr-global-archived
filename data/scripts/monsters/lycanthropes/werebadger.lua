...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 50, attack = 60, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, startDamage = 140, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 15, minDamage = -10, maxDamage = -100, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_CARNIPHILA, target = false},

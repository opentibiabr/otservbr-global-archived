...
local wood1 = Position(32647, 32216, 7)
			...
			if wooda then
			wooda:remove()
			local woods = Game.createItem(12183, 1, { x=27873, y=28632, z=7})
...
local wood11 = Position(32660, 32213, 7)
			...
			if woodaa then
			woodaa:remove()
			local woodss = Game.createItem(12183, 1, { x=27887, y=13747, z=7}) -- 27887, 13747, 7
...
local wood111 = Position(32644, 32183, 6)
			...
			if woodaaa then
			woodaaa:remove()
			local woodsss = Game.createItem(12185, 1, { x=27870, y=13693, z=6}) -- 27887, 13747, 7
...
local wood1111 = Position(32660, 32201, 7)
			...
			if woodaaaa then
			woodaaaa:remove()
			local woodssss = Game.createItem(12184, 1, { x=27887, y=13735, z=7}) --
...
local wood11111 = Position(32652, 32200, 5)
			...
			if woodaaaaa then
			woodaaaaa:remove()
			local woodsssss = Game.createItem(12185, 1, { x=27879, y=13734, z=5}) --
...
function hammer.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif targetActionId == 42501 then
			if player:getStorageValue(36765) == 3 and player:getStorageValue(Storage.RottinWoodAndMaried.RottinStart) < 6 then

			local wood1 = Position(32647, 32216, 7)
			local wooda = Tile(wood1):getItemById(12183)
			if wooda then
			wooda:remove()
			Game.createItem(6474, 1, { x=27873, y=28632, z=7})
			...
			if woodaa then
			woodaa:remove()
			Game.createItem(6474, 1, { x=27887, y=13747, z=7})
			...
			if woodaaa then
			woodaaa:remove()
			Game.createItem(6473, 1, { x=27870, y=13693, z=6})
			...
			if woodaaaa then
			woodaaaa:remove()
			Game.createItem(6473, 1, { x=27887, y=13735, z=7})
			...
			if woodaaaaa then
			woodaaaaa:remove()
			Game.createItem(6473, 1, { x=27879, y=13734, z=5})

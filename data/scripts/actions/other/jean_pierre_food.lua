...
local iid = {[9079] = 0, [9080] = 1, [9081] = 2, [9082] = 3, [9083] = 4, [9084] = 5, [9085] = 6, [9086] = 7, [10000] = 8, [9088] = 9, [11584] = 10, [11586] = 11, [11587] = 12, [11588] = 13}

local jeanPierreFood = Action()

function jeanPierreFood.onUse(player, item, frompos, item2, topos)
	local cid = player:getId()
	if player:getStorageValue(15305 + iid[item.itemid]) > os.time() then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You need to wait before using it again.")
		return true
	end
	player:setStorageValue(15305 + iid[item.itemid],os.time() + (15 * 60))

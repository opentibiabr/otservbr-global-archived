...
function flaskPotion.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if potion.level and player:getLevel() < potion.level or potion.vocations and not table.contains(potion.vocations, player:getVocation():getVocationBaseId()) and not (player:getGroup():getId() >= 2) then

...
function ferumbrasAscendantTheShattererLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if item.itemid == 9825 then
		...
		Game.setStorageValue(GlobalStorage.FerumbrasAscendant.TheShattererTimer, 1)
		addEvent(clearForgotten, 30 * 60 * 1000, Position(33377, 32390, 14), Position(33446, 32447, 14), Position(33319, 32318, 13), GlobalStorage.FerumbrasAscendant.TheShattererTimer)
		item:transform(9826)

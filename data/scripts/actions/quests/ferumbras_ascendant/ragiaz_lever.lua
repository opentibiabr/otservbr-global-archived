...
function ferumbrasAscendantRagiaz.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if item.itemid == 9825 then
		...
		Game.setStorageValue(Storage.FerumbrasAscension.RagiazTimer, 1)
		addEvent(clearForgotten, 30 * 60 * 1000, Position(33472, 32323, 13), Position(33493, 32347, 13), Position(33319, 32318, 13), Storage.FerumbrasAscension.RagiazTimer)
		item:transform(9826)

...
function explorerSocietyBotanist.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if target.itemid == 3874 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 17 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 17 then
		...
		item:transform(4868)
	elseif target.itemid == 3885 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 20 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 20 then
		...
		toPosition:sendMagicEffect(CONST_ME_MAGIC_BLUE)
		item:transform(4869)
	elseif target.itemid == 3878 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 23 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 23 then

...
ARENA = {
	[1] = {
		name = 'Greenhorn',
		price = 1000,
		questLog = Storage.Quest.BarbarianArena.QuestLogGreenhorn,
		...
		reward = {
			trophy = 5807,
			trophyStorage = Storage.Quest.BarbarianArena.TrophyGreenhorn,
	...
	[2] = {
		name = 'Scrapper',
		price = 5000,
		questLog = Storage.Quest.BarbarianArena.QuestLogScrapper,
		...
		reward = {
			trophy = 5806,
			trophyStorage = Storage.Quest.BarbarianArena.TrophyScrapper,
	...
	[3] = {
		name = 'Warlord',
		price = 10000,
		questLog = Storage.Quest.BarbarianArena.QuestLogWarlord,
		...
		reward = {
			trophy = 5805,
			trophyStorage = Storage.Quest.BarbarianArena.TrophyWarlord,
...
function SvargrondArena.kickPlayer(cid, hideMessage)
	...
	if player:getStorageValue(Storage.Quest.BarbarianArena.Pit) > 0 then
		player:teleportTo(SvargrondArena.kickPosition)
		SvargrondArena.kickPosition:sendMagicEffect(CONST_ME_TELEPORT)
		player:setStorageValue(Storage.Quest.BarbarianArena.Pit, 0)

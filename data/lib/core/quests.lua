--[[if not Quests then
	Quests = {
		[1] = {
			name = "The Explorer Society", startstorageid = Storage.Quest.TheExplorerSociety.QuestLine, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Joining the Explorers", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 1, endvalue = 4,
					states = {
				...
				[2] = {
					name = "The Ice Delivery", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 5, endvalue = 7,
					states = {
				...
				[3] = {
					name = "The Butterfly Hunt", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 8, endvalue = 16,
					states = {
				...
				[4] = {
					name = "The Plant Collection", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 17, endvalue = 26,
					states = {
				...
				[5] = {
					name = "The Lizard Urn", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 27, endvalue = 29,
					states = {
				...
				[6] = {
					name = "The Bonelord Secret", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 30, endvalue = 32,
					states = {
				...
				[7] = {
					name = "The Orc Powder", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 33, endvalue = 35,
					states = {
				...
				[8] = {
					name = "The Elven Poetry", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 36, endvalue = 38,
					states = {
				...
				[9] = {
					name = "The Memory Stone", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 39, endvalue = 41,
					states = {
				...
				[10] = {
					name = "The Rune Writings", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 42, endvalue = 47,
					states = {
				...
				[11] = {
					name = "The Ectoplasm", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 45, endvalue = 47,
					states = {
				...
				[12] = {
					name = "The Spectral Dress", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 48, endvalue = 50,
					states = {
				...
				[13] = {
					name = "The Spectral Stone", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 51, endvalue = 55,
					states = {
				...
				[14] = {
					name = "The Astral Portals", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 56, endvalue = 56,
					states = {
				...
				[15] = {
					name = "The Island of Dragons", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 57, endvalue = 58,
					states = {
				...
				[16] = {
					name = "The Ice Music", storageid = Storage.Quest.TheExplorerSociety.QuestLine, startvalue = 60, endvalue = 61,
					states = {
				...
				[17] = {
					name = "The Undersea Kingdom", storageid = Storage.Quest.TheExplorerSociety.CalassaQuest, startvalue = 1, endvalue = 2,
					states = {
		...
		[2] = {
			name = "Spirithunters Quest", startstorageid = Storage.Quest.Spirithunters.MissionOne, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Method", storageid = Storage.Quest.Spirithunters.MissionOne, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "First Mission", storageid = Storage.Quest.Spirithunters.MissionOne, startvalue = 2, endvalue = 4,
					states = {
				...
				[3] = {
					name = "Second Mission", storageid = Storage.Quest.Spirithunters.MissionOne, startvalue = 4, endvalue = 6,
					states = {
		...
		[3] = {
			name = "Spike Task", startstorageid = Storage.Quest.SpikeTasks.QuestLine, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "First Task", storageid = Storage.Quest.SpikeTasks.Gnomilly, startvalue = 0, endvalue = 100, description = function(player)return string.format("You have %d points of task. You need 100 points to take Cave Explorer outfit.", (math.max(player:getStorageValue(Storage.Quest.SpikeTasks.Gnomilly), 0))) end,
				},

				[2] = {
					name = "Second Task", storageid = Storage.Quest.SpikeTasks.Gnombold.Points, startvalue = 0, endvalue = 100, description = function(player)return string.format("You have %d points of task. You need 100 points to take first addon.", (math.max(player:getStorageValue(Storage.Quest.SpikeTasks.Gnombold.Points), 0))) end,
				},

				[3] = {
					name = "Third Task", storageid = Storage.Quest.SpikeTasks.Gnomargery.Points, startvalue = 0, endvalue = 100, description = function(player)return string.format("You have %d points of task. You need 100 points to take second addon.", (math.max(player:getStorageValue(Storage.Quest.SpikeTasks.Gnomargery.Points), 0))) end,
				},
		...
		[4] = {
			name = "A Father's Burden", startstorageid = Storage.Quest.FathersBurdenQuest.QuestLog, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Birthday Presents", storageid = Storage.Quest.FathersBurdenQuest.Status, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "The Magic Bow - Sinew", storageid = Storage.Quest.FathersBurdenQuest.Sinew, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "The Magic Bow - Wood", storageid = Storage.Quest.FathersBurdenQuest.Wood, startvalue = 1, endvalue = 2,
					states = {
				...
				[4] = {
					name = "The Magic Robe - Cloth", storageid = Storage.Quest.FathersBurdenQuest.Cloth, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "The Magic Robe - Silk", storageid = Storage.Quest.FathersBurdenQuest.Silk, startvalue = 1, endvalue = 2,
					states = {
				...
				[6] = {
					name = "The Magic Rod - Crystal", storageid = Storage.Quest.FathersBurdenQuest.Crystal, startvalue = 1, endvalue = 2,
					states = {
				...
				[7] = {
					name = "The Magic Rod - Root", storageid = Storage.Quest.FathersBurdenQuest.Root, startvalue = 1, endvalue = 2,
					states = {
				...
				[8] = {
					name = "The Magic Shield - Iron", storageid = Storage.Quest.FathersBurdenQuest.Iron, startvalue = 1, endvalue = 2,
					states = {
				...
				[9] = {
					name = "The Magic Shield - Scale", storageid = Storage.Quest.FathersBurdenQuest.Scale, startvalue = 1, endvalue = 2,
					states = {
		...
		[5] = {
			name = "Bigfoot's Burden", startstorageid = Storage.Quest.BigfootBurden.QuestLine, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Looking for Gnomerik", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 1, endvalue = 2, description = "The dwarf Xelvar has sent you to meet the gnome Gnomerik. He can recruit you to the Bigfoot Company. Use the teleporter near Xelvar to enter the gnomish base and start looking for Gnomerik.",
				},

				[2] = {
					name = "A New Recruit", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 3, endvalue = 4, description = "You have found the gnomish recruiter and are ready to become a Bigfoot.",
				},

				[3] = {
					name = "Recruitment: A Test in Gnomology", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 5, endvalue = 7,
					states = {
				...
				[4] = {
					name = "Recruitment: Medical Examination", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 8, endvalue = 9, description = "Walk through the g-ray apparatus for your g-raying.",
				},

				[5] = {
					name = "Recruitment: Ear Examination", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 10, endvalue = 12,
					states = {
				...
				[6] = {
					name = "Recruitment: Gnomish Warfare", storageid = Storage.Quest.BigfootBurden.Shooting, startvalue = 0, endvalue = 5, description = function(player)return string.format("Hit five targets in a row. Don't hit an innocent target as it will reset your hit counter. %d / 5", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.Shooting), 0))) end,
				},

				[7] = {
					name = "Recruitment: Gnomish Warfare", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 15, endvalue = 16, description = "You are now ready for your endurance test. Talk to Gnomewart about it.",
				},

				[8] = {
					name = "Recruitment: Endurance Test", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 17, endvalue = 20,
					states = {
				...
				[9] = {
					name = "Recruitment: Soul Melody", storageid = Storage.Quest.BigfootBurden.QuestLine, startvalue = 21, endvalue = 23,
					states = {
				...
				[10] = {
					name = "Recruitment", storageid = Storage.Quest.BigfootBurden.QuestLineComplete, startvalue = 1, endvalue = 2, description = "You are now a true member of the Bigfoot company.",
				},

				[11] = {
					name = "Gnome Reputation", storageid = Storage.Quest.BigfootBurden.Rank, startvalue = 0, endvalue = 999999, description = function(player)return string.format("Your reputation in the eyes of gnomekind is %d.\nYour standing rises at: \nReputation   30 - I \nReputation  120 - II \nReputation  480 - III \nReputation 1440 - IV \n", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.Rank), 0))) end,
				},

				[12] = {
					name = "Daily Minor: Crystal Keeper", storageid = Storage.Quest.BigfootBurden.RepairedCrystalCount, startvalue = 0, endvalue = 5, description = function(player)return string.format("Use the repair crystal to repair five damaged blue crystals in the crystal caves. Damaged crystals will not glow.\n%d / 5", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.RepairedCrystalCount), 0))) end,
				},

				[13] = {
					name = "Daily Minor: Raiders of the Lost Spark", storageid = Storage.Quest.BigfootBurden.ExtractedCount, startvalue = 0, endvalue = 7, description = function(player)return string.format("Kill crystal crushers and use the discharger item on the corpse to collect their charges. Gather 7 charges and report back. %d / 7", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.ExtractedCount), 0 ))) end,
				},

				[14] = {
					name = "Daily Minor Plus: Exterminators", storageid = Storage.Quest.BigfootBurden.ExterminatedCount, startvalue = 0, endvalue = 10, description = function(player)return string.format("Kill 10 of the wigglers for the gnomes. Then report back. %d / 10", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.ExterminatedCount), 0))) end,
				},

				[15] = {
					name = "Daily Minor Plus: Mushroom Digger", storageid = Storage.Quest.BigfootBurden.MushroomCount, startvalue = 0, endvalue = 3, description = function(player)return string.format("Find a truffle sniffing pig and lure it around. Occasionally it will unearth some truffles. Use the baby pig on the truffles to feed it 3 times. Then report back to the gnomes. %d / 3", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.MushroomCount), 0))) end,
				},

				[16] = {
					name = "Daily Major: Matchmaker", storageid = Storage.Quest.BigfootBurden.MatchmakerStatus, startvalue = 0, endvalue = 1,
					states = {
				...
				[17] = {
					name = "Daily Major: The Tinker's Bell", storageid = Storage.Quest.BigfootBurden.GolemCount, startvalue = 0, endvalue = 4, description = function(player)return string.format("Use the harmonic bell on the mad golems in the golem workshop so that they will automatically be teleported to the gnomish workshops. Then report back to the gnomes. %d / 4", (math.max(player:getStorageValue(Storage.Quest.BigfootBurden.GolemCount), 0))) end,
				},

				[18] = {
					name = "Daily Major Advanced: Spores", storageid = Storage.Quest.BigfootBurden.SporeCount, startvalue = 0, endvalue = 4, description = "Gather spores in the correct order. Your spore gathering list will display the next color you have to look for.",
				},

				[19] = {
					name = "Daily Major Advanced: Yet Another Grinding", storageid = Storage.Quest.BigfootBurden.GrindstoneStatus, startvalue = 0, endvalue = 2, description = "Gather a grindstone from the lava area en report back.",
				},

				[20] = {
					name = "Gnomish War Hero (Warzone 1)", storageid = Storage.Quest.BigfootBurden.Warzone1Access, startvalue = 1, endvalue = 2,
					states = {
				...
				[21] = {
					name = "Gnomish War Hero (Warzone 2)", storageid = Storage.Quest.BigfootBurden.Warzone2Access, startvalue = 1, endvalue = 2,
					states = {
				...
				[22] = {
					name = "Gnomish War Hero (Warzone 3)", storageid = Storage.Quest.BigfootBurden.Warzone3Access, startvalue = 1, endvalue = 2,
					states = {
		...
		[6] = {
			name = "Barbarian Test Quest", startstorageid = Storage.Quest.BarbarianTest.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Barbarian Test 1: Barbarian Booze", storageid = Storage.Quest.BarbarianTest.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Barbarian Test 2: The Bear Hugging", storageid = Storage.Quest.BarbarianTest.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Barbarian Test 3: The Mammoth Pushing", storageid = Storage.Quest.BarbarianTest.Mission03, startvalue = 1, endvalue = 3,
					states = {
		...
		[7] = {
			name = "Children of the Revolution", startstorageid = Storage.Quest.ChildrenoftheRevolution.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Prove Your Worzz!", storageid = Storage.Quest.ChildrenoftheRevolution.Mission00, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Mission 1: Corruption", storageid = Storage.Quest.ChildrenoftheRevolution.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 2: Imperial Zzecret Weaponzz", storageid = Storage.Quest.ChildrenoftheRevolution.Mission02, startvalue = 1, endvalue = 5,
					states = {
				...
				[4] = {
					name = "Mission 3: Zee Killing Fieldzz", storageid = Storage.Quest.ChildrenoftheRevolution.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "Mission 4: Zze Way of Zztonezz", storageid = Storage.Quest.ChildrenoftheRevolution.Mission04, startvalue = 1, endvalue = 6,
					states = {
				...
				[6] = {
					name = "Mission 5: Phantom Army", storageid = Storage.Quest.ChildrenoftheRevolution.Mission05, startvalue = 1, endvalue = 3,
					states = {
		...
		[8] = {
			name = "Factions", startstorageid = Storage.Quest.Factions, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Marid and the Efreet - Djinn Greeting", storageid = Storage.Quest.DjinnWar.Faction.Greeting, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "The Marid and the Efreet - Marid Faction", storageid = Storage.Quest.DjinnWar.Faction.Marid, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "The Efreet and the Efreet - Efreet Faction", storageid = Storage.Quest.DjinnWar.Faction.Efreet, startvalue = 1, endvalue = 2,
					states = {
		...
		[9] = {
			name = "Friends and Traders", startstorageid = Storage.Quest.FriendsandTraders.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Sweaty Cyclops", storageid = Storage.Quest.FriendsandTraders.TheSweatyCyclops, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "The Mermaid Marina", storageid = Storage.Quest.FriendsandTraders.TheMermaidMarina, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "The Blessed Stake", storageid = Storage.Quest.FriendsandTraders.TheBlessedStake, startvalue = 1, endvalue = 12,
					states = {
		...
		[10] = {
			name = "Hot Cuisine", startstorageid = Storage.Quest.HotCuisineQuest.QuestStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Hot Cuisine", storageid = Storage.Quest.HotCuisineQuest.QuestLog, startvalue = 1, endvalue = 16,
					states = {
		...
		[11] = {
			name = "In Service of Yalahar", startstorageid = Storage.Quest.InServiceofYalahar.Questline, startstoragevalue = 5,
			missions = {
				[1] = {
					name = "Mission 01: Something Rotten", storageid = Storage.Quest.InServiceofYalahar.Mission01, startvalue = 1, endvalue = 6,
					states = {
				...
				[2] = {
					name = "Mission 02: Watching the Watchmen", storageid = Storage.Quest.InServiceofYalahar.Mission02, startvalue = 1, endvalue = 8,
					states = {
				...
				[3] = {
					name = "Mission 03: Death to the Deathbringer", storageid = Storage.Quest.InServiceofYalahar.Mission03, startvalue = 1, endvalue = 6,
					states = {
				...
				[4] = {
					name = "Mission 04: Good to be Kingpin", storageid = Storage.Quest.InServiceofYalahar.Mission04, startvalue = 1, endvalue = 6,
					states = {
				...
				[5] = {
					name = "Mission 05: Food or Fight", storageid = Storage.Quest.InServiceofYalahar.Mission05, startvalue = 1, endvalue = 8,
					states = {
						[1] = "Ask Palimuth for mission.",
				...
				[6] = {
					name = "Mission 06: Frightening Fuel", storageid = Storage.Quest.InServiceofYalahar.Mission06, startvalue = 1, endvalue = 5,
					states = {
						[1] = "Ask Palimuth for mission.",
				...
				[7] = {
					name = "Mission 07: A Fishy Mission", storageid = Storage.Quest.InServiceofYalahar.Mission07, startvalue = 1, endvalue = 5,
					states = {
						[1] = "Ask Palimuth for mission.",
				...
				[8] = {
					name = "Mission 08: Dangerous Machinations", storageid = Storage.Quest.InServiceofYalahar.Mission08, startvalue = 1, endvalue = 4,
					states = {
						[1] = "Ask Palimuth for mission.",
				...
				[9] = {
					name = "Mission 09: Decision", storageid = Storage.Quest.InServiceofYalahar.Mission09, startvalue = 1, endvalue = 2,
					states = {
				...
				[10] = {
					name = "Mission 10: The Final Battle", storageid = Storage.Quest.InServiceofYalahar.Mission10, startvalue = 1, endvalue = 5,
					states = {
		...
		[12] = {
			...
			missions = {
				...
				[6] = {
					name = "Paw and Fur: Tiquandas Revenge", storageid = Storage.Quest.KillingInTheNameOf.TiquandasRevengeTeleport, startvalue = 1, endvalue = 2,
					states = {
				...
				[7] = {
					name = "Paw and Fur: Demodras", storageid = Storage.Quest.KillingInTheNameOf.DemodrasTeleport, startvalue = 1, endvalue = 2,
					states = {
		...
		[13] = {
			name = "Outfit and Addon Quests", startstorageid = Storage.Quest.OutfitQuest.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Assassin Addon: The Red Death", storageid = Storage.Quest.OutfitQuest.AssassinSecondAddon, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Citizen Addon: Backpack", storageid = Storage.Quest.OutfitQuest.Citizen.MissionBackpack, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "Citizen Addon: Feather Hat", storageid = Storage.Quest.OutfitQuest.Citizen.MissionHat, startvalue = 1, endvalue = 2,
					states = {
				...
				[4] = {
					name = "Barbarian Outfit Quest", storageid = Storage.Quest.OutfitQuest.BarbarianAddon, startvalue = 1, endvalue = 17,
					states = {
				...
				[5] = {
					name = "Beggar Outfit: The Newest Fashion", storageid = Storage.Quest.OutfitQuest.BeggarOutfit, startvalue = 1, endvalue = 6,
					states = {
				...
				[6] = {
					name = "Druid Outfit Quest", storageid = Storage.Quest.OutfitQuest.DruidHatAddon, startvalue = 1, endvalue = 10,
					states = {
				...
				[7] = {
					name = "Hunter Outfit Quest", storageid = Storage.Quest.OutfitQuest.HunterHatAddon, startvalue = 1, endvalue = 5,
					states = {
				...
				[8] = {
					name = "Knight Addon: Helmet", storageid = Storage.Quest.OutfitQuest.Knight.MissionHelmet, startvalue = 1, endvalue = 6,
					states = {
				...
				[9] = {
					name = "Mage &amp; Summoner Outfit Quest (Wand)", storageid = Storage.Quest.OutfitQuest.MageSummoner.AddonWand, startvalue = 1, endvalue = 7,
					states = {
				...
				[10] = {
					name = "Mage &amp; Summoner Outfit Quest (Fluid Belt)", storageid = Storage.Quest.OutfitQuest.MageSummoner.AddonBelt, startvalue = 1, endvalue = 2,
					states = {
				...
				[11] = {
					name = "Female Mage and Male Summoner Addon: Headgear", storageid = Storage.Quest.OutfitQuest.MageSummoner.MissionHatCloak, startvalue = 1, endvalue = 11,
					states = {
				...
				[12] = {
					name = "Norseman Outfit Quest", storageid = Storage.Quest.OutfitQuest.NorsemanAddon, startvalue = 1, endvalue = 3,
					states = {
				...
				[13] = {
					name = "Warrior Addon: Shoulder Spike", storageid = Storage.Quest.OutfitQuest.WarriorShoulderAddon, startvalue = 1, endvalue = 7,
					states = {
				...
				[14] = {
					name = "Wizard Outfits Quest", storageid = Storage.Quest.OutfitQuest.WizardAddon, startvalue = 1, endvalue = 7,
					states = {
				...
				[15] = {
					name = "Pirate Outfit Quest (Sabre)", storageid = Storage.Quest.OutfitQuest.PirateSabreAddon, startvalue = 1, endvalue = 5,
					states = {
				...
				[16] = {
					name = "Oriental Addon: Hipwear", storageid = Storage.Quest.OutfitQuest.firstOrientalAddon, startvalue = 1, endvalue = 2,
					states = {
				...
				[17] = {
					name = "Oriental Addon: Headgear", storageid = Storage.Quest.OutfitQuest.secondOrientalAddon, startvalue = 1, endvalue = 5,
					states = {
				...
				[18] = {
					name = "Shaman Addon: Staff", storageid = Storage.Quest.OutfitQuest.Shaman.MissionStaff, startvalue = 1, endvalue = 2,
					states = {
				...
				[19] = {
					name = "Shaman Addon: Mask", storageid = Storage.Quest.OutfitQuest.Shaman.MissionMask, startvalue = 1, endvalue = 2,
					states = {
		...
		[14] = {
			name = "Sam's Old Backpack", startstorageid = Storage.Quest.SamsOldBackpack, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Dwarven Armor Quest", storageid = Storage.Quest.SamsOldBackpack, startvalue = 1, endvalue = 3,
					states = {
		...
		[15] = {
			name = "Sea of Light", startstorageid = Storage.Quest.SeaOfLightQuest.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 1: The Plans", storageid = Storage.Quest.SeaOfLightQuest.Mission1, startvalue = 1, endvalue = 4,
					states = {
				...
				[2] = {
					name = "Mission 2: The Collector", storageid = Storage.Quest.SeaOfLightQuest.Mission2, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 3: The Mirror Crystal", storageid = Storage.Quest.SeaOfLightQuest.Mission3, startvalue = 1, endvalue = 4,
					states = {
		...
		[16] = {
			name = "Secret Service", startstorageid = Storage.Quest.secretService.Quest, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 1: From Thais with Love", storageid = Storage.Quest.secretService.TBIMission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Mission 1: For Your Eyes Only", storageid = Storage.Quest.secretService.AVINMission01, startvalue = 1, endvalue = 4,
					states = {
				...
				[3] = {
					name = "Mission 1: Borrowed Knowledge", storageid = Storage.Quest.secretService.CGBMission01, startvalue = 1, endvalue = 2,
					states = {
				...
				[4] = {
					name = "Mission 2: Operation Green Claw", storageid = Storage.Quest.secretService.TBIMission02, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "Mission 2: A File Between Friends", storageid = Storage.Quest.secretService.AVINMission02, startvalue = 1, endvalue = 2,
					states = {
				...
				[6] = {
					name = "Mission 2: Codename:Lumberjack", storageid = Storage.Quest.secretService.CGBMission02, startvalue = 1, endvalue = 2,
					states = {
				...
				[7] = {
					name = "Mission 3: Treachery in Port Hope", storageid = Storage.Quest.secretService.TBIMission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[8] = {
					name = "Mission 3: What Men are Made of", storageid = Storage.Quest.secretService.AVINMission03, startvalue = 1, endvalue = 4,
					states = {
				...
				[9] = {
					name = "Mission 3: Rust in Peace", storageid = Storage.Quest.secretService.CGBMission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[10] = {
					name = "Mission 4: Objective Hellgate", storageid = Storage.Quest.secretService.TBIMission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[11] = {
					name = "Mission 4: Pawn Captures Knight", storageid = Storage.Quest.secretService.AVINMission04, startvalue = 1, endvalue = 3,
					states = {
				...
				[12] = {
					name = "Mission 4: Plot for A Plan", storageid = Storage.Quest.secretService.CGBMission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[13] = {
					name = "Mission 5: Coldfinger", storageid = Storage.Quest.secretService.TBIMission05, startvalue = 1, endvalue = 3,
					states = {
				...
				[14] = {
					name = "Mission 5: A Cryptic Mission", storageid = Storage.Quest.secretService.AVINMission05, startvalue = 1, endvalue = 2,
					states = {
				...
				[15] = {
					name = "Mission 5: No Admittance", storageid = Storage.Quest.secretService.CGBMission05, startvalue = 1, endvalue = 2,
					states = {
				...
				[16] = {
					name = "Mission 6: The Weakest Spot", storageid = Storage.Quest.secretService.TBIMission06, startvalue = 1, endvalue = 3,
					states = {
				...
				[17] = {
					name = "Mission 6: A Little Bribe Won't Hurt", storageid = Storage.Quest.secretService.AVINMission06, startvalue = 1, endvalue = 3,
					states = {
				...
				[18] = {
					name = "Mission 6: News From the Past", storageid = Storage.Quest.secretService.CGBMission06, startvalue = 1, endvalue = 2,
					states = {
				...
				[19] = {
					name = "Mission 7: Licence to Kill", storageid = Storage.Quest.secretService.Mission07, startvalue = 1, endvalue = 2,
					states = {
		...
		[17] = {
			name = "The Ancient Tombs", startstorageid = Storage.Quest.TheAncientTombs.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
		...
		[18] = {
			name = "The Ape City", startstorageid = Storage.Quest.TheApeCity.Started, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Hairycles' Missions", storageid = Storage.Quest.TheApeCity.Questline, startvalue = 1, endvalue = 18,
					states = {
		...
		[19] = {
			name = "The Beginning", startstorageid = Storage.Quest.RookgaardTutorialIsland.SantiagoQuestLog, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Cockroach Plague", storageid = Storage.Quest.RookgaardTutorialIsland.SantiagoQuestLog, startvalue = 1, endvalue = 11,
					states = {
				...
				[2] = {
					name = "Collecting Wood", storageid = Storage.Quest.RookgaardTutorialIsland.ZirellaQuestLog, startvalue = 1, endvalue = 8,
					states = {
				...
				[3] = {
					name = "A Hungry Tailor", storageid = Storage.Quest.RookgaardTutorialIsland.CarlosQuestLog, startvalue = 1, endvalue = 8,
					states = {
		...
		[20] = {
			name = "The Djinn War - Efreet Faction", startstorageid = Storage.Quest.DjinnWar.EfreetFaction.Start, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Efreet Mission 1: The Supply Thief", storageid = Storage.Quest.DjinnWar.EfreetFaction.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Efreet Mission 2: The Tear of Daraman", storageid = Storage.Quest.DjinnWar.EfreetFaction.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Efreet Mission 3: The Sleeping Lamp", storageid = Storage.Quest.DjinnWar.EfreetFaction.Mission02, startvalue = 1, endvalue = 3,
					states = {
		...
		[21] = {
			name = "The Djinn War - Marid Faction", startstorageid = Storage.Quest.DjinnWar.MaridFaction.Start, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Marid Mission 1: The Dwarven Kitchen", storageid = Storage.Quest.DjinnWar.MaridFaction.Mission01, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Marid Mission 2: The Spyreport", storageid = Storage.Quest.DjinnWar.MaridFaction.Mission02, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "Rata'Mari and the Cheese", storageid = Storage.Quest.DjinnWar.MaridFaction.RataMari, startvalue = 1, endvalue = 2,
					states = {
				...
				[4] = {
					name = "Marid Mission 3: The Sleeping Lamp", storageid = Storage.Quest.DjinnWar.MaridFaction.Mission03, startvalue = 1, endvalue = 3,
					states = {
		...
		[22] = {
			name = "The Hidden City of Beregar", startstorageid = Storage.Quest.hiddenCityOfBeregar.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Going Down", storageid = Storage.Quest.hiddenCityOfBeregar.GoingDown, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Justice for All", storageid = Storage.Quest.hiddenCityOfBeregar.JusticeForAll, startvalue = 1, endvalue = 6,
					states = {
				...
				[3] = {
					name = "Pythius the Rotten", storageid = Storage.Quest.FirewalkerBoots, startvalue = 1, endvalue = 1,
					states = {
				...
				[4] = {
					name = "Sweet as Chocolate Cake", storageid = Storage.Quest.hiddenCityOfBeregar.SweetAsChocolateCake, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "The Good Guard", storageid = Storage.Quest.hiddenCityOfBeregar.TheGoodGuard, startvalue = 1, endvalue = 2,
					states = {
		...
		[23] = {
			name = "The Ice Islands Quest", startstorageid = Storage.Quest.TheIceIslands.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Befriending the Musher", storageid = Storage.Quest.TheIceIslands.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Nibelor 1: Breaking the Ice", storageid = Storage.Quest.TheIceIslands.Mission02, startvalue = 1, endvalue = 5,
					states = {
				...
				[3] = {
					name = "Nibelor 2: Ecological Terrorism", storageid = Storage.Quest.TheIceIslands.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Nibelor 3: Artful Sabotage", storageid = Storage.Quest.TheIceIslands.Mission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "Nibelor 4: Berserk Brewery", storageid = Storage.Quest.TheIceIslands.Mission05, startvalue = 1, endvalue = 6,
					states = {
				...
				[6] = {
					name = "Nibelor 5: Cure the Dogs", storageid = Storage.Quest.TheIceIslands.Mission06, startvalue = 1, endvalue = 8,
					states = {
				...
				[7] = {
					name = "The Secret of Helheim", storageid = Storage.Quest.TheIceIslands.Mission07, startvalue = 1, endvalue = 3,
					states = {
				...
				[8] = {
					name = "The Contact", storageid = Storage.Quest.TheIceIslands.Mission08, startvalue = 1, endvalue = 4,
					states = {
				...
				[9] = {
					name = "Formorgar Mines 1: The Mission", storageid = Storage.Quest.TheIceIslands.Mission09, startvalue = 1, endvalue = 2,
					states = {
				...
				[10] = {
					name = "Formorgar Mines 2: Ghostwhisperer", storageid = Storage.Quest.TheIceIslands.Mission10, startvalue = 1, endvalue = 2,
					states = {
				...
				[11] = {
					name = "Formorgar Mines 3: The Secret", storageid = Storage.Quest.TheIceIslands.Mission11, startvalue = 1, endvalue = 2,
					states = {
				...
				[12] = {
					name = "Formorgar Mines 4: Retaliation", storageid = Storage.Quest.TheIceIslands.Mission12, startvalue = 1, endvalue = 6,
					states = {
		...
		[24] = {
			name = "The Inquisition", startstorageid = Storage.Quest.TheInquisition.Questline, startstoragevalue = 2,
			missions = {
				[1] = {
					name = "Mission 1: Interrogation", storageid = Storage.Quest.TheInquisition.Mission01, startvalue = 1, endvalue = 7,
					states = {
				...
				[2] = {
					name = "Mission 2: Eclipse", storageid = Storage.Quest.TheInquisition.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 3: Vampire Hunt", storageid = Storage.Quest.TheInquisition.Mission03, startvalue = 1, endvalue = 6,
					states = {
				...
				[4] = {
					name = "Mission 4: The Haunted Ruin", storageid = Storage.Quest.TheInquisition.Mission04, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "Mission 5: Essential Gathering", storageid = Storage.Quest.TheInquisition.Mission05, startvalue = 1, endvalue = 3,
					states = {
				...
				[6] = {
					name = "Mission 6: The Demon Ungreez", storageid = Storage.Quest.TheInquisition.Mission06, startvalue = 1, endvalue = 3,
					states = {
				...
				[7] = {
					name = "Mission 7: The Shadow Nexus", storageid = Storage.Quest.TheInquisition.Mission07, startvalue = 1, endvalue = 5,
					states = {
		...
		[25] = {
			name = "The New Frontier", startstorageid = Storage.Quest.TheNewFrontier.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 01: New Land", storageid = Storage.Quest.TheNewFrontier.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Mission 02: From Kazordoon With Love", storageid = Storage.Quest.TheNewFrontier.Mission02, startvalue = 1, endvalue = 6,
					states = {
				...
				[3] = {
					name = "Mission 03: Strangers in the Night", storageid = Storage.Quest.TheNewFrontier.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 04: The Mine Is Mine", storageid = Storage.Quest.TheNewFrontier.Mission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "Mission 05: Getting Things Busy", storageid = Storage.Quest.TheNewFrontier.Mission05, startvalue = 1, endvalue = 7,
					states = {
				...
				[6] = {
					name = "Mission 06: Days Of Doom", storageid = Storage.Quest.TheNewFrontier.Mission06, startvalue = 1, endvalue = 3,
					states = {
				...
				[7] = {
					name = "Mission 07: Messengers Of Peace", storageid = Storage.Quest.TheNewFrontier.Mission07, startvalue = 1, endvalue = 3,
					states = {
				...
				[8] = {
					name = "Mission 08: An Offer You Can't Refuse", storageid = Storage.Quest.TheNewFrontier.Mission08, startvalue = 1, endvalue = 2,
					states = {
				...
				[9] = {
					name = "Mission 09: Mortal Combat", storageid = Storage.Quest.TheNewFrontier.Mission09, startvalue = 1, endvalue = 3,
					states = {
				...
				[10] = {
					name = "Mission 10: New Horizons", storageid = Storage.Quest.TheNewFrontier.Mission10, startvalue = 1, endvalue = 1, description = "You now have permission to use the Magic Carpet on the mountain above Farmine, Cael now accepts more Tomes of Knowledge from you and you got the Warmaster Outfit!",
				},

				[11] = {
					name = "Tome of Knowledge Counter", storageid = Storage.Quest.TheNewFrontier.TomeofKnowledge, startvalue = 1, endvalue = 12,
					states = {
		...
		[26] = {
			name = "The Postman Missions", startstorageid = Storage.Quest.postman.Mission01, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 01 - Check Postal Routes", storageid = Storage.Quest.postman.Mission01, startvalue = 1, endvalue = 6,
					states = {
				...
				[2] = {
					name = "Mission 02 - Fix Mailbox", storageid = Storage.Quest.postman.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 03 - Bill Delivery", storageid = Storage.Quest.postman.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 04 - Aggressive Dogs", storageid = Storage.Quest.postman.Mission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "Mission 05 - Present Delivery", storageid = Storage.Quest.postman.Mission05, startvalue = 1, endvalue = 4,
					states = {
				...
				[6] = {
					name = "Mission 06 - New Uniforms", storageid = Storage.Quest.postman.Mission06, startvalue = 1, endvalue = 13,
					states = {
				...
				[7] = {
					name = "Mission 07 - Measurements", storageid = Storage.Quest.postman.Mission07, startvalue = 1, endvalue = 8,
					states = {
				...
				[8] = {
					name = "Mission 08 - Missing Courier", storageid = Storage.Quest.postman.Mission08, startvalue = 1, endvalue = 3,
					states = {
				...
				[9] = {
					name = "Mission 09 - Dear Santa", storageid = Storage.Quest.postman.Mission09, startvalue = 1, endvalue = 4,
					states = {
				...
				[10] = {
					name = "Mission 10 - Mintwallin", storageid = Storage.Quest.postman.Mission10, startvalue = 1, endvalue = 3,
					states = {
				...
				[11] = {
					name = "Postman Rank", storageid = Storage.Quest.postman.Rank, startvalue = 1, endvalue = 5,
					states = {
						[1] = "Assistant Postman",
						[2] = "Postman",
						[3] = "Grand Postman",
		...
		[27] = {
			name = "The Shattered Isles", startstorageid = Storage.Quest.TheShatteredIsles.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "A Djinn in Love", storageid = Storage.Quest.TheShatteredIsles.ADjinnInLove, startvalue = 1, endvalue = 5,
					states = {
				...
				[2] = {
					name = "A Poem for the Mermaid", storageid = Storage.Quest.TheShatteredIsles.APoemForTheMermaid, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Access to Goroma", storageid = Storage.Quest.TheShatteredIsles.AccessToGoroma, startvalue = 1, endvalue = 1, description = "After helping Jack Fate to collect the 30 woodpieces, Jack Fate in Liberty Bay will bring you to Goroma.",
				},

				[4] = {
					name = "Access to Laguna Island", storageid = Storage.Quest.TheShatteredIsles.AccessToLagunaIsland, startvalue = 1, endvalue = 1, description = "After arranging a date for Marina and Ocelus, you are allowed to use Marina's sea turtles. They will bring you to the idyllic Laguna Islands.",
				},

				[5] = {
					name = "Access to Meriana", storageid = Storage.Quest.TheShatteredIsles.AccessToMeriana, startvalue = 1, endvalue = 1, description = "After earning the trust of the governor's daughter Eleonore, Captain Waverider in Liberty Bay will bring you to Meriana if you tell him the secret codeword 'peg leg'.",
				},

				[6] = {
					name = "The Counterspell", storageid = Storage.Quest.TheShatteredIsles.TheCounterspell, startvalue = 1, endvalue = 4,
					states = {
				...
				[7] = {
					name = "The Errand", storageid = Storage.Quest.TheShatteredIsles.TheErrand, startvalue = 1, endvalue = 2,
					states = {
				...
				[8] = {
					name = "The Governor's Daughter", storageid = Storage.Quest.TheShatteredIsles.TheGovernorDaughter, startvalue = 1, endvalue = 3,
					states = {
		...
		[28] = {
			name = "The Thieves Guild", startstorageid = Storage.Quest.thievesGuild.Quest, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 1: Ivory Poaching", storageid = Storage.Quest.thievesGuild.Mission01, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Mission 2: Burglary", storageid = Storage.Quest.thievesGuild.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 3: Invitation", storageid = Storage.Quest.thievesGuild.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 4: Bridge Robbery", storageid = Storage.Quest.thievesGuild.Mission04, startvalue = 1, endvalue = 8,
					states = {
				...
				[5] = {
					name = "Mission 5: Enforcing Debts", storageid = Storage.Quest.thievesGuild.Mission05, startvalue = 1, endvalue = 2,
					states = {
				...
				[6] = {
					name = "Mission 6: Fishnapping", storageid = Storage.Quest.thievesGuild.Mission06, startvalue = 1, endvalue = 4,
					states = {
				...
				[7] = {
					name = "Mission 7: Blackmail", storageid = Storage.Quest.thievesGuild.Mission07, startvalue = 1, endvalue = 2,
					states = {
				...
				[8] = {
					name = "Mission 8: Message", storageid = Storage.Quest.thievesGuild.Mission08, startvalue = 1, endvalue = 3,
					states = {
		...
		[29] = {
			name = "The Travelling Trader Quest", startstorageid = Storage.Quest.TravellingTrader.Mission01, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 1: Trophy", storageid = Storage.Quest.TravellingTrader.Mission01, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Mission 2: Delivery", storageid = Storage.Quest.TravellingTrader.Mission02, startvalue = 1, endvalue = 5,
					states = {
				...
				[3] = {
					name = "Mission 3: Cheese", storageid = Storage.Quest.TravellingTrader.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 4: Vase", storageid = Storage.Quest.TravellingTrader.Mission04, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "Mission 5: Make a deal", storageid = Storage.Quest.TravellingTrader.Mission05, startvalue = 1, endvalue = 3,
					states = {
				...
				[6] = {
					name = "Mission 6: Goldfish", storageid = Storage.Quest.TravellingTrader.Mission06, startvalue = 1, endvalue = 2,
					states = {
				...
				[7] = {
					name = "Mission 7: Declare", storageid = Storage.Quest.TravellingTrader.Mission07, startvalue = 1, endvalue = 1,
					states = {
		...
		[30] = {
			name = "The Queen of the Banshees", startstorageid = Storage.Quest.QueenOfBansheesQuest.FirstSeal, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Hidden Seal", storageid = Storage.Quest.QueenOfBansheesQuest.FirstSeal, startvalue = 1, endvalue = 1, description = "You broke the first seal.",
				},

				[2] = {
					name = "The Seal of Logic", storageid = Storage.Quest.QueenOfBansheesQuest.SixthSeal, startvalue = 1, endvalue = 1, description = "You broke the sixth seal.",
				},

				[3] = {
					name = "The Seal of True Path", storageid = Storage.Quest.QueenOfBansheesQuest.FifthSeal, startvalue = 1, endvalue = 1, description = "You broke the fifth seal.",
				},

				[4] = {
					name = "The Seal of Sacrifice", storageid = Storage.Quest.QueenOfBansheesQuest.FourthSeal, startvalue = 1, endvalue = 1, description = "You broke the fourth seal.",
				},

				[5] = {
					name = "The Seal of Demonrage", storageid = Storage.Quest.QueenOfBansheesQuest.ThirdSeal, startvalue = 1, endvalue = 1, description = "You broke the third seal.",
				},

				[6] = {
					name = "The Plague Seal", storageid = Storage.Quest.QueenOfBansheesQuest.SecondSeal, startvalue = 1, endvalue = 1, description = "You broke the second seal.",
				},

				[7] = {
					name = "All Seals", storageid = Storage.Quest.QueenOfBansheesQuest.LastSeal, startvalue = 1, endvalue = 1, description = "You broke all the seals.",
				},
		...
		[31] = {
			name = "The Ultimate Challenges", startstorageid = Storage.Quest.Quest.SvargrondArena.QuestLogGreenhorn, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Barbarian Arena - Greenhorn Mode", storageid = Storage.Quest.Quest.SvargrondArena.QuestLogGreenhorn, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "Barbarian Arena - Scrapper Mode", storageid = Storage.Quest.Quest.SvargrondArena.QuestLogScrapper, startvalue = 1, endvalue = 2,
					states = {
						[1] = "You have to defeat all enemies in this mode.",
						[2] = "You have defeated all enemies in this mode.",
					},
				...
				[3] = {
					name = "Barbarian Arena - Warlord Mode", storageid = Storage.Quest.Quest.SvargrondArena.QuestLogWarlord, startvalue = 1, endvalue = 2,
					states = {
						[1] = "You have to defeat all enemies in this mode.",
						[2] = "You have defeated all enemies in this mode.",
					},
		...
		[32] = {
			name = "The White Raven Monastery", startstorageid = Storage.Quest.WhiteRavenMonasteryQuest.QuestLog, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Access to the Isle of Kings", storageid = Storage.Quest.WhiteRavenMonasteryQuest.Passage, endvalue = 1,
					states = {
				...
				[2] = {
					name = "The Investigation", storageid = Storage.Quest.WhiteRavenMonasteryQuest.Diary, startvalue = 1, endvalue = 2,
					states = {
		...
		[33] = {
			name = "Tibia Tales", startstorageid = Storage.Quest.TibiaTales.DefaultStart, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "To Appease the Mighty", storageid = Storage.Quest.TibiaTales.ToAppeaseTheMightyQuest, stargtvalue = 0, endvalue = 4,
					states = {
				...
				[2] = {
					name = "Arito's Task", storageid = Storage.Quest.TibiaTales.AritosTask, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Against the Spider Cult", storageid = Storage.Quest.TibiaTales.AgainstTheSpiderCult, startvalue = 1, endvalue = 6,
					states = {
				...
				[4] = {
					name = "An Interest In Botany", storageid = Storage.Quest.TibiaTales.AnInterestInBotany, startvalue = 1, endvalue = 4,
					states = {
				...
				[5] = {
					name = "Graves Sanctified - In Progress", storageid = Storage.Quest.TibiaTales.RestInHallowedGround.HolyWater, startvalue = 1, endvalue = 15, description = function(player)return string.format("You sanctified %d of 15 graves.", (math.max(player:getStorageValue(Storage.Quest.TibiaTales.RestInHallowedGround.HolyWater), 0))) end,
				},

				[6] = {
					name = "Into the Bone Pit", storageid = Storage.Quest.TibiaTales.IntoTheBonePit, startvalue = 1, endvalue = 3,
					states = {
				...
				[7] = {
					name = "Rest in Hallowed Ground", storageid = Storage.Quest.TibiaTales.RestInHallowedGround.Questline, startvalue = 1, endvalue = 5,
					states = {
				...
				[8] = {
					name = "The Exterminator", storageid = Storage.Quest.TibiaTales.TheExterminator, startvalue = 1, endvalue = 3,
					states = {
				...
				[9] = {
					name = "The Ultimate Booze", storageid = Storage.Quest.TibiaTales.ultimateBoozeQuest, startvalue = 1, endvalue = 3,
					states = {
		...
		[34] = {
			name = "Unnatural Selection", startstorageid = Storage.Quest.UnnaturalSelection.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 1: Skulled", storageid = Storage.Quest.UnnaturalSelection.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Mission 2: All Around the World", storageid = Storage.Quest.UnnaturalSelection.Mission02, startvalue = 1, endvalue = 13,
					states = {
				...
				[3] = {
					name = "Mission 3: Dance Dance Evolution", storageid = Storage.Quest.UnnaturalSelection.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 4: Bits and Pieces", storageid = Storage.Quest.UnnaturalSelection.Mission04, startvalue = 1, endvalue = 2,
					states = {
				...
				[5] = {
					name = "Mission 5: Ray of Light", storageid = Storage.Quest.UnnaturalSelection.Mission05, startvalue = 1, endvalue = 3,
					states = {
				...
				[6] = {
					name = "Mission 6: Firewater Burn", storageid = Storage.Quest.UnnaturalSelection.Mission06, startvalue = 1, endvalue = 3,
					states = {
		...
		[35] = {
			name = "What a foolish Quest", startstorageid = Storage.Quest.WhatAFoolishQuest.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "What a foolish Quest - Tasks of a Fool", storageid = Storage.Quest.WhatAFoolishQuest.Mission1, startvalue = 1, endvalue = 2,
					states = {
				...
				[2] = {
					name = "What a foolish Quest - That stinks!", storageid = Storage.Quest.WhatAFoolishQuest.Mission2, startvalue = 1, endvalue = 2,
					states = {
				...
				[3] = {
					name = "What a foolish Quest - A Piece of Cake", storageid = Storage.Quest.WhatAFoolishQuest.Mission3, startvalue = 1, endvalue = 2,
					states = {
				...
				[4] = {
					name = "What a foolish Quest - Fool Spirits", storageid = Storage.Quest.WhatAFoolishQuest.Mission4, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "What a foolish Quest - Watch out for the foolish", storageid = Storage.Quest.WhatAFoolishQuest.Mission5, startvalue = 1, endvalue = 3,
					states = {
				...
				[6] = {
					name = "What a foolish Quest - The queen of farts", storageid = Storage.Quest.WhatAFoolishQuest.Mission6, startvalue = 1, endvalue = 5,
					states = {
				...
				[7] = {
					name = "What a foolish Quest - For your mice only", storageid = Storage.Quest.WhatAFoolishQuest.Mission7, startvalue = 1, endvalue = 2,
					states = {
				...
				[8] = {
					name = "What a foolish Quest - Smoking is a foolish thing", storageid = Storage.Quest.WhatAFoolishQuest.Mission8, startvalue = 1, endvalue = 5,
					states = {
				...
				[9] = {
					name = "What a foolish Quest - A fool's bargain", storageid = Storage.Quest.WhatAFoolishQuest.Mission9, startvalue = 1, endvalue = 5,
					states = {
				...
				[10] = {
					name = "What a foolish Quest - A sweet surprise", storageid = Storage.Quest.WhatAFoolishQuest.Mission10, startvalue = 1, endvalue = 2,
					states = {
				...
				[11] = {
					name = "What a foolish Quest - The final foolishness", storageid = Storage.Quest.WhatAFoolishQuest.Mission11, startvalue = 1, endvalue = 4,
					states = {
				...
				[12] = {
					name = "What a foolish Quest - To become a complete fool", storageid = Storage.Quest.WhatAFoolishQuest.JesterOutfit, startvalue = 4, endvalue = 4,
					states = {
		...
		[36] = {
			name = "Wrath of the Emperor", startstorageid = Storage.Quest.WrathoftheEmperor.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 01: Catering the Lions Den", storageid = Storage.Quest.WrathoftheEmperor.Mission01, startvalue = 1, endvalue = 3,
					states = {
				...
				[2] = {
					name = "Mission 02: First Contact", storageid = Storage.Quest.WrathoftheEmperor.Mission02, startvalue = 1, endvalue = 3,
					states = {
				...
				[3] = {
					name = "Mission 03: The Keeper", storageid = Storage.Quest.WrathoftheEmperor.Mission03, startvalue = 1, endvalue = 3,
					states = {
				...
				[4] = {
					name = "Mission 04: Sacrament of the Snake", storageid = Storage.Quest.WrathoftheEmperor.Mission04, startvalue = 1, endvalue = 3,
					states = {
				...
				[5] = {
					name = "Mission 05: New in Town", storageid = Storage.Quest.WrathoftheEmperor.Mission05, startvalue = 1, endvalue = 3,
					states = {
				...
				[6] = {
					name = "Mission 06: The Office Job", storageid = Storage.Quest.WrathoftheEmperor.Mission06, startvalue = 0, endvalue = 4, description = function(player)return string.format("Explore the area where Zlak is to find Lizard Magistratus and kill 4 of them. You currently have %d killed. Report back to Zlak if you finished it.", (math.max(player:getStorageValue(Storage.Quest.WrathoftheEmperor.Mission06), 0))) end,
				},

				[7] = {
					name = "Mission 07: A Noble Cause", storageid = Storage.Quest.WrathoftheEmperor.Mission07, startvalue = 0, endvalue = 6, description = function(player)return string.format("Explore the area where Zlak is to find Lizard Noble and kill 6 of them. You currently have %d killed. Report back to Zlak if you finished it.", (math.max(player:getStorageValue(Storage.Quest.WrathoftheEmperor.Mission07), 0))) end,
				},

				[8] = {
					name = "Mission 08: Uninvited Guests", storageid = Storage.Quest.WrathoftheEmperor.Mission08, startvalue = 1, endvalue = 2,
					states = {
				...
				[9] = {
					name = "Mission 09: The Sleeping Dragon", storageid = Storage.Quest.WrathoftheEmperor.Mission09, startvalue = 1, endvalue = 2,
					states = {
				...
				[10] = {
					name = "Mission 10: A Message of Freedom", storageid = Storage.Quest.WrathoftheEmperor.Mission10, startvalue = 1, endvalue = 6,
					states = {
				...
				[11] = {
					name = "Mission 11: Payback Time", storageid = Storage.Quest.WrathoftheEmperor.Mission11, startvalue = 1, endvalue = 2,
					states = {
				...
				[12] = {
					name = "Mission 12: Just Rewards", storageid = Storage.Quest.WrathoftheEmperor.Mission12, startvalue = 0, endvalue = 1,
					states = {
		...
		[37] = {
			name = "Oramond", startstorageid = Storage.Quest.Oramond.QuestLine, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "To Take Roots", storageid = Storage.Quest.Oramond.MissionToTakeRoots, startvalue = 1, endvalue = 3000, description = "Five Juicy roots from the outskirts of Rathleton may already help feed the poor. Try to find a city official to deliver them to or go to the Rathleton poor house.",
				},
			},
		},
		[38] = {
			name = "Forgotten Knowledge", startstorageid = Storage.Quest.Quest.ForgottenKnowledge.Tomes, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Circle of the Black Sphinx", storageid = Storage.Quest.Quest.ForgottenKnowledge.LadyTenebrisKilled, startvalue = 0, endvalue = 1522018605,
					states = {
						[1] = "You defeated the rogue Lady Tenebris.",
					},
				},
				[2] = {
					name = "Bane of the Cosmic Force", storageid = Storage.Quest.Quest.ForgottenKnowledge.LloydKilled, startvalue = 0, endvalue = 1522018605,
					states = {
				...
				[3] = {
					name = "The Desecrated Glade", storageid = Storage.Quest.Quest.ForgottenKnowledge.ThornKnightKilled, startvalue = 0, endvalue = 1522018605,
					states = {
				...
				[4] = {
					name = "The Unwary Mage", storageid = Storage.Quest.Quest.ForgottenKnowledge.DragonkingKilled, startvalue = 0, endvalue = 1522018605,
					states = {
				...
				[5] = {
					name = "Dragon in Distress", storageid = Storage.Quest.Quest.ForgottenKnowledge.HorrorKilled, startvalue = 0, endvalue = 1522018605,
					states = {
						[1] = "You saved the Dragon Mother's egg and she melted the ice wall that blocked your way.",
					},
				},
				[6] = {
					name = "Time is a Window", storageid = Storage.Quest.Quest.ForgottenKnowledge.TimeGuardianKilled, startvalue = 0, endvalue = 1522018605,
					states = {
				...
				[7] = {
					name = "Final Fight", storageid = Storage.Quest.Quest.ForgottenKnowledge.LastLoreKilled, startvalue = 0, endvalue = 1522018605,
					states = {
						[1] = "Description Fault.",
					},
				},
		...
		[39] = {
			name = "The First Dragon", startstorageid = Storage.Quest.FirstDragon.Start, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Power", storageid = Storage.Quest.FirstDragon.DragonCounter, startvalue = 0, endvalue = 200, description = function(player)return string.format("You already hunted %d/200 dragons.")(math.max(player:getStorageValue(Storage.Quest.FirstDragon.DragonCounter))) end,
				},
				[2] = {
					name = "Treasure", storageid = Storage.Quest.FirstDragon.ChestCounter, startvalue = 1, endvalue = 15, description = "Treasure is the favorite of the dragon lords. Find and take Kalyassa's treasures spread accross the world."
				},
				[3] = {
					name = "Knowledge", storageid = Storage.Quest.FirstDragon.GelidrazahAccess, startvalue = 1, endvalue = 1, description = "You learned that frost dragon's incitement is the thirst for knowledge, perhaps if you bring some to Gelidrazah's you'll meet him."
				},
				[4] = {
					name = "Life", storageid = Storage.Quest.FirstDragon.SecretsCounter, startvalue = 1, endvalue = 3, description = "Undead dragons aspires for life. No better way to see life as it grows around the world, is there?"
				},
			},
		},

		[40] = {
			name = "Cults of Tibia", startstorageid = Storage.Quest.CultsOfTibia.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Strengthtening of the Minotaurs", storageid = Storage.Quest.CultsOfTibia.Minotaurs.jamesfrancisTask, startvalue = 0, endvalue = 50, description = function(player)
                    return ("James asked you to enter the cave for hunting 50 empowered minotaurs. Then he will be able to continue his research.\nMinotaurs killed: %d/50"):format(player:getStorageValue(Storage.Quest.CultsOfTibia.Minotaurs.jamesfrancisTask))
                end,
				},

				[2] = {
					name = "The Strengthtening of the Minotaurs", storageid = Storage.Quest.CultsOfTibia.Minotaurs.Mission, startvalue = 1, endvalue = 5,
					states = {
				...
				[3] = {
					name = "Patron of Arts", storageid = Storage.Quest.CultsOfTibia.MotA.Mission, startvalue = 1, endvalue = 15,
					states = {
				...
				[4] = {
					name = "Barkless", storageid = Storage.Quest.CultsOfTibia.Barkless.Mission, startvalue = 1, endvalue = 7,
					states = {
						...
						[3] = function(player)return("You survived the Trial. Barkless now have the right to see the cult leader but a powerful relic is sealing the path.\nBarkless markings broken to reverse the power of the cult object: %d of 10"):format(math.max(player:getStorageValue(Storage.Quest.CultsOfTibia.Barkless.Objects), 0))
                end,
				...
				[5] = {
					name = "Misguided", storageid = Storage.Quest.CultsOfTibia.Misguided.Mission, startvalue = 1, endvalue = 5,
					states = {
						[1] = "ASD",
				...
				[6] = {
					name = "The Orc Idol", storageid = Storage.Quest.CultsOfTibia.Orcs.Mission, startvalue = 1, endvalue = 3,
					states = {
						[1] = "ASD",
						[2] = "ASD",
				...
				[7] = {
					name = "The Secret of the Sandy Cave", storageid = Storage.Quest.CultsOfTibia.Life.Mission, startvalue = 1, endvalue = 10,
					states = {
						[1] = "ASD",
						[2] = "ASD",
				...
				[8] = {
					name = "Zathroth Remmants", storageid = Storage.Quest.CultsOfTibia.Humans.Mission, startvalue = 1, endvalue = 3,
					states = {
						[1] = function(player)
		...
		[41] = {
			name = "Dangerous Depths", startstorageid = Storage.Quest.DangerousDepths.Questline, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Dwarves: Home Improvement", storageid = Storage.Quest.DangerousDepths.Dwarves.Home, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("Destroy makeshift homes of the Lost to force them to fight you! Try making some prisoners in the progress and report back to Klom Stonecutter.\n\nLost Exiles: %d/20\nPrisoners (bonus): %d/3"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Dwarves.LostExiles), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Dwarves.Prisoners), 0))
						end,
						[2] = "You drove off the Lost but more are sure to come. Check back with Klom Stonecutter at a later time.",
					},
				},
				[2] = {
					name = "Dwarves: Subterranean Life", storageid = Storage.Quest.DangerousDepths.Dwarves.Subterranean, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("Klome Stonecutter sent you on a grave mission to exterminate large populaces of subterranian life. Looks like the dwarves make short work of the deep intruders.\n\nSubterranean organisms: %d/50"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Dwarves.Organisms), 0))
						end,
				...
				[3] = {
					name = "Gnomes: Gnomal Warming Measurements", storageid = Storage.Quest.DangerousDepths.Gnomes.Measurements, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("Gnomus sent you on a mission to measure the rising heat from below.\n\nLocation A: %d/1\nLocation B: %d/1\nLocation C: %d/1\nLocation D: %d/1\nLocation E: %d/1"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.locationA), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.locationB), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.locationC), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.locationD), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.locationE), 0))
						end,
				...
				[4] = {
					name = "Gnomes: Ordnance", storageid = Storage.Quest.DangerousDepths.Gnomes.Ordnance, startvalue = 1, endvalue = 3,
					states = {
						...
						[2] = function(player)return string.format("You found the old gnome trail where ordnance for the gnome outpost arrive, escort them and their pack animals to safety and return to Gnomus.\n\nRescued gnomes: %d/5\nRescued animals: %d/3"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.GnomesCount), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.CrawlersCount), 0))
						end,
				...
				[5] = {
					name = "Gnomes: Uncharted Territory", storageid = Storage.Quest.DangerousDepths.Gnomes.Charting, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("Chart the area around the deep base for Gnomus. Look for especific landmarks:\n\nOld Gate: %d/1\nThe Gaze: %d/1\nLost Ruin: %d/1\nOutpost: %d/1\nBastion: %d/1\nBroken Tower: %d/1"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.OldGate), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.TheGaze), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.LostRuin), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.Outpost), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.Bastion), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Gnomes.BrokenTower), 0))
						end,
				...
				[6] = {
					name = "Scouts: Explosive Growth", storageid = Storage.Quest.DangerousDepths.Scouts.Growth, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("You found the mine shaft. Burn all the growth and report back to Lardoc Bashsmite!\n\nFirst Room: %d/1\nSecond room: %d/1\nThird room: %d/1\nFourth room: %d/1\nFifth room: %d/1"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.firstBarrel), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.secondBarrel), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.thirdBarrel), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.fourthBarrel), 0), math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.fifthBarrel), 0))
						end,
						[2] = "You helped Lardoc Bashsmite fighting back the verminous growth in the northern mineshaft. Return to him later to see if he has more work for you.",
					},
				},
				[7] = {
					name = "Scouts: Pesticide", storageid = Storage.Quest.DangerousDepths.Scouts.Diremaw, startvalue = 1, endvalue = 2,
					states = {
						[1] = function(player)return string.format("Lardoc asked you to follow a plan of the gnomes to stop the deep threat by trying to neutralise diremaw spawn with pesticies. Diremaws lay eggs inside corpses of their skin.\n\nNeutralised: %d/20"):format(math.max(player:getStorageValue(Storage.Quest.DangerousDepths.Scouts.DiremawsCount), 0))
						end,
		...
		[42] = {
			name = "Threatened Dreams", startstorageid = Storage.Quest.ThreatenedDreams.Start, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "Mission 01: Troubled Animals", storageid = Storage.Quest.ThreatenedDreams.TroubledMission01, startvalue = 1, endvalue = 4,
					states = {
						[1] = "STATE 1",
						[2] = "STATE 2",
						[3] = "STATE 3",
		...
		[43] = {
			name = "Adventurers Guild", startstorageid = Storage.Quest.AdventurersGuild.GreatDragonHunt.WarriorSkeleton, startstoragevalue = 1,
			missions = {
				[1] = {
					name = "The Great Dragon Hunt", storageid = Storage.Quest.AdventurersGuild.GreatDragonHunt.WarriorSkeleton, startvalue = 0, endvalue = 2, description = function(player)
						return ("You are exploring the Kha'zeel Dragon Lairs. Others obviously found a terrible end here. But the dragon hoards might justify the risks. You killed %d/50 dragons and dragon lords."):format(math.max(player:getStorageValue(Storage.Quest.AdventurersGuild.GreatDragonHunt.DragonCounter), 0))
					end,
				},
			},
		},

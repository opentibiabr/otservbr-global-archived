		...
		[33] = {
			...
			missions = {
				...
				[10] = {
					...
					endvalue = 11,
					states = {
						[1] = "Spectulus told you about a failed experiment he once did, involving an intern named Jack, and asked you to help him rescue Jack. Go to Jack's house and talk to him about Spectulus.",
						...
						[4] = "You have talked to Jack about the furniture you placed in his house. Report it back to Spectulus in the Edron Academy.",
						...
						[7] = "Spectulus suggested asking Jack abouthis hobbies. Make Jack leave his hobby be by whateber means it takes. Only by doing this he will be separated from what distracts him from his former self.",
						[8] = "You found out and destroyed Jack's hobby. Jack is now finally ready and beginning to change. He event seems to start remembering Spectulus and the Academy.",

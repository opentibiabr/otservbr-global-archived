local function startWaves()
	...
	elseif Game.getStorageValue(GlobalStorage.HeroRathleton.GloothWave) == 8 then
		for i = 1, 4 do
			...
			if chance == 1 then
				Game.createMonster('glooth trasher', Position(math.random(33704, 33718), math.random(32040, 32053), 15), true, true)
			elseif chance == 2 then
				Game.createMonster('glooth slasher', Position(math.random(33704, 33718), math.random(32040, 32053), 15), true, true)
			else
				Game.createMonster('glooth golem', Position(math.random(33704, 33718), math.random(32040, 32053), 15), true, true)
			end
		end

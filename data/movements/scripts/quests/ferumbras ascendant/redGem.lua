...
function onStepIn(creature, item, position, fromPosition)
	...
	if item.itemid == 9562 then
		...
		local leverFour = Tile(Position(33671, 32688, 13)):getItemById(10029) or Tile(Position(33671, 32688, 13)):getItemById(10030) -- lever green
		...
		Game.setStorageValue(GlobalStorage.FerumbrasAscendantQuest.Elements.Four, 4) -- é blood

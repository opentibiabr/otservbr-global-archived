...
function onStepIn(creature, item, position, fromPosition)
	...
	if item.itemid == 9563 then
		...
		local leverFour = Tile(Position(33672, 32688, 13)):getItemById(10029) or Tile(Position(33672, 32688, 13)):getItemById(10030) -- lever green
		...
		Game.setStorageValue(GlobalStorage.FerumbrasAscendantQuest.Elements.Four, 5) -- é grass

local config = {
	...
	[6] = {text = 'Considering that higher places around here aren\'t that easy to reach, you think the view from here is tolerably good.', position = Position(32589, 32801, 4)},

function onStepIn(creature, item, position, fromPosition)
	...
	Game.setStorageValue(GlobalStorage.FerumbrasAscendantQuest.FerumbrasEssence,
	Game.getStorageValue(GlobalStorage.FerumbrasAscendantQuest.FerumbrasEssence) + 1)

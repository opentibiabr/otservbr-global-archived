local positions = {
	...
	[13516] = Position(32111, 31372, 14), -- pra recompensa
	[13517] = Position(32102, 31400, 13), -- fora da recompensa
	[13518] = Position(32114, 31353, 13),  -- pro começo
	[13519] = Position(32090, 31320, 13), -- do msg pra recompensa
	[13520] = Position(32272, 31382, 14), -- primeiro boss pra segunda alavanca
	[13521] = Position(32113, 31353, 13), -- saindo dos bosses
	[13522] = Position(32337, 31289, 14), -- segundo boss pra terceira alavanca
	[13523] = Position(32306, 31250, 14), -- terceiro boss pra quarta alavanca
	[13524] = Position(32203, 31284, 14), -- quarto boss pra ultima alavanca do ultimo boss
	[13525] = Position(32216, 31378, 14), -- saida do World Devourer pra recompensa
	[13526] = Position(32162, 31295, 7), -- svarground saida
	[13527] = Position(32112, 31390, 11), -- svarground entrada
	[13528] = Position(33185, 31643, 8), -- lá dentro da quest e vai pra edron
	[13529] = Position(32113, 31358, 13), -- de edron lá pra dentro COORDENADA CERTA
	[13531] = Position(32113, 31358, 13), -- de farmine lá pra dentro COORDENADA CERTA	-- oramond sea
}

...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 1 then

	if player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 1 then
	...
	elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 1 then
		if player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 1 then
			
			player:addItem(36551, 1) -- Tefrit List
			npcHandler:say({"Aqui esta a lista com os ingredientes que faltam para completar o ritual."}, cid)
			player:setStorageValue(Storage.KilmareshQuest.Oito.Tefrit, 2)
...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 2 then

	if player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 2 then
	...
	elseif msgcontains(msg, "yes") and playerTopic[cid] == 3 and player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 2 then
		if player:getStorageValue(Storage.KilmareshQuest.Oito.Tefrit) == 2 and player:getItemById(36164, 20) and player:getItemById(36174, 25) and player:getItemById(36165, 15) then
			...
			player:setStorageValue(Storage.KilmareshQuest.Oito.Tefrit, 3)

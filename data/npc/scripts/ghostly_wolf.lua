...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, "mission") then
        ...
        elseif (player:getStorageValue(Storage.ThreatenedDreams.TroubledMission01) == 10) then -- Verificar
            player:setStorageValue(Storage.ThreatenedDreams.TroubledMission01, 11)  -- Verificar

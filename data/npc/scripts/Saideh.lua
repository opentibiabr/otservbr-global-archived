...
local player = Player(cid)
if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Fourteen.Remains) == 1 then
	if player:getStorageValue(Storage.KilmareshQuest.Fourteen.Remains) == 1 then
...
elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.KilmareshQuest.Fourteen.Remains) == 1 then
	if player:getStorageValue(Storage.KilmareshQuest.Fourteen.Remains) == 1 then
		npcHandler:say({"Well, I appreciate that. Good luck!"}, cid)
		player:setStorageValue(Storage.KilmareshQuest.Fourteen.Remains, 2)

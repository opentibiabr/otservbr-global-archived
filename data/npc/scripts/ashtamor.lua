...
keywordHandler:addKeyword({'souls'}, StdModule.say, {npcHandler = npcHandler, text = "The essence of life. Source of your very self. While the body is in space and time, the soul exists in time only."})
...
keywordHandler:addKeyword({'monsters'}, StdModule.say, {npcHandler = npcHandler, text = "Oh yes, monsters can grant you a passage to the afterlife also, but it's not a comfortable trip. <chuckles>"})
...
keywordHandler:addKeyword({'offer'}, StdModule.say, {npcHandler = npcHandler, text = "I'm offering vases and amphoras, the perfect vessel for all kinds of dusty remains. Ask me for a trade if you're interested."})

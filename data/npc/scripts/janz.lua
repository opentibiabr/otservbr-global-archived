...
local voices = { 
	{text = 'Moved into a new house? I got the perfect furniture for you.'} 
}
...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = "My name is Janz."})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = "I am selling furniture."})
...
keywordHandler:addKeyword({'gods'}, StdModule.say, {npcHandler = npcHandler, text = "We have little use of your southern gods."})
keywordHandler:addKeyword({'druid'}, StdModule.say, {npcHandler = npcHandler, text = "The druids are shamans from Carlin."})
keywordHandler:addKeyword({'shaman'}, StdModule.say, {npcHandler = npcHandler, text = "The shamans are great seers and healers."})
keywordHandler:addKeyword({'Ferumbras'}, StdModule.say, {npcHandler = npcHandler, text = "That's some evil spirit the people of the south are fearing."})
keywordHandler:addKeyword({'Excalibug'}, StdModule.say, {npcHandler = npcHandler, text = "A weapon that would make woodcutting easy."})
keywordHandler:addKeyword({'news'}, StdModule.say, {npcHandler = npcHandler, text = "Nothing exciting has happened lately."})
keywordHandler:addKeyword({'Carlin'}, StdModule.say, {npcHandler = npcHandler, text = "I visited Carlin once and I was very impressed. They used less wood then I'd expected but it was a marvellous town."})
keywordHandler:addKeyword({'Edron'}, StdModule.say, {npcHandler = npcHandler, text = "From the tales I heard, it expect it to be a bit like Everspring."})
keywordHandler:addKeyword({'Everspring'}, StdModule.say, {npcHandler = npcHandler, text = "I heard this is some spot in the South which is similar to the place that expects one in the afterlife."})
keywordHandler:addKeyword({'Port Hope'}, StdModule.say, {npcHandler = npcHandler, text = "I heard they used much wood, too, to build that town."})
keywordHandler:addKeyword({'Svargrond'}, StdModule.say, {npcHandler = npcHandler, text = "If it were not for the wood we've gotten from Carlin, the city would for sure look less impressive."})
keywordHandler:addKeyword({'Thais'}, StdModule.say, {npcHandler = npcHandler, text = "I heard Thais is even bigger than Carlin."})
keywordHandler:addKeyword({'Venore'}, StdModule.say, {npcHandler = npcHandler, text = "The people of Carlin are somewhat bothered by Venore."})
keywordHandler:addKeyword({'dwarf'}, StdModule.say, {npcHandler = npcHandler, text = "I heard they are fine woodcutters."})
keywordHandler:addKeyword({'Elf'}, StdModule.say, {npcHandler = npcHandler, text = "I heard their city is made of living trees! Imagine!"})
keywordHandler:addKeyword({'chakoya'}, StdModule.say, {npcHandler = npcHandler, text = "The chakoyas are real. My grandfather got killed by them."})
keywordHandler:addKeyword({'yeti'}, StdModule.say, {npcHandler = npcHandler, text = "They are rather rare."})
keywordHandler:addKeyword({'dragon'}, StdModule.say, {npcHandler = npcHandler, text = "The dragons usually stay in their areas, so we have little trouble with them."})
keywordHandler:addKeyword({'jarl'}, StdModule.say, {npcHandler = npcHandler, text = "Our jarl is a fine man. I named a cupboard after him."})
keywordHandler:addKeyword({'barbarians'}, StdModule.say, {npcHandler = npcHandler, text = "I am proud to be a barbarian, even though a civilised one of course."})
keywordHandler:addKeyword({'raiders'}, StdModule.say, {npcHandler = npcHandler, text = "They are just greedy for all we have accomplished."})
keywordHandler:addKeyword({'cult'}, StdModule.say, {npcHandler = npcHandler, text = "I don't even understand what that means."})
keywordHandler:addKeyword({'mines'}, StdModule.say, {npcHandler = npcHandler, text = "The mines are somewhere in the mountains. In the early days of our city, many people from Carlin used to work there."})
keywordHandler:addKeyword({'Chyll'}, StdModule.say, {npcHandler = npcHandler, text = "Father north wind knows best."})
keywordHandler:addKeyword({'Nibelor'}, StdModule.say, {npcHandler = npcHandler, text = "Most shamans live there."})
keywordHandler:addKeyword({'Years of Serpents'}, StdModule.say, {npcHandler = npcHandler, text = "That have been hard years in which we were cut off from our main wood supply. Gladly wood does not suffer much in our climate."})
keywordHandler:addKeyword({'how are you?'}, StdModule.say, {npcHandler = npcHandler, text = "It could be worse I guess."})

npcHandler:setMessage(MESSAGE_GREET, "HAIL to the Warlord of the arena! |PLAYERNAME|, Hero of Svargrond!")
npcHandler:setMessage(MESSAGE_FAREWELL, "Farewell, Warlord of the arena, |PLAYERNAME|, Hero of Svargrond!")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Farewell, Warlord of the arena, |PLAYERNAME|, Hero of Svargrond!")

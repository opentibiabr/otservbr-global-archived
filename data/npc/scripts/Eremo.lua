...
blessKeyword:addChildKeyword(
	{'yes'},
	StdModule.bless,
	{npcHandler = npcHandler, text = 'So receive the wisdom of solitude, pilgrim.', cost = '|BLESSCOST|', bless = 2}
)
blessKeyword:addChildKeyword(
	{''},
	StdModule.say,
	{npcHandler = npcHandler, text = 'Fine. You are free to decline my offer.', reset = true}
)
...
addHealKeyword(
	'You are electrified, my child. Let me help you to stop trembling.',
	CONDITION_ENERGY,
...
keywordHandler:addKeyword(
	{'heal'},
	StdModule.say,
	{npcHandler = npcHandler, text = 'You are hurt, my child. I will heal your wounds.'},
	function(player)
...
local teleportKeyword =
	...
	{'cormaya'},
	StdModule.say,
	{npcHandler = npcHandler, text = 'Should I teleport you back to Pemaret?'}
)
teleportKeyword:addChildKeyword(
	{'yes'},
	StdModule.travel,
	{npcHandler = npcHandler, text = 'Here you go!', premium = false, destination = Position(33288, 31956, 6)}
)
...
keywordHandler:addKeyword(
	{'embrace'},
	StdModule.say,
	{npcHandler = npcHandler, text = 'The druids north of Carlin will provide you with the embrace of Tibia.'}
)
keywordHandler:addKeyword(
	{'suns'},
	StdModule.say,
	{npcHandler = npcHandler, text = "You can ask for the blessing of the two suns in the suntower near Ab'Dendriel."}
)
keywordHandler:addAliasKeyword({'fire'})
keywordHandler:addKeyword(
	{'phoenix'},
...
keywordHandler:addKeyword(
	{'name'},
	StdModule.say,
	{npcHandler = npcHandler, text = 'I am Eremo, an old man who has seen many things.'}
)

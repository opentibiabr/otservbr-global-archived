...
shopModule:addBuyableItem({"empty potion flask"}, 7636, 5, 1)
shopModule:addBuyableItem({"empty potion flask"}, 7634, 5, 1)
shopModule:addBuyableItem({"empty potion flask"}, 7635, 5, 1)
shopModule:addBuyableItem({"spellwand"}, 7735, 299, 1)
shopModule:addBuyableItem({"vial"}, 2006, 5, 1)
-- Sellable
shopModule:addSellableItem({"avalanche rune"}, 2274, 57, 1)
shopModule:addSellableItem({"blank rune"}, 2260, 10, 1)
shopModule:addSellableItem({"chameleon rune"}, 2291, 210, 1)
shopmodule:addsellableitem({"convince creature rune"}, 2290, 80, 1)
shopmodule:addsellableitem({"cure poison rune"}, 2266, 65, 1)
shopmodule:addsellableitem({"destroy field rune"}, 2261, 15, 1)
shopmodule:addsellableitem({"energy field rune"}, 2277, 38, 1)
shopmodule:addsellableitem({"energy wall rune"}, 2279, 85, 1)
shopmodule:addsellableitem({"exercise rod"}, 32388, 262500, 1, 500)
shopmodule:addsellableitem({"exercise wand"}, 32389, 262500, 1, 500)
shopmodule:addsellableitem({"explosion rune"}, 2313, 31, 1)
shopmodule:addsellableitem({"fire bomb rune"}, 2305, 147, 1)
shopmodule:addsellableitem({"fire field rune"}, 2301, 28, 1)
shopmodule:addsellableitem({"fire wall rune"}, 2303, 61, 1)
shopmodule:addsellableitem({"great fireball rune"}, 2304, 57, 1)
shopmodule:addsellableitem({"great health potion"}, 7591, 225, 1)
shopmodule:addsellableitem({"great mana potion"}, 7590, 144, 1)
shopmodule:addsellableitem({"great spirit potion"}, 8472, 228, 1)
shopmodule:addsellableitem({"hailstorm rod"}, 2183, 15000, 1)
shopmodule:addsellableitem({"health potion"}, 7618, 50, 1)
shopmodule:addsellableitem({"heavy magic missile rune"}, 2311, 12, 1)
shopmodule:addsellableitem({"intense healing rune"}, 2265, 95, 1)
shopmodule:addsellableitem({"light magic missile rune"}, 2287, 4, 1)
shopmodule:addsellableitem({"mana potion"}, 7620, 56, 1)
shopmodule:addsellableitem({"moonlight rod"}, 2186, 1000, 1)
shopmodule:addsellableitem({"necrotic rod"}, 2185, 5000, 1)
shopmodule:addsellableitem({"northwind rod"}, 8911, 7500, 1)
shopmodule:addsellableitem({"poison field rune"}, 2285, 21, 1)
shopmodule:addsellableitem({"poison wall rune"}, 2289, 52, 1)
shopmodule:addsellableitem({"snakebite rod"}, 2182, 500, 1)
shopmodule:addsellableitem({"spellbook"}, 2217, 150, 1)
shopmodule:addsellableitem({"springsprout rod"}, 8912, 18000, 1)
shopmodule:addsellableitem({"stalagmite rune"}, 2292, 12, 1)
shopmodule:addsellableitem({"strong health potion"}, 7588, 115, 1)
shopmodule:addsellableitem({"strong mana potion"}, 7589, 93, 1)
shopmodule:addsellableitem({"sudden death rune"}, 2268, 135, 1)
shopmodule:addsellableitem({"supreme health potion"}, 26031, 625, 1)
shopmodule:addsellableitem({"terra rod"}, 2181, 10000, 1)
shopmodule:addsellableitem({"ultimate health potion"}, 8473, 379, 1)
shopmodule:addsellableitem({"ultimate healing rune"}, 2273, 175, 1)
shopmodule:addsellableitem({"ultimate mana potion"}, 26029, 438, 1)
shopmodule:addsellableitem({"ultimate spirit potion"}, 26030, 438, 1)
shopmodule:addsellableitem({"underworld rod"}, 8910, 22000, 1)
shopmodule:addsellableitem({"wand of cosmic energy"}, 2189, 10000, 1)
shopmodule:addsellableitem({"wand of decay"}, 2188, 5000, 1)
shopmodule:addsellableitem({"wand of draconia"}, 8921, 7500, 1)
shopmodule:addsellableitem({"wand of dragonbreath"}, 2191, 1000, 1)
shopmodule:addsellableitem({"wand of inferno"}, 2187, 15000, 1)
shopmodule:addsellableitem({"wand of starstorm"}, 8920, 18000, 1)
shopmodule:addsellableitem({"wand of voodoo"}, 8922, 22000, 1)
shopmodule:addsellableitem({"wand of vortex"}, 2190, 500, 1)

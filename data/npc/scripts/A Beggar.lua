...
function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
			npcHandler:say("Thought so. You'll have to talk to the king though. The beggar king that is. The king does not grant an audience to just everyone. You know how those kings are, don't you? ... ", cid)
			...
			npcHandler:say("So why don't you show your dedication to the poor? Go and help Chavis at the poor house. He's collecting food for people like us. ... ", cid)
			npcHandler:say("If you brought enough of the stuff you'll see that the king will grant you entrance in his {palace}.", cid)

...
-- MISSAO 1 PEGAR TITULO DA MISSAO E PEGAR MISSAO DE VASCULHAR OS LIVROS NA CASA

if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Segunda.Investigando) == -1 then
	...
	player:setStorageValue(Storage.KilmareshQuest.Primeira.Titulo, 1)
	npcHandler.topic[cid] = 1
	playerTopic[cid] = 1

elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.KilmareshQuest.Segunda.Investigando) == -1 then
	if player:getStorageValue(Storage.KilmareshQuest.Primeira.Titulo) == 1 then
		...
		player:setStorageValue(Storage.KilmareshQuest.Segunda.Investigando, 1)
...
-- MISSAO 1 OLHOU OS LIVROS E JA PEGA PROXIMA MISSAO DE PEGAR RING

if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Segunda.Investigando) == 5 then
	if player:getStorageValue(Storage.KilmareshQuest.Segunda.Investigando) == 5 then
		...
		player:setStorageValue(Storage.KilmareshQuest.Terceira.Recuperando, 1)
		player:setStorageValue(Storage.KilmareshQuest.Segunda.Investigando, 6)
...
if msgcontains(msg, "ring") and player:getStorageValue(Storage.KilmareshQuest.Terceira.Recuperando) == 1 and player:getItemById(36098, true) then
	if player:getStorageValue(Storage.KilmareshQuest.Terceira.Recuperando) == 1 then
		...
		player:setStorageValue(Storage.KilmareshQuest.Terceira.Recuperando, 2)
...
-- MISSAO 3 MEMORIAS DO EMBAIXADOR

if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Quinta.Memorias) == 3 then
	if player:getStorageValue(Storage.KilmareshQuest.Quinta.Memorias) == 3 then
		...
		player:setStorageValue(Storage.KilmareshQuest.Quinta.Memorias, 4)

...
local voices = {
	{ text = "This is a good day for buying gems! Come and see how they sparkle!" }
}
...
keywordHandler:addKeyword({'time'}, StdModule.say, {npcHandler = npcHandler, text = "It's 9:28 pm."})
keywordHandler:addKeyword({'offers'}, StdModule.say, {npcHandler = npcHandler, text = "We offer a great assortment of gems and pearls."})
keywordHandler:addKeyword({'gems'}, StdModule.say, {npcHandler = npcHandler, text = "We trade small diamonds, sapphires, rubies, emeralds, and amethysts."})
...
npcHandler:setMessage(MESSAGE_GREET, "Be greeted, dear |PLAYERNAME|. Have a look at our gems.")

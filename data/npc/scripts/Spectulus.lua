...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
	if player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
		...
		{"I couldn\'t explore what lies below the stairs as there was an unpredictable stream. Diving into these waters would have been an uncontrollable risk, even with the means to survive without any air. ..."},
	...
	elseif msgcontains(msg, "yes") and playerTopic[cid] == 2 and player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
	if player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
		npcHandler:say(
		...
		{"I will put this under your footgear. Here you go. And this in your nose. There. And there will be no further problems for you down there. Except- ah, well you'll find out yourself soon enough, won't you?"}, cid)
		npcHandler.topic[cid] = 3
		playerTopic[cid] = 3
	end
	elseif msgcontains(msg, "yes") and playerTopic[cid] == 3 and player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
	if player:getStorageValue(Storage.LiquidBlackQuest.Visitor) == 3 then
		npcHandler:say(
		{"Then off you go! I'm sorry that I cannot offer you any further help but I'm sure you will find support along your way. And - be careful. The sea can appear pitch black down there."}, cid)

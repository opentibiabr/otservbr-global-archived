...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'mission') then
		...
		elseif cStorage == 6 then
			npcHandler:say(
				'Well, the only thing left to do would be to offer the crystal at the well of the collector. \z
			There must be a pedestal near the well, where you need to put your donation. Ha, do you think you could do that?',
				cid
			)
		...
		elseif cStorage == 9 then
			if player:getItemCount(10616) == 0 then
				npcHandler:say(
					'Put the mirror crystal into the special carrying device I gave you and bring it \z
				directly to me.',
					cid
				)
				return true
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 5 then
			npcHandler:say(
				"Good, because if you wouldn't do it... listen, this well is on \z
				one of the isles near Carlin. There you offer the crystal. Once you get access \z
				to its lair, find the collector and... convince it to give \z

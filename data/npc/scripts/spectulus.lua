...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'mission') then
		...
		elseif cStorage == 1 then
			npcHandler:say(
				"You should find the beggar somewhere in Edron. Stay persistent, I'm sure he knows more than he wants to tell us.",
				cid
			)
		...
		elseif cStorage == 8 then
			npcHandler:say(
				'So have you found the well and entered the lair? I hope you can find the {mirror crystal} in there. \z
				It is the only way to finish the {Lightboat}.',
				cid
			)
		elseif cStorage == 9 then
			if player:getItemCount(10616) == 0 then
				npcHandler:say(
					'Put the mirror crystal into the special carrying device I gave you and bring it directly to me.',
					cid
				)
				return true
			end
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 5 then
			npcHandler:say(
				"Good, because if you wouldn't do it... listen, this well is on one of the isles near Carlin. There you \z
...
npcHandler:setMessage(
	MESSAGE_GREET,
	"Hello |PLAYERNAME|! You're late, do you have no concept of time? My mission is of utmost importance. If you \z
		are not interested in helping me, you might as well just leave."
)

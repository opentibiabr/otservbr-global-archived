...
shopModule:addBuyableItem({"botanist s container"}, 4869, 500, 1)
shopModule:addBuyableItem({"ectoplasm container"}, 4863, 750, 1)

shopModule:addSellableItem({"explorer brooch"}, 4873, 50, 1)
shopModule:addSellableItem({"hydra egg"}, 4850, 500, 1)
shopModule:addSellableItem({"old parchment"}, 4842, 500, 1)
...
local function creatureSayCallback(cid, type, msg)
    ...
    elseif msgcontains(msg, "farmine") then
        if player:getStorageValue(Storage.TheNewFrontier.Questline) <= 15 and 
        player:getStorageValue(Storage.TheNewFrontier.BribeExplorerSociety) < 1 then
            npcHandler:say("Oh yes, an interesting topic. We had vivid discussions about this discovery. \z
            But what is it that you want?", cid)
    ...
    elseif msgcontains(msg, "bluff") then
        if npcHandler.topic[cid] == 30 then
            if player:getStorageValue(Storage.TheNewFrontier.BribeExplorerSociety) < 1 then
                npcHandler:say({
                    "Those stories are just amazing! Men with faces on their stomach instead of \z
                    heads you say? And hens that lay golden eggs? Whereas, most amazing is this fountain \z
                    of youth you've mentioned! ...",
                ...
                player:setStorageValue(Storage.TheNewFrontier.Mission05, 
                player:getStorageValue(Storage.TheNewFrontier.Mission05) + 1)
            end
        end

        -- MISSION CHECK
    elseif msgcontains(msg, "mission") then
        if player:getStorageValue(Storage.ExplorerSociety.JoiningtheExplorers) > 3 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 3 and 
        ...
        player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 7 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 7 or 
        player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 16 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 16 or 
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 4 then
            npcHandler:say("The missions available for your rank are the {butterfly hunt}, \z
            {plant collection} and {ice delivery}.", cid)
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 32 then
            npcHandler:say("The missions available for your rank are {lizard urn}, \z
            {bonelord secrets} and {orc powder}.", cid)
            npcHandler.topic[cid] = 0
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 41 then
            npcHandler:say("The missions available for your rank are {elven poetry}, \z
            {memory stone} and {rune writings}.", cid)
            npcHandler.topic[cid] = 0
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 44 then
            npcHandler:say("The explorer society needs a great deal of help in the research of astral travel. \z
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 47 then
            npcHandler:say({
                "The research on ectoplasm makes good progress. Now we need some spectral article. \z
                Our scientists think a spectral dress would be a perfect object for their studies ...",
                "The bad news is that the only source to got such a dress is the queen of the banshees. \z
                Do you dare to seek her out?"
            }, cid)
            npcHandler.topic[cid] = 30
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 50 then
            npcHandler:say({
                "With the objects you've provided our researchers will make steady progress. \z
                Still we are missing some test results from fellow explorers ...",
                "Please travel to our base in Northport and ask them to mail us their latest research reports. \z
        ...
        player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 1 then 
            npcHandler:say("The reports from Northport have already arrived here and our progress is astonishing. \z
            We think it is possible to create an astral bridge between our bases. \z
            Are you interested to assist us with this?", cid)
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 55 then
            npcHandler:say({
                "Both carvings are now charged and harmonised. In theory you should be able to \z
                travel in zero time from one base to the other ...",
                "However, you will need to have an orichalcum pearl in your possession to use it as power source. \z
                It will be destroyed during the process. I will give you 6 of such pearls and you can buy new ones \z
                in our bases ...",
                "In addition, you need to be a premium explorer to use the astral travel. ...",
                "And remember: it's a small teleport for you, but a big teleport for all Tibians! \z
                Here is a small present for your efforts!"
            }, cid)
    ...
    elseif msgcontains(msg, "pickaxe") then
        if player:getStorageValue(Storage.ExplorerSociety.JoiningtheExplorers) < 4 or 
    ...
    elseif msgcontains(msg, "ice delivery") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 4 then
            npcHandler:say({
                "Our finest minds came up with the theory that deep beneath the ice island of Folda \z
                ice can be found that is ancient. To prove this theory we would need a sample \z
                of the aforesaid ice ...",
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 6 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 6 then
    ...
    elseif msgcontains(msg, "butterfly hunt") then
        if player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 7 and 
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 9 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 9 then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 10 then
            npcHandler:say({
                ...
                "Just use it on the fresh corpse of a blue butterfly, return the prepared butterfly to me and \z
                give me a report of your butterfly hunt."
            }, cid)
            npcHandler.topic[cid] = 0
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 12 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 12 then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 13 then
            npcHandler:say({
                ...
                "Just use it on the fresh corpse of a red butterfly, return the prepared butterfly to me and \z
                give me a report of your butterfly hunt."
            }, cid)
            npcHandler.topic[cid] = 0
            player:addItem(4865, 1)
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 15 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 15 then
    ...
    elseif msgcontains(msg, "plant collection") then
        if player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 16 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 16 then
            npcHandler:say("In this mission we require you to get us some plant samples from Tiquandan plants. \z
            Would you like to fulfil this mission?", cid)
            npcHandler.topic[cid] = 11
        elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 18  and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 18 then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 19 then
            npcHandler:say("Use this botanist's container on a witches cauldron to collect a sample for us. \z
            Bring it here and report about your plant collection.", cid)
            npcHandler.topic[cid] = 0
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 21 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 21 then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 22 then
            npcHandler:say("Use this botanist\'s container on a giant jungle rose to obtain a sample for us. \z
            Bring it here and report about your plant collection.", cid)
            npcHandler.topic[cid] = 0
            player:addItem(4869, 1)
        ...
        elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 24 and 
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 24 then
    ...
    elseif msgcontains(msg, "lizard urn") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 26 then
            npcHandler:say("The explorer society would like to acquire an ancient urn which is \z
            some sort of relic to the lizard people of Tiquanda. Would you like to accept this mission?", cid)
    ...
    elseif msgcontains(msg, "bonelord secrets") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 29 then
            npcHandler:say({
                "We want to learn more about the ancient race of bonelords. We believe the black \z
                pyramid north east of Darashia was originally built by them ...",
                "We ask you to explore the ruins of the black pyramid and look for any signs that \z
                prove our theory. You might probably find some document with the numeric bonelord language ...",
    ...
    elseif msgcontains(msg, "orc powder") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 32 then
            npcHandler:say({
                "It is commonly known that orcs of Uldereks Rock use some sort of powder to \z
                increase the fierceness of their war wolves and berserkers ...",
    ...
    elseif msgcontains(msg, "elven poetry") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 35 then
            npcHandler:say({
                "Some high ranking members would like to study elven poetry. \z
                They want the rare book 'Songs of the Forest' ...",
                "For sure someone in Ab'Dendriel will own a copy. So you would just have to ask around there. \z
    ...
    elseif msgcontains(msg, "memory stone") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 38 then
            npcHandler:say({
                "We acquired some knowledge about special magic stones. Some lost civilisations \z
                used it to store knowledge and lore, just like we use books ...",
                "The wisdom in such stones must be immense, but so are the dangers \z
                faced by every person who tries to obtain one...",
                "As far as we know the ruins found in the north-west of Edron were once inhabited by \z
                beings who used such stones. Do you have the heart to go there and to get us such a stone?"
            }, cid)
    ...
    elseif msgcontains(msg, "rune writings") then
        ...
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 41 then
            npcHandler:say({
                "We would like to study some ancient runes that were used by the lizard race. \z
                We suspect some relation of the lizards to the founders of Ankrahmun ...",
                "Somewhere under the ape infested city of Banuta, one can find dungeons that \z
                were once inhabited by lizards...",
                "Look there for an atypical structure that would rather fit to Ankrahmun and its Ankrahmun Tombs. \z
                Copy the runes you will find on this structure...",
    ...
    elseif msgcontains(msg, "yes") then
        if npcHandler.topic[cid] == 1 then
            npcHandler:say({
                "Fine, though it takes more then a mere lip service to join our ranks. To prove your dedication \z
                to the cause you will have to acquire an item for us ...",
                "The mission should be simple to fulfil. For our excavations we have ordered a sturdy \z
                pickaxe in Kazordoon. You would have to seek out this trader Uzgod and get the pickaxe for us ...",
                "Simple enough? Are you interested in this task?"
            }, cid)
            npcHandler.topic[cid] = 2
        elseif npcHandler.topic[cid] == 2 then
            npcHandler:say("We will see if you can handle this simple task. Get the pickaxe from Uzgod in Kazordoon \z
            and bring it to one of our bases. Report there about the pickaxe.", cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 3 then
            if player:removeItem(4874, 1) then
                ...
                npcHandler:say({
                    ...
                    "I officially welcome you to the explorer society. From now on you can ask for missions \z
        ...
        elseif npcHandler.topic[cid] == 4 then
            ...
            npcHandler:say({
                "So listen please: Take this ice pick and use it on a block of ice in the caves beneath Folda. \z
                Get some ice and bring it here as fast as you can ...",
                "Should the ice melt away, report on your ice delivery mission anyway. \z
                I will then tell you if the time is right to start another mission."
            }, cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 6 then
            player:setStorageValue(Storage.ExplorerSociety.TheIceDelivery, 5)
            player:setStorageValue(Storage.ExplorerSociety.QuestLine, 5)
            npcHandler:say("*Sigh* I think the time is right to grant you another chance to get that ice. \z
            Hurry up this time.", cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 7 then
            ...
            npcHandler:say({
                ...
                "Just use it on the fresh corpse of a purple butterfly, return the prepared butterfly to me \z
                and give me a report of your butterfly hunt."
            }, cid)
            npcHandler.topic[cid] = 0
            player:addItem(4865, 1)
        elseif npcHandler.topic[cid] == 8 then
            if player:removeItem(4866, 1) then
                ...
                npcHandler:say("A little bit battered but it will do. Thank you! If you think you are ready, \z
                ask for another butterfly hunt.", cid)
                npcHandler.topic[cid] = 0
            end
        ...
        elseif npcHandler.topic[cid] == 10 then
            if player:removeItem(4868, 1) then
                ...
                npcHandler:say("That is an extraordinary species you have brought. \z
                Thank you! That was the last butterfly we needed.", cid)
                npcHandler.topic[cid] = 0
            end
            -- BUTTERFLY HUNT
        ...
        elseif npcHandler.topic[cid] == 11 then
            ...
            npcHandler:say("Fine! Here take this botanist's container. Use it on a jungle bells plant to \z
            collect a sample for us. Report about your plant collection when you have been successful.", cid)
            npcHandler.topic[cid] = 0
            player:addItem(4869, 1)
        elseif npcHandler.topic[cid] == 12 then
            if player:removeItem(4870, 1) then
                ...
                npcHandler:say("I see. It seems you've got some quite useful sample by sheer luck. \z
                Thank you! Just tell me when you are ready to continue with the plant collection.", cid)
                npcHandler.topic[cid] = 0
            end
        elseif npcHandler.topic[cid] == 13 then
            if player:removeItem(4871, 1) then
                ...
                npcHandler:say("Ah, finally. I started to wonder what took you so long. But thank you! \z
                Another fine sample, indeed. Just tell me when you are ready to continue \z
                with the plant collection.", cid)
                npcHandler.topic[cid] = 0
            end
        elseif npcHandler.topic[cid] == 14 then
            if player:removeItem(4872, 1) then
                ...
                npcHandler:say("What a lovely sample! With that you have finished your plant \z
                collection missions.", cid)
                npcHandler.topic[cid] = 0
            end
            -- PLANT COLLECTION
        ...
        elseif npcHandler.topic[cid] == 15 then
            ...
            npcHandler:say({
                "You have indeed the spirit of an adventurer! In the south-east of Tiquanda is a \z
                small settlement of the lizard people ...",
                "Beneath the newly constructed temple there, the lizards hide the said urn. \z
                Our attempts to acquire this item were without success ...",
        ...
        elseif npcHandler.topic[cid] == 16 then
            if player:removeItem(4858, 1) then
                ...
                npcHandler:say("Yes, that is the prized relic we have been looking for so long. \z
                You did a great job, thank you.", cid)
                npcHandler.topic[cid] = 0
            end
            -- LIZARD URN
        ...
        elseif npcHandler.topic[cid] == 19 then
            ...
            npcHandler:say({
                "You are a brave soul. As far as we can tell, the orcs maintain some sort of training \z
                facility in some hill in the north-east of their city ...",
                "There you should find lots of their war wolves and hopefully also some of the orcish powder. \z
                Good luck!"
            }, cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 21 then
            ...
            npcHandler:say("Excellent. This mission is easy but nonetheless vital. Travel to \z
            Ab'Dendriel and get the book.", cid)
            npcHandler.topic[cid] = 0
        elseif npcHandler.topic[cid] == 22 then
            if player:removeItem(4855, 1) then
                ...
                npcHandler:say("Let me have a look! Yes, that's what we wanted. A copy of 'Songs of the Forest'. \z
                I won't ask any questions about those bloodstains.", cid)
                npcHandler.topic[cid] = 0
            end
            -- ELVEN POETRY
        ...
        elseif npcHandler.topic[cid] == 23 then
            ...
            npcHandler:say("In the ruins of north-western Edron you should be able to find a memory stone. \z
            Good luck.", cid)
            npcHandler.topic[cid] = 0
        elseif npcHandler.topic[cid] == 24 then
            if player:removeItem(4852, 1) then
                ...
                npcHandler:say("A flawless memory stone! Incredible! It will take years even to figure \z
                out how it works but what an opportunity for science, thank you!", cid)
                npcHandler.topic[cid] = 0
            end
            -- MEMORY STONE
        ...
        elseif npcHandler.topic[cid] == 25 then
            ...
            npcHandler:say("Excellent! Here, take this tracing paper and use it on the object you will \z
            find there to create a copy of the ancient runes.", cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 27 then
            npcHandler:say({
                "Fine. The society is looking for new means to travel. Some of our most brilliant \z
                minds have some theories about astral travel that they want to research further ...",
                "Therefore we need you to collect some ectoplasm from the corpse of a ghost. \z
                We will supply you with a collector that you can use on the body of a slain ghost ...",
                "Do you think you are ready for that mission?"
            }, cid)
            npcHandler.topic[cid] = 28
        elseif npcHandler.topic[cid] == 28 then
            npcHandler:say("Good! Take this container and use it on a ghost that was recently slain. \z
            Return with the collected ectoplasm and hand me that container ...", cid)
        ...
        elseif npcHandler.topic[cid] == 29 then
            if player:removeItem(8182, 1) then
                ...
                npcHandler:say("Phew, I had no idea that ectoplasm would smell that ... oh, it's you, well, \z
                sorry. Thank you for the ectoplasm.", cid)
                npcHandler.topic[cid] = 0
            end
            -- ECTOPLASM
        ...
        elseif npcHandler.topic[cid] == 30 then
            npcHandler:say({
                "That is quite courageous. We know, it's much we are asking for. The queen of the banshees \z
                lives in the so called Ghostlands, south west of Carlin. It is rumoured that her lair is \z
                located in the deepest dungeons beneath that cursed place ...",
                "Any violence will probably be futile, you will have to negotiate with her. \z
                Try to get a spectral dress from her. Good luck."
            }, cid)
            npcHandler.topic[cid] = 0
        ...
        elseif npcHandler.topic[cid] == 32 then
            npcHandler:say({
                "Good, just take this spectral essence and use it on the strange carving in this building \z
                as well as on the corresponding tile in our base at Northport ...",
        ...
        elseif npcHandler.topic[cid] == 33 then
            if player:removeItem(2320, 1) then
                npcHandler:say("Poor Ratha. Thank you for returning this skull to the society. \z
                We will see to a honourable burial of Ratha.", cid)
    ...
    elseif msgcontains(msg, "no") then
        ...
        -- SKULL OF RATHA / GIANT SMITHHAMMER
    elseif msgcontains(msg, "skull of ratha") and 
    player:getStorageValue(Storage.ExplorerSociety.skullofratha) < 1 then
        npcHandler:say({
            "Ratha was a great explorer and even greater ladies' man. Sadly he never returned \z
            from a visit to the amazons. Probably he is dead ...",
            "The society offers a substantial reward for the retrieval of Ratha or his remains. \z
            Do you have any news about Ratha?"
        }, cid)
    ...
    player:getStorageValue(Storage.ExplorerSociety.giantsmithhammer) < 1 then
        npcHandler:say("The explorer society is looking for a genuine giant smith hammer for our collection. \z
        It is rumoured the cyclopses of the Plains of Havoc might be using one. Did you by \z
        chance obtain such a hammer?", cid)
...
npcHandler:setMessage(MESSAGE_FAREWELL, "GCome back soon, noble |PLAYERNAME|.")
npcHandler:setMessage(MESSAGE_WALKAWAY, "GCome back soon.")

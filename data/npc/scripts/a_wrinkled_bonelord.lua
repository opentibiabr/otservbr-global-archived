...
keywordHandler:addKeyword({'books'}, StdModule.say, {npcHandler = npcHandler, text = "Our books are written in 594, of course you can't understand them."})
keywordHandler:addKeyword({'0'}, StdModule.say, {npcHandler = npcHandler, text = "Go and wash your eyes for using this obscene number!"})
keywordHandler:addKeyword({'594'}, StdModule.say, {npcHandler = npcHandler, text = "The language of my kind. Superior to any other language and only to be spoken by entities with enough eyes to blink it."})

...
local config = {
	...
	['fighting spirit'] = {
		storageValue = 3,
		message = {
			wrongValue = 'You should have enough fighting spirit if you are a true hero. Sorry, but you have \z
			to figure this one out by yourself. Unless someone grants you a wish.',
			deliever = 'So, can you show me your fighting spirit?',
			success = 'Correct - pretty smart for a man. But the hardest task is yet to come: the claw from \z
			a lord among the dragon lords.'
		},
		itemId = 5884
	},
	['dragon claw'] = {
		storageValue = 4,
		message = {
			wrongValue = 'You cannot get this special red claw from any common dragon in Tibia. It requires \z
			a special one, a lord among the lords.',
			deliever = 'Have you actually managed to obtain the dragon claw I asked for?',
			success = 'You did it! I have seldom seen a man as courageous as you. I really have to say that \z
			you deserve to wear a spike. Go ask Cornelia to adorn your armour.'
		},
		itemId = 5919
	}
}
...
local function creatureSayCallback(cid, type, msg)
	...
	if npcHandler.topic[cid] == 0 then
		...
		elseif msgcontains(msg, 'earn') then
			if player:getStorageValue(storage) < 1 then
				npcHandler:say('I\'m not sure if you are enough of a hero to earn them. You could try, though. \z
			...
			elseif player:getStorageValue(storage) == 5 then
				npcHandler:say('You did it! I have seldom seen a man as courageous as you. I really have to \z
				say that you deserve to wear a spike. Go ask Cornelia to adorn your armour.', cid)
			end
	...
	elseif npcHandler.topic[cid] == 1 then
		if msgcontains(msg, 'yes') then
			npcHandler:say({
				...
				'Next, if you actually managed to collect that many, please complete a small task for our \z
				guild and bring us 100 turtle shells. ...',
				'It is said that excellent shields can be created from these. ...',
				'Alright, um, afterwards show me that you have fighting spirit. Any true hero needs plenty \z
				of that. ...',
		...
		elseif msgcontains(msg, 'no') then
			npcHandler:say('I thought so. Train hard and maybe some day you will be ready to face \z
			this mission.', cid)
	...
	elseif npcHandler.topic[cid] == 2 then
		if msgcontains(msg, 'yes') then
			...
			player:setStorageValue(Storage.OutfitQuest.DefaultStart, 1) --start of Outfit and Addon Quests
			npcHandler:say('Excellent! Don\'t forget: Your first task is to bring me 100 hardened bones. \z
			Good luck!', cid)
			npcHandler.topic[cid] = 0
		elseif msgcontains(msg, 'no') then
...
keywordHandler:addKeyword({'spells'}, StdModule.say,
	{
		npcHandler = npcHandler,
		text = 'I can teach you {healing spells} and {support spells}. What kind of spell do you wish to learn? \z

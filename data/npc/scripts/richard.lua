...
shopModule:addBuyableItem({"backpack"}, 2854, 10, 1)
shopModule:addBuyableItem({"bag"}, 2853, 4, 1)
shopModule:addBuyableItem({"bread"}, 3600, 3, 1)
shopModule:addBuyableItem({"carrot"}, 3595, 1, 1)
shopModule:addBuyableItem({"cheese"}, 3607, 5, 1)
shopModule:addBuyableItem({"cherry"}, 3590, 1, 1)
shopModule:addBuyableItem({"egg"}, 3606, 1, 1)
shopModule:addBuyableItem({"fishing rod"}, 3483, 150, 1)
shopModule:addBuyableItem({"ham"}, 3582, 8, 1)
shopModule:addBuyableItem({"machete"}, 3308, 6, 1)
shopModule:addBuyableItem({"meat"}, 3577, 5, 1)
shopModule:addBuyableItem({"pick"}, 3456, 15, 1)
shopModule:addBuyableItem({"rope"}, 3003, 50, 1)
shopModule:addBuyableItem({"salmon"}, 3579, 2, 1)
shopModule:addBuyableItem({"scroll"}, 2815, 5, 1)
shopModule:addBuyableItem({"shovel"}, 3457, 10, 1)
shopModule:addBuyableItem({"torch"}, 2920, 2, 1)
shopModule:addBuyableItem({"worm"}, 3492, 1, 1)
-- Sellable
shopModule:addSellableItem({"cheese"}, 3607, 2, 1)
shopModule:addSellableItem({"fishing rod"}, 3483, 30, 1)
shopModule:addSellableItem({"meat"}, 3577, 2, 1)
shopModule:addSellableItem({"rope"}, 3003, 8, 1)
shopModule:addSellableItem({"shovel"}, 3457, 2, 1)

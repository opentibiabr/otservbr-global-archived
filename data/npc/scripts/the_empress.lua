...
local player = Player(cid)
if msgcontains(msg, "mission") and player:getStorageValue(Storage.Kilmaresh.Fifth.Memories) == 4 then
	if player:getStorageValue(Storage.Kilmaresh.Fifth.Memories) == 4 then
		...
		player:setStorageValue(Storage.Kilmaresh.Fifth.Memories, 5)
...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.Kilmaresh.Sixth.Favor) == 10 then
	if player:getStorageValue(Storage.Kilmaresh.Sixth.Favor) == 10 then
...
elseif msgcontains(msg, "yes") and playerTopic[cid] == 3 and player:getStorageValue(Storage.Kilmaresh.Sixth.Favor) == 10 then
	if player:getStorageValue(Storage.Kilmaresh.Sixth.Favor) == 10 then				

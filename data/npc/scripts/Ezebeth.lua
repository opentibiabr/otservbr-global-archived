...
function onCreatureSay(type, msg)	npcHandler:onCreatureSay(type, msg)	end
function onThink()						npcHandler:onThink()						end

function creatureSayCallback(type, msg)
	...
	if(msgcontains(msg, "mission")) then
		...
		else npcHandler:say("You already asked for a mission, go to the next.", cid)
		end

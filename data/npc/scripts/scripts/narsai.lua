...
local player = Player(cid)
if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 1 then
	if player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 1 then
		npcHandler:say({"Could you help me do a ritual?"}, cid)-- It needs to be revised, it's not the same as the global
		npcHandler.topic[cid] = 1
		playerTopic[cid] = 1
	end
elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 1 then
	if player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 1 then
		...
		player:setStorageValue(Storage.KilmareshQuest.Eighth.Narsai, 2)
...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 2 then
...
elseif msgcontains(msg, "yes") and playerTopic[cid] == 3 and player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 2 then
	if player:getStorageValue(Storage.KilmareshQuest.Eighth.Narsai) == 2 and player:getItemById(36170, 10) and player:getItemById(11196, 2) and player:getItemById(36167, 5) then
		...
		player:setStorageValue(Storage.KilmareshQuest.Eighth.Narsai, 3)

...
local player = Player(cid)
if msgcontains(msg, "mission") and player:getStorageValue(Storage.Kilmaresh.Second.Investigating) == -1 then
	...
	player:setStorageValue(Storage.Kilmaresh.First.Title, 1)
	npcHandler.topic[cid] = 1
	playerTopic[cid] = 1
elseif msgcontains(msg, "yes") and playerTopic[cid] == 1 and player:getStorageValue(Storage.Kilmaresh.Second.Investigating) == -1 then
	if player:getStorageValue(Storage.Kilmaresh.First.Title) == 1 then
		...
		player:setStorageValue(Storage.Kilmaresh.Second.Investigating, 1)
...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.Kilmaresh.Second.Investigating) == 5 then
	if player:getStorageValue(Storage.Kilmaresh.Second.Investigating) == 5 then
...
if msgcontains(msg, "ring") and player:getStorageValue(Storage.Kilmaresh.Third.Recovering) == 1 and player:getItemById(36098, true) then
	if player:getStorageValue(Storage.Kilmaresh.Third.Recovering) == 1 then
		...
		player:setStorageValue(Storage.Kilmaresh.Third.Recovering, 2)
...
if msgcontains(msg, "mission") and player:getStorageValue(Storage.Kilmaresh.Fifth.Memories) == 3 then
	if player:getStorageValue(Storage.Kilmaresh.Fifth.Memories) == 3 then
		...
		player:setStorageValue(Storage.Kilmaresh.Fifth.Memories, 4)

...
keywordHandler:addKeyword({'name'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "I am Duria Steelbender, daughter of Fire, of the Dragoneaters."
	}
)
keywordHandler:addKeyword({'job'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "Iam the Highknight of the dwarfs."
	}
)
keywordHandler:addKeyword({'Tibia'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "Bah, to much plantsandstuff, to few tunnels ifyoudaskme."
	}
)
keywordHandler:addKeyword({'Knights'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "Knights are proud of being dwarfs, jawoll."
	}
)
keywordHandler:addKeyword({'Heroes'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "Heroes are rare in this days, jawoll."
	}
)
keywordHandler:addKeyword({'Thais'}, StdModule.say, 
	{
		npcHandler = npcHandler, 
		text = "Was there once. Can't handle the crime overthere."
	}
)

...
function onUseShovel(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif
		targetActionId == 4668 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission69) == 1 and
			player:getStorageValue(Storage.GravediggerOfDrefia.Mission70) < 1
	 then
...
function onUsePick(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if table.contains({354, 355}, targetId) and targetActionId == 101 then
		...
		target:decay()
		toPosition:sendMagicEffect(CONST_ME_POFF)
	elseif target.itemid == 11227 then -- Shiny Stone Refining
	...
	elseif targetId == 3621 and targetActionId == 12026 then --The Ice Islands Quest, Nibelor 1: Breaking the Ice
	...
	elseif targetId == 9025 and targetActionId == 101 then -- The Banshee Quest
		target:transform(392)
		target:decay()
		toPosition:sendMagicEffect(CONST_ME_POFF)
	elseif targetActionId == 50090 then -- The Hidden City of Beregar Quest
	...
	elseif targetActionId == 50127 then -- Pythius The Rotten (Firewalker Boots)
	...
	elseif targetActionId == 50091 then -- The Asure
		player:teleportTo(Position(32960, 32676, 4))
	elseif targetId == 12296 then -- Wrath of the emperor quest
	...
	if (target ~= nil) and target:isItem() and (target:getId() == 22469) then --Lower Roshamuul
...
function onUseCrowbar(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if targetUniqueId == 3071 then -- In Service of Yalahar Quest
		if player:getStorageValue(Storage.InServiceofYalahar.SewerPipe01) < 1 then
			...
			player:setStorageValue(
				Storage.InServiceofYalahar.Mission01,
...
function onUseSpoon(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if targetId == 388 then --The Ice Islands Quest
	...
	elseif targetId == 8573 or targetId == 388 then -- What a Foolish Quest - Mission 8 (sulphur)
		if
...
function onUseScythe(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if targetActionId == 64028 then -- Secret Library
...
function onUseKitchenKnife(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if targetId == 2992 then --The Ice Islands Quest
		if player:getStorageValue(Storage.TheIceIslands.Questline) >= 21 then
	...
	elseif target.actionid == 4200 then -- What a foolish Quest (Mission 1)
	...
	elseif targetId == 7480 then -- What a foolish quest (mission 5)
	...
	elseif targetId == 4008 then -- What a foolish quest (mission 8)
		if

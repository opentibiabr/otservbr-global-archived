...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 10044 then
		if Game.getStorageValue(GlobalStorage.FerumbrasAscendantQuest.Habitats.Desert) >= 1 then
		...
		Game.setStorageValue(GlobalStorage.FerumbrasAscendantQuest.Habitats.Desert, 1)

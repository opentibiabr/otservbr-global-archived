...
function onUse(player, item, fromPosition, itemEx, toPosition)
	...
	player:setStorageValue(Storage.CultsOfTibia.MotA.Stone1, pedra1)
	player:setStorageValue(Storage.CultsOfTibia.MotA.Stone2, pedra2)
	player:setStorageValue(Storage.CultsOfTibia.MotA.Stone3, pedra3)

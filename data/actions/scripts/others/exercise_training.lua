                    ...
                    if exercise:hasAttribute(ITEM_ATTRIBUTE_CHARGES) then
                        ...
                        if charges_n >= 1 then
                            ...
                            if skills[itemid].id == SKILL_MAGLEVEL then
                                local magicRate = getRateFromTable(magicLevelStages, player:getMagicLevel(), magicRate)
                                ...
                                local skillRate = getRateFromTable(skillsStages, player:getEffectiveSkillLevel(skills[itemid].id), skillRate)
                                if not bonusDummy then

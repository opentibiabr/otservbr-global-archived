...
local config = {
	...
	[27628]	=	{NAME = 'Stone Rhino',				ID = 106,	TYPE = TYPE_MONSTER,	CHANCE = 40,	FAIL_MSG = { {1, 'The stone rhino ran away.'}, {2, 'Oh no! The reins were torn.'}, {3, 'The stone rhino is trying to run away.'} },SUCCESS_MSG = 'You have tamed the stone rhino.'},
	...
	[32491]	=	{NAME = 'Flying Book',				ID = 126,	TYPE = TYPE_MONSTER,	CHANCE = 40,	FAIL_MSG = { {1, 'The flying book ran away.'}, {2, 'Oh no! The reins were torn.'}, {3, 'The flying book is trying to run away.'} },SUCCESS_MSG = 'You have tamed the flying book.'},
	...
	[36411]	=	{NAME = 'Gryphon',					ID = 144,	TYPE = TYPE_MONSTER,	CHANCE = 40,	FAIL_MSG = { {1, 'The gryphon ran away.'}, {2, 'Oh no! The reins were torn.'}, {3, 'The gryphon is trying to run away.'} },SUCCESS_MSG = 'You have tamed the gryphon.'}
}

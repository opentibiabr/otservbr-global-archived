...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 90, attack = 96, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 5, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -400, range = 7, radius = 4, effect = CONST_ME_DRAWBLOOD, target = true},

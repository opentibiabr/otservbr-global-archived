...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 45, type = COMBAT_ICEDAMAGE, minDamage = -350, maxDamage = -450, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEATTACK, target = true},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_ICEDAMAGE, minDamage = -200, maxDamage = -500, radius = 4, effect = CONST_ME_ICEATTACK, target = false}
}
